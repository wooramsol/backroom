...
/**
 * L-corner span rule (works for boxes and keeps thickness visible):
 * - X-spanning walls (axis "z") run through the corner.
 * - Z-spanning walls (axis "x") stop half a thickness early at perpendicular joins.
 */
