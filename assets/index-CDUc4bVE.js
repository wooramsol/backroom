...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:pt,depthTest:!1,depthWrite:!1})}function X9(){return new gt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:t9(),fragmentShader:`
		...
		`,blending:pt,depthTest:!1,depthWrite:!1})}function q9(){return new gt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:t9(),fragmentShader:`
...
`)}function e5(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),a=s.name;let o=1;s.type===i.FLOAT_MAT2&&(o=2),s.type===i.FLOAT_MAT3&&(o=3),s.type===i.FLOAT_MAT4&&(o=4),t[a]={type:s.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function An(i){return i!==""}function ir(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function rr(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const t5=/^[ \t]*#include +<([\w\d./]+)>/gm;function H1(i){return i.replace(t5,i5)}const n5=new Map;function i5(i,e){let t=N0[e];if(t===void 0){const n=n5.get(e);if(n!==void 0)t=N0[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return H1(t)}const r5=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function sr(i){return i.replace(r5,s5)}function s5(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function ar(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function a5(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===_r?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===os?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===tt&&(e="SHADOWMAP_TYPE_VSM"),e}function o5(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case hn:case fn:e="ENVMAP_TYPE_CUBE";break;case Si:e="ENVMAP_TYPE_CUBE_UV";break}return e}function l5(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case fn:e="ENVMAP_MODE_REFRACTION";break}return e}function c5(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case gr:e="ENVMAP_BLENDING_MULTIPLY";break;case bs:e="ENVMAP_BLENDING_MIX";break;case ws:e="ENVMAP_BLENDING_ADD";break}return e}function u5(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function h5(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=a5(t),c=o5(t),u=l5(t),h=c5(t),d=u5(t),m=Jo(t),v=Qo(s),M=r.createProgram();let p,f,b=t.glslVersion?"#version "+t.glslVersion+`
