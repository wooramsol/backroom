...
#define LOW_PRECISION`),e}function Y5(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===W9?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===jr?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===at&&(e="SHADOWMAP_TYPE_VSM"),e}function K5(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case pn:case mn:e="ENVMAP_TYPE_CUBE";break;case Bi:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Z5(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case mn:e="ENVMAP_MODE_REFRACTION";break}return e}function $5(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case X9:e="ENVMAP_BLENDING_MULTIPLY";break;case ga:e="ENVMAP_BLENDING_MIX";break;case xa:e="ENVMAP_BLENDING_ADD";break}return e}function J5(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function j5(i,e,t,n){const s=i.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=Y5(t),c=K5(t),u=Z5(t),h=$5(t),f=J5(t),m=z5(t),g=H5(r),M=s.createProgram();let p,d,A=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(Un).join(`
`)),a=as(a),a=b9(a,t),a=A9(a,t),o=as(o),o=b9(o,t),o=A9(o,t),a=w9(a),o=w9(o),t.isRawShaderMaterial!==!0&&(A=`#version 300 es
...
`)+`
`+d);const y=A+p+a,S=A+d+o,I=E9(s,s.VERTEX_SHADER,y),L=E9(s,s.FRAGMENT_SHADER,S);s.attachShader(M,I),s.attachShader(M,L),t.index0AttributeName!==void 0?s.bindAttribLocation(M,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(M,0,"position"),s.linkProgram(M);function R(P){if(i.debug.checkShaderErrors){const W=s.getProgramInfoLog(M).trim(),H=s.getShaderInfoLog(I).trim(),Z=s.getShaderInfoLog(L).trim();let $=!0,q=!0;if(s.getProgramParameter(M,s.LINK_STATUS)===!1)if($=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,M,I,L);else{const j=y9(s,I,"vertex"),k=y9(s,L,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(M,s.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`};class Jn{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error("THREE.Pass: .render() must be implemented in derived pass.")}dispose(){}}const k6=new mr(-1,1,1,-1,0,1);class V6 extends yt{constructor(){super(),this.setAttribute("position",new ht([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new ht([0,2,0,0,2,0],2))}}const G6=new V6;class kr{constructor(e){this._mesh=new we(G6,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,k6)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}}class W6 extends Jn{constructor(e,t="tDiffuse"){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof Pe?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Ni.clone(e.uniforms),this.material=new Pe({name:e.name!==void 0?e.name:"unspecified",defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new kr(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}}class G9 extends Jn{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){const s=e.getContext(),r=e.state;r.buffers.color.setMask(!1),r.buffers.depth.setMask(!1),r.buffers.color.setLocked(!0),r.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),r.buffers.stencil.setTest(!0),r.buffers.stencil.setOp(s.REPLACE,s.REPLACE,s.REPLACE),r.buffers.stencil.setFunc(s.ALWAYS,a,4294967295),r.buffers.stencil.setClear(o),r.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),r.buffers.color.setLocked(!1),r.buffers.depth.setLocked(!1),r.buffers.color.setMask(!0),r.buffers.depth.setMask(!0),r.buffers.stencil.setLocked(!1),r.buffers.stencil.setFunc(s.EQUAL,1,4294967295),r.buffers.stencil.setOp(s.KEEP,s.KEEP,s.KEEP),r.buffers.stencil.setLocked(!0)}}class X6 extends Jn{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}}class q6{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){const n=e.getSize(new B0);this._width=n.width,this._height=n.height,t=new Ze(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:Ke}),t.texture.name="EffectComposer.rt1"}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name="EffectComposer.rt2",this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new W6(Di),this.copyPass.material.blending=ct,this.clock=new _r}swapBuffers(){const e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){const t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){e===void 0&&(e=this.clock.getDelta());const t=this.renderer.getRenderTarget();let n=!1;for(let s=0,r=this.passes.length;s<r;s++){const a=this.passes[s];if(a.enabled!==!1){if(a.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(s),a.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),a.needsSwap){if(n){const o=this.renderer.getContext(),l=this.renderer.state.buffers.stencil;l.setFunc(o.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),l.setFunc(o.EQUAL,1,4294967295)}this.swapBuffers()}G9!==void 0&&(a instanceof G9?n=!0:a instanceof X6&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){const t=this.renderer.getSize(new B0);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;const n=this._width*this._pixelRatio,s=this._height*this._pixelRatio;this.renderTarget1.setSize(n,s),this.renderTarget2.setSize(n,s);for(let r=0;r<this.passes.length;r++)this.passes[r].setSize(n,s)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}}class Y6 extends Jn{constructor(e,t,n=null,s=null,r=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=s,this.clearAlpha=r,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this._oldClearColor=new O0}render(e,t,n){const s=e.autoClear;e.autoClear=!1;let r,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(r=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==!0&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(r),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=s}}const K6={uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new O0(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}vn.BlurDirectionX=new B0(1,0);vn.BlurDirectionY=new B0(0,1);function Z6(i,e,t){const n=new q6(i);n.setPixelRatio(i.getPixelRatio()*wr),n.addPass(new Y6(e,t));const s=new vn(new B0(window.innerWidth,window.innerHeight),Y8,K8,Z8);return n.addPass(s),{composer:n,bloom:s}}function $6(i,e,t,n,s){i.setSize(n,s),e.setPixelRatio(i.getPixelRatio()*wr),e.setSize(n,s),t.resolution.set(n,s)}const Ln=document.getElementById("overlay"),J6=document.getElementById("hud"),j6=document.getElementById("vignette"),ze=new A8({antialias:!1,powerPreference:"high-performance"});w8.init();ze.setPixelRatio(Math.min(window.devicePixelRatio,1.5));ze.setSize(window.innerWidth,window.innerHeight);ze.outputColorSpace=be;ze.toneMapping=q9;ze.toneMappingExposure=$8;ze.domElement.style.cssText="position:fixed;inset:0;z-index:1;visibility:hidden";document.body.appendChild(ze.domElement);const Mn=new C2;Mn.background=new O0(Tr);Mn.fog=new Ms(Tr,F8,O8);const Nn=new Be(U8,window.innerWidth/window.innerHeight,I8,50);Nn.position.set(b/2,In,b/2);const Vr=new H2(z8,H8);Vr.layers.enableAll();Mn.add(Vr);const Gr=new z2(k8,V8,G8);Gr.layers.enableAll();Mn.add(Gr);async function Q6(){const i=new B2,e=await i6(i),t=t6(),n=Lr(t,Rr,b,b),s={wallTex:e,carpetTex:t,carpet:Dr(n),lightPanelOn:new Xn({color:os}),lightPanelOff:new Xn({color:W8})},r=new U6(Mn,s),a=new H6(Nn,ze.domElement);r.init(a.position),a.connect();const{composer:o,bloom:l}=Z6(ze,Mn,Nn);let c=!1,u=!1;const h=document.querySelector("#overlay .hint"),f="클릭하여 시작<br />WASD · 이동 &nbsp; Shift · 달리기 &nbsp; Space · 점프 &nbsp; 마우스 · 시야";h&&(h.textContent="주변 공간 생성 중… (처음 한 번만)"),Ln.style.cursor="wait",r.preloadAround(a.position,(A,y)=>{h&&!u&&(h.innerHTML=`주변 공간 생성 중… ${A}/${y}<br/>시야 거리만큼 미리 만들고 있습니다`)}).then(()=>{for(let A=0;A<5;A++)o.render();a.setColliders(r.getColliders()),u=!0,ze.domElement.style.visibility="visible",Ln.style.cursor="pointer",h&&(h.innerHTML=f)}).catch(A=>{console.error(A),u=!0,ze.domElement.style.visibility="visible",Ln.style.cursor="pointer",h&&(h.textContent="로딩 오류 — 새로고침 해주세요.")}),Ln.addEventListener("click",()=>{u&&(a.requestLock(),c||(c=!0,Ln.classList.add("hidden"),J6.classList.add("visible"),j6.classList.add("visible")))});const m=new _r;let g=0;const M=new O0(os),p=16.7;function d(){requestAnimationFrame(d);const A=performance.now(),y=Math.min(m.getDelta(),.05);g+=y,r.tick(y),r.preloading||(r.update(a.position),r.flushColliders()),a.setColliders(r.getColliders()),r.consumeColliderRebuild()&&a.resolvePenetration(),c&&a.update(y);for(const{light:S,panel:I,face:L}of r.getFixtures()){const R=.94+Math.sin(g*8+I.phase)*.04;S.intensity=Ar*I.bright*R,L.material.color.copy(M).multiplyScalar(br*I.bright*R)}if(o.render(),!r.preloading){const S=performance.now()-A;let I=Math.max(3,Math.min(8,p-S));r.hasPendingLoads()&&(I=Math.max(I,14)),r.processLoadQueue(a.position,I)}}d(),window.addEventListener("resize",()=>{const A=window.innerWidth,y=window.innerHeight;Nn.aspect=A/y,Nn.updateProjectionMatrix(),$6(ze,o,l,A,y)})}Q6().catch(i=>{console.error(i);const e=document.querySelector("#overlay .hint");e&&(e.textContent="로딩 오류 — 새로고침 해주세요.")});
