...
`)}function Zo(i,e){let t;switch(e){case w2:t="Linear";break;case R2:t="Reinhard";break;case C2:t="Cineon";break;case mr:t="ACESFilmic";break;case L2:t="AgX";break;case D2:t="Neutral";break;case P2:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const oi=new F;function $o(){G0.getLuminanceCoefficients(oi);const i=oi.x.toFixed(4),e=oi.y.toFixed(4),t=oi.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}function s5(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===dr?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===a2?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===tt&&(e="SHADOWMAP_TYPE_VSM"),e}function a5(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case hn:case fn:e="ENVMAP_TYPE_CUBE";break;case Mi:e="ENVMAP_TYPE_CUBE_UV";break}return e}function o5(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case fn:e="ENVMAP_MODE_REFRACTION";break}return e}function l5(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case pr:e="ENVMAP_BLENDING_MULTIPLY";break;case A2:e="ENVMAP_BLENDING_MIX";break;case b2:e="ENVMAP_BLENDING_ADD";break}return e}function c5(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function u5(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=s5(t),c=a5(t),u=o5(t),h=l5(t),d=c5(t),m=jo(t),v=Jo(s),M=r.createProgram();let p,f,b=t.glslVersion?"#version "+t.glslVersion+`
