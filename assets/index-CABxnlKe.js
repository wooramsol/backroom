...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:mt,depthTest:!1,depthWrite:!1})}function q9(){return new vt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:n9(),fragmentShader:`
		...
		`,blending:mt,depthTest:!1,depthWrite:!1})}function Y9(){return new vt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:n9(),fragmentShader:`
		...
		`,blending:mt,depthTest:!1,depthWrite:!1})}function n9(){return`
...
#define LOW_PRECISION`),e}function a5(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===gr?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===o2?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===tt&&(e="SHADOWMAP_TYPE_VSM"),e}function o5(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case hn:case fn:e="ENVMAP_TYPE_CUBE";break;case Mi:e="ENVMAP_TYPE_CUBE_UV";break}return e}function l5(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case fn:e="ENVMAP_MODE_REFRACTION";break}return e}function c5(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case vr:e="ENVMAP_BLENDING_MULTIPLY";break;case b2:e="ENVMAP_BLENDING_MIX";break;case w2:e="ENVMAP_BLENDING_ADD";break}return e}function u5(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function h5(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=a5(t),c=o5(t),u=l5(t),h=c5(t),d=u5(t),m=Jo(t),v=Qo(s),M=r.createProgram();let p,f,b=t.glslVersion?"#version "+t.glslVersion+`
