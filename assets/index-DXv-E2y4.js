...
#define LOW_PRECISION`),e}function f5(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===vr?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===d2?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===tt&&(e="SHADOWMAP_TYPE_VSM"),e}function d5(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case un:case hn:e="ENVMAP_TYPE_CUBE";break;case Mi:e="ENVMAP_TYPE_CUBE_UV";break}return e}function p5(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case hn:e="ENVMAP_MODE_REFRACTION";break}return e}function m5(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case xr:e="ENVMAP_BLENDING_MULTIPLY";break;case D2:e="ENVMAP_BLENDING_MIX";break;case U2:e="ENVMAP_BLENDING_ADD";break}return e}function _5(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function g5(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=f5(t),c=d5(t),u=p5(t),h=m5(t),d=_5(t),m=r5(t),v=s5(s),M=r.createProgram();let p,f,b=t.glslVersion?"#version "+t.glslVersion+`
