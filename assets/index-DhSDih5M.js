...
`].filter(zs).join(`
`)),o=pl(o),o=Mu(o,t),o=yu(o,t),a=pl(a),a=Mu(a,t),a=yu(a,t),o=Su(o),a=Su(a),t.isRawShaderMaterial!==!0&&(E=`#version 300 es
...
`)+`
`+p);const T=E+m+o,v=E+p+a,R=_u(i,i.VERTEX_SHADER,T),A=_u(i,i.FRAGMENT_SHADER,v);i.attachShader(_,R),i.attachShader(_,A),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function w(L){if(s.debug.checkShaderErrors){const O=i.getProgramInfoLog(_).trim(),z=i.getShaderInfoLog(R).trim(),$=i.getShaderInfoLog(A).trim();let K=!0,X=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(K=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,R,A);else{const Z=vu(i,R,"vertex"),G=vu(i,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      ${e}`))}function QS(s){var i,r;const e=Bd(),t=s.map||null;t&&(t.colorSpace=qe);const n=new Mo({map:t,color:((r=(i=s.color)==null?void 0:i.clone)==null?void 0:r.call(i))??new Me(12564640),emissiveMap:e,emissive:new Me(13421772),emissiveIntensity:.65});return n.userData.chunkOwned=!0,n.userData.chairGlitch=!0,n.onBeforeCompile=o=>{o.uniforms.uGlitchTime={value:0},o.uniforms.uGlitchAmp={value:1},n.userData.glitchUniforms=o.uniforms,o.vertexShader=o.vertexShader.replace("#include <common>",`#include <common>
      ...
      uniform float uGlitchTime;`),JS(o)},n}function eE(s){s.userData.chairGlitch=!0,Qr.add(s),s.traverse(e=>{if(!e.isMesh||!e.material)return;const n=(Array.isArray(e.material)?e.material:[e.material]).map(i=>QS(i));e.material=n.length===1?n[0]:n})}function tE(s,e,t){var i,r;if(!((i=s.isMesh)!=null&&i.material))return;const n=Array.isArray(s.material)?s.material:[s.material];for(const o of n){if(!((r=o.userData)!=null&&r.chairGlitch))continue;const a=o.userData.glitchUniforms;a&&(a.uGlitchTime.value=e,a.uGlitchAmp.value=t),o.emissiveIntensity=.5+Math.random()*.95}}function nE(s,e){if(!Qr.size)return;(Math.floor(e*60)&1)===0&&ZS();const n=(Math.random()<.11?2.2:1)*(1+Math.sin(e*61)*.3+Math.random()*.55);for(const i of Qr){if(!i.parent){Qr.delete(i);continue}i.traverse(r=>tE(r,e,n))}}const vi=new Ot;function iE(s,e,t){e.updateMatrixWorld(!0),vi.setFromObject(s);const n={minX:vi.min.x,maxX:vi.max.x,minZ:vi.min.z,maxZ:vi.max.z,topY:vi.max.y,bottomY:vi.min.y};return t.push(n),n}function sE(s,e,t,n){let i=0;const r=Math.max(.22,t*.38);for(const o of n)s+r>o.minX&&s-r<o.maxX&&e+r>o.minZ&&e-r<o.maxZ&&(i=Math.max(i,o.topY));return i}const Ju=new Ot,Qu={cx:0,cz:0};function rE(s,e,t){e.updateMatrixWorld(!0),Ju.setFromObject(s),s.position.y+=t-Ju.min.y}function oE(s,e,t,n){if(!t||e.cx!==Qu.cx||e.cz!==Qu.cz)return;const i={x:k/2+2.6,z:k/2-2.4,yaw:Math.PI*.12};if(!si(i.x,i.z,e.innerWalls))return;const r=py(t);r.rotation.y=i.yaw,r.position.set(i.x,0,i.z),rE(r,s,0),r.userData.chunkOwned=!0,s.add(r);const o=Od(r,s);o.standable=!1,n.push(o)}function aE(s,e,t,n,i){t&&oE(s,e,t.car,n)}const po=new Ot,eh=new Gt,lE=[["floor_normal",28],["floor_tipped",18],["wall_lean",24],["wall_embedded",14],["ceiling_stuck",10],["floor_embedded",6]],cE=[["floor_normal",38],["floor_tipped",32],["floor_embedded",18],["wall_lean",12]],uE=[["floor_normal",32],["floor_tipped",28],["floor_embedded",14],["ceiling_stuck",10]],hE=[["floor_normal",38],["floor_tipped",32],["floor_embedded",18],["ceiling_stuck",12]];function $i(s,e,t){e.updateMatrixWorld(!0),po.setFromObject(s),s.position.y+=t-po.min.y}function dE(s,e,t){e.updateMatrixWorld(!0),po.setFromObject(s),s.position.y+=t-po.max.y}function Tl(s,e,t=.55,n=48){for(let i=0;i<n;i++){const r=e.range(t,k-t),o=e.range(t,k-t);if(si(r,o,s))return{x:r,z:o}}return null}function fE(s){const e=St*.5+.04,t=.8,n=[{axis:"z",pos:e,span0:t,span1:k-t},{axis:"z",pos:k-e,span0:t,span1:k-t},{axis:"x",pos:e,span0:t,span1:k-t},{axis:"x",pos:k-e,span0:t,span1:k-t}];return[...s,...n]}function pE(s,e,t){if(s.axis==="z"){const r=si(e,s.pos+.55,t),o=si(e,s.pos-.55,t);return r&&!o?.55:o&&!r?-.55:r?.55:-.55}const n=si(s.pos+.55,e,t),i=si(s.pos-.55,e,t);return n&&!i?.55:i&&!n?-.55:n?.55:-.55}function mE(s,e,t,n){const i=[...s];for(let r=i.length-1;r>0;r--){const o=n.int(0,r);[i[r],i[o]]=[i[o],i[r]]}for(let r=0;r<24;r++){const o=i[r%i.length],a=n.range(o.span0+t*.5,o.span1-t*.5),l=pE(o,a,e),c=o.axis==="z"?a:o.pos+l,u=o.axis==="z"?o.pos+l:a;if(!si(c,u,e))continue;const h=o.axis==="z"?l>0?0:Math.PI:l>0?-Math.PI/2:Math.PI/2;return{x:c,z:u,yaw:h,wall:o,offset:l}}return null}function gE(s,e,t,n,i,r){const{height:o,depth:a}=i,l=t.supportY??0;switch(s.rotation.set(0,0,0),s.position.set(t.x,0,t.z),e){case"floor_normal":s.rotation.y=t.yaw??n.range(0,Math.PI*2),$i(s,r,l);break;case"floor_tipped":s.rotation.y=n.range(0,Math.PI*2),eh.set(n.range(1.1,1.65),s.rotation.y,n.range(-.35,.35)),s.setRotationFromEuler(eh),$i(s,r,l+n.range(-.01,.02));break;case"wall_lean":{const c=n.range(.22,.48);s.rotation.y=t.yaw+n.range(-.2,.2),(t.wall.axis==="z"?"x":"z")==="x"?s.rotation.x=t.offset>0?-c:c:s.rotation.z=t.offset>0?c:-c;const h=a*n.range(.22,.42);t.wall.axis==="z"?s.position.z-=Math.sign(t.offset)*h:s.position.x-=Math.sign(t.offset)*h,$i(s,r,l);break}case"wall_embedded":{s.rotation.y=t.yaw+n.range(-.15,.15);const c=a*n.range(.42,.72);t.wall.axis==="z"?s.position.z-=Math.sign(t.offset)*c:s.position.x-=Math.sign(t.offset)*c,s.rotation.x=n.range(-.12,.12),$i(s,r,l+n.range(-.03,.05));break}case"ceiling_stuck":s.rotation.y=n.range(0,Math.PI*2),s.rotation.x=Math.PI+n.range(-.22,.22),s.rotation.z=n.range(-.18,.18),dE(s,r,Ci-.006+n.range(0,o*.22));break;case"floor_embedded":s.rotation.y=n.range(0,Math.PI*2),s.rotation.z=n.range(-.18,.18),$i(s,r,l-o*n.range(.15,.35));break;default:s.rotation.y=n.range(0,Math.PI*2),$i(s,r,l)}}function _E(s,e=!1,t=!1){return t?s.pickWeighted(e?hE:uE):s.pickWeighted(e?cE:lE)}function xE(s,e,t){for(const n of e){const[i,r]=n.split(",").map(Number),o=s.x-i,a=s.z-r;if(o*o+a*a<t*t)return!0}return!1}function vE(s,e,t,n,i,r,o){e.userData.chunkOwned=!0,s.add(e),n.push(Od(e,s)),t.furnitureId==="chairGlb"&&eE(e),iE(e,s,o),i.add(`${r.x.toFixed(2)},${r.z.toFixed(2)}`)}function kd(s,e,t,n,i,r,o,a={}){if(!t)return!1;const l=vd(t),c=l.userData;c.furnitureKind=a.kind||(c.isPile?"pile":"chair");const u=_E(n,a.pileMode,!!a.spot);let h=null;if(a.spot)h={...a.spot,yaw:a.spot.yaw??n.range(0,Math.PI*2)};else if(u==="floor_normal"||u==="floor_tipped"||u==="floor_embedded"){const f=Tl(e.innerWalls,n,c.footprint*.45);if(!f)return!1;h={...f,yaw:n.range(0,Math.PI*2)}}else if(u==="ceiling_stuck"){const f=Tl(e.innerWalls,n,c.footprint*.4);if(!f)return!1;h={...f}}else{const f=fE(e.innerWalls);if(h=mE(f,e.innerWalls,c.footprint,n),!h)return!1}h.supportY=sE(h.x,h.z,c.footprint,o);const d=a.minSep??c.footprint*.72;return xE(h,i,d)?!1:(gE(l,u,h,n,c,s),vE(s,l,c,r,i,h,o),!0)}function th(s,e,t,n,i,r,o){const a=Md(t,n);return kd(s,e,a,n,i,r,o,{kind:"prop"})}function ME(s,e,t,n,i,r,o){const a=Tl(e.innerWalls,n,1.2,72);if(!a)return 0;const l=n.int(2,14),c=n.range(.55,1.35);let u=0;for(let h=0;h<l*5&&u<l;h++){const d=n.range(0,Math.PI*2),f=n.range(.02,c)*Math.sqrt(n.range(.15,1)),g={x:a.x+Math.cos(d)*f,z:a.z+Math.sin(d)*f,yaw:n.range(0,Math.PI*2)};if(g.x<.45||g.x>k-.45||g.z<.45||g.z>k-.45||!si(g.x,g.z,e.innerWalls))continue;const _=Md(t,n);kd(s,e,_,n,i,r,o,{spot:g,pileMode:!0,minSep:.26,kind:"pile"})&&u++}return u}function yE(s,e,t,n=null){var c,u;if(!((c=t==null?void 0:t.allProps)!=null&&c.length)&&!n)return{colliders:[]};const i=[],r=[],o=ms(e.cx,e.cz,881),a=new Set;let l=0;if((u=t==null?void 0:t.allProps)!=null&&u.length&&o.chance(.5)){o.chance(.3)&&(l+=ME(s,e,t,o,a,i,r));const h=l>0?o.int(0,2):o.int(1,2);let d=0;for(let f=0;f<h*6&&d<h;f++)th(s,e,t,o,a,i,r)&&d++;if(l+=d,l===0)for(let f=0;f<4&&!th(s,e,t,o,a,i,r);f++);}return n&&aE(s,e,n,i),s.userData.furnitureColliders=i,{colliders:i}}const nc=new Pi(k,k);nc.translate(k/2,k/2,0);nc.userData.shared=!0;const zd=new Pi(Cu,Cu);zd.userData.shared=!0;const Hd=new Pi(Fv,Ov);Hd.userData.shared=!0;const nh=new en().setFromEuler(new Gt(Math.PI/2,0,0)),Hr=new I,ih=new I(1,1,1),Gr=new Ne;function sh(s,e=Ci){s.boundingSphere=new xn(new I(k/2,e*.5,k/2),Math.hypot(k,e)*.75)}function SE(s,e,t,n,i,r){const{geometry:o}=$S(e,t.wallTex,n,i,r);if(o){o.computeBoundingBox(),o.computeBoundingSphere();const a=new At(o,t.wall);a.frustumCulled=!1,s.add(a)}}function EE(s,e,t,n){const i=nc.clone();Xv(i,gl,t,n);const r=new At(i,e.floor);r.rotation.x=-Math.PI/2,r.frustumCulled=!1,s.add(r)}function TE(s,e,t,n,i){const{gapY:r,tileY:o}=zS(e),a=Eo,{tx0:l,tx1:c,tz0:u,tz1:h}=kS(n,i,k,a),d=[];for(let m=l;m<=c;m++)for(let p=u;p<=h;p++){const{x:E,z:T}=BS(m,p,n,i,a);d.push(E,T)}const f=d.length/2,g=new hl(Hd,t.ceilingGroove,f),_=new hl(zd,t.ceilingTile,f);g.frustumCulled=!1,_.frustumCulled=!1,_.renderOrder=2;for(let m=0;m<f;m++){const p=d[m*2],E=d[m*2+1];Hr.set(p,r,E),Gr.compose(Hr,nh,ih),g.setMatrixAt(m,Gr),Hr.set(p,o,E),Gr.compose(Hr,nh,ih),_.setMatrixAt(m,Gr)}g.instanceMatrix.needsUpdate=!0,_.instanceMatrix.needsUpdate=!0,sh(g,e),sh(_,e),s.add(g),s.add(_)}function bE(s){s.traverse(e=>{var n;if(e.frustumCulled=!1,e.isInstancedMesh||!e.isMesh)return;const t=e.geometry;t&&!((n=t.userData)!=null&&n.shared)&&(t.computeBoundingBox(),t.computeBoundingSphere())})}function Gd(s,e,t=null,n=null){const i=new kt;return i.position.set(s.cx*k,0,s.cz*k),{room:s,group:i,materials:e,furnitureModels:t,specialAssets:n,shellDone:!1,worldX:s.cx*k,worldZ:s.cz*k}}function Vd(s){if(s.shellDone)return;const{room:e,group:t,materials:n}=s,i=e.height;EE(t,n,s.worldX,s.worldZ),TE(t,i,n,s.worldX,s.worldZ),SE(t,e,n,i,s.worldX,s.worldZ),s.furnitureModels&&yE(t,e,s.furnitureModels,s.specialAssets),s.shellDone=!0}function AE(s,e){return s.shellDone||Vd(s),!0}function Wd(s){const{group:e,room:t}=s;return e.userData.room=t,bE(e),e.frustumCulled=!1,e}function rh(s,e,t=null,n=null){const i=Gd(s,e,t,n);return Vd(i),Wd(i)}const wE=["map","normalMap","roughnessMap","metalnessMap","aoMap","emissiveMap","alphaMap","bumpMap"];function oh(s){var e,t;if((e=s==null?void 0:s.userData)!=null&&e.chunkOwned){for(const n of wE){const i=s[n];(t=i==null?void 0:i.userData)!=null&&t.chunkOwned&&i.dispose()}s.dispose()}}function RE(s){var t;const e=s.geometry;if(e&&!((t=e.userData)!=null&&t.shared)&&e.dispose(),!!s.material)if(Array.isArray(s.material))for(const n of s.material)oh(n);else oh(s.material)}function ah(s){s&&s.traverse(e=>{e.isLight||(e.isMesh||e.isInstancedMesh)&&RE(e)})}const lh=2,ch=2,CE=2;class LE{constructor(e,t,n=null,i=null){this.scene=e,this.materials=t,this.furnitureModels=n,this.specialAssets=i,this.chunks=new Map,this.wallMap=new Map,this.colliders=[],this.collidersDirty=!1,this.time=0,this.loadQueue=[],this.pendingKeys=new Set,this.disposeQueue=[],this.despawnPending=[],this.cellCx=NaN,this.cellCz=NaN,this.lastPrefetchEdge=!1,this.preloading=!1}key(e,t){return`${e},${t}`}distToPlayer(e,t,n){const i=e*k+k/2-n.x,r=t*k+k/2-n.z;return i*i+r*r}nearPrefetchEdge(e,t,n){const i=e.x-t*k,r=e.z-n*k,o=k*Ds;return i>o||i<k-o||r>o||r<k-o}ringKeys(e,t,n){const i=new Set;for(let r=t-n;r<=t+n;r++)for(let o=e-n;o<=e+n;o++)i.add(this.key(o,r));return i}computeNeed(e,t,n,i=Jl){const r=this.ringKeys(e,t,i),o=n.x-e*k,a=n.z-t*k,l=i+1;if(o>k*Ds)for(let c=t-i;c<=t+i;c++)r.add(this.key(e+l,c));if(o<k*(1-Ds))for(let c=t-i;c<=t+i;c++)r.add(this.key(e-l,c));if(a>k*Ds)for(let c=e-i;c<=e+i;c++)r.add(this.key(c,t+l));if(a<k*(1-Ds))for(let c=e-i;c<=e+i;c++)r.add(this.key(c,t-l));return r}insertJob(e){const t=e.dist;let n=0,i=this.loadQueue.length;for(;n<i;){const r=n+i>>1;this.loadQueue[r].dist<t?n=r+1:i=r}this.loadQueue.splice(n,0,e)}rebuildColliderList(){const e=OS(this.wallMap);for(const t of this.chunks.values()){const n=t.furnitureColliders;n!=null&&n.length&&e.push(...n)}this.colliders=e,this.collidersDirty=!1}_markCollidersDirty(){this.collidersDirty=!0}addCollidersForRoom(e){Xu(this.wallMap,e),this.rebuildColliderList()}removeCollidersForRoom(e){Yu(this.wallMap,e)&&this.rebuildColliderList()}addFurnitureForChunk(e){const t=e.userData.furnitureColliders||[];return this._markCollidersDirty(),{furnitureColliders:t}}removeFurnitureForChunk(e){this._markCollidersDirty()}consumeColliderRebuild(){return this.collidersDirty?(this.rebuildColliderList(),!0):!1}attachChunk(e,t,n,i){const r=this.key(e,t);Wd(i);const o=i.group,a=this.addFurnitureForChunk(o);this.chunks.set(r,{mesh:o,room:n,...a})}spawnComplete(e,t){const n=ya(e,t);this.addCollidersForRoom(n);const i=rh(n,this.materials,this.furnitureModels,this.specialAssets),r=this.addFurnitureForChunk(i);this.scene.add(i),this.chunks.set(this.key(e,t),{mesh:i,room:n,...r})}despawn(e){const t=this.chunks.get(e);if(!t)return;const{mesh:n,room:i}=t;n&&(this.scene.remove(n),this.disposeQueue.push(n)),this.chunks.delete(e),i&&(this.removeCollidersForRoom(i),US(i.cx,i.cz))}enqueue(e,t,n){const i=this.key(e,t);this.chunks.has(i)||this.pendingKeys.has(i)||(this.pendingKeys.add(i),this.insertJob({cx:e,cz:t,dist:this.distToPlayer(e,t,n),room:null,build:null}))}init(e){const t=Math.floor(e.x/k),n=Math.floor(e.z/k);this.cellCx=t,this.cellCz=n,this.lastPrefetchEdge=this.nearPrefetchEdge(e,t,n),this.spawnComplete(t,n)}update(e){if(this.preloading)return;const t=Math.floor(e.x/k),n=Math.floor(e.z/k),i=this.nearPrefetchEdge(e,t,n);if(t===this.cellCx&&n===this.cellCz&&i===this.lastPrefetchEdge&&!this.loadQueue.length&&!this.despawnPending.length)return;this.cellCx=t,this.cellCz=n,this.lastPrefetchEdge=i;const r=this.computeNeed(t,n,e),o=new Set(this.despawnPending);for(const a of this.chunks.keys()){if(r.has(a)||o.has(a))continue;const[l,c]=a.split(",").map(Number);Math.max(Math.abs(l-t),Math.abs(c-n))>Lv&&this.despawnPending.push(a)}this.loadQueue=this.loadQueue.filter(a=>{var c;const l=this.key(a.cx,a.cz);return r.has(l)?!0:(a.room&&!this.chunks.has(l)&&(Yu(this.wallMap,a.room),this._markCollidersDirty()),(c=a.build)!=null&&c.group&&(a.build.group.parent&&this.scene.remove(a.build.group),ah(a.build.group)),!1)});for(const a of this.pendingKeys)!r.has(a)&&!this.chunks.has(a)&&this.pendingKeys.delete(a);for(const a of r)if(!this.chunks.has(a)){const[l,c]=a.split(",").map(Number);this.enqueue(l,c,e)}}processLoadQueue(e){let t=0;for(;this.loadQueue.length&&t<CE;){const n=this.loadQueue[0],i=this.key(n.cx,n.cz);if(!n.room){n.room=ya(n.cx,n.cz),n.build=Gd(n.room,this.materials,this.furnitureModels,this.specialAssets),this.chunks.has(i)||(Xu(this.wallMap,n.room),this._markCollidersDirty());continue}n.build.shellDone||AE(n.build),n.build.group.parent||this.scene.add(n.build.group),this.attachChunk(n.cx,n.cz,n.room,n.build),this.loadQueue.shift(),this.pendingKeys.delete(i),t++}}tick(e){this.time+=e;for(let t=0;t<lh&&this.disposeQueue.length;t++)ah(this.disposeQueue.shift());for(let t=0;t<lh&&this.despawnPending.length;t++)this.despawn(this.despawnPending.shift())}getColliders(){return this.colliders}_spawnChunkComplete(e,t){const n=this.key(e,t),i=ya(e,t);this.addCollidersForRoom(i);const r=rh(i,this.materials,this.furnitureModels,this.specialAssets),o=this.addFurnitureForChunk(r);this.scene.add(r),this.chunks.set(n,{mesh:r,room:i,...o}),this.pendingKeys.delete(n)}_spawnChunkSafe(e,t){try{this._spawnChunkComplete(e,t)}catch(n){throw console.error(`Chunk build failed (${e}, ${t})`,n),n}}async preloadAround(e,t){const n=e.position,i=Math.floor(n.x/k),r=Math.floor(n.z/k),o=[];for(let a=r-Dr;a<=r+Dr;a++)for(let l=i-Dr;l<=i+Dr;l++)this.chunks.has(this.key(l,a))||o.push({cx:l,cz:a});o.sort((a,l)=>this.distToPlayer(a.cx,a.cz,n)-this.distToPlayer(l.cx,l.cz,n)),this.preloading=!0,this.loadQueue.length=0,this.pendingKeys.clear();try{const a=o.length;let l=0;for(let c=0;c<o.length;c+=ch){const u=Math.min(c+ch,o.length);for(let h=c;h<u;h++){const{cx:d,cz:f}=o[h];this._spawnChunkSafe(d,f),l++}t==null||t(l,a||1),await new Promise(h=>requestAnimationFrame(h))}this.rebuildColliderList(),t==null||t(a||1,a||1)}finally{this.preloading=!1}}hasPendingLoads(){return!this.preloading&&this.loadQueue.length>0}}const PE=3.2,IE=5.8,DE=9,UE=.035,NE=.018,Mn=.09,FE=.44,uh=new Gt(0,0,0,"YXZ"),OE=new I(0,1,0),Nn=new I,Vr=new I,cn=new I;class BE{constructor(e,t){this.camera=e,this.domElement=t,this.position=new I(k/2,bi,k/2),this.yaw=0,this.pitch=0,this.keys={},this.locked=!1,this.mobileMode=!1,this.mobileActive=!1,this.mobileMove={x:0,y:0},this.mobileControls=null,this.colliders=[],this.bob=0,this.vy=0,this.grounded=!0,this.groundY=0,this._jumpFromY=0,this.crouchBlend=0,this.onMove=null,this.onJump=null,this.onLand=null,this.onLockLost=null,this.onLockAcquired=null,this.camera.rotation.order="YXZ",this._onKeyDown=n=>{var i;n.code==="Space"&&(n.preventDefault(),this.locked&&this.grounded&&!this.crouching&&(this.vy=Pr,this.grounded=!1,this._jumpFromY=this.groundY,(i=this.onJump)==null||i.call(this))),this.keys[n.code]=!0,n.code==="KeyR"&&this._unstuck()},this._onKeyUp=n=>{this.keys[n.code]=!1},this._onMouseMove=n=>{this.locked&&(this.yaw-=n.movementX*wu,this.pitch-=n.movementY*wu,this.pitch=hn.clamp(this.pitch,-Ir,Ir))},this._onLockChange=()=>{var i,r;const n=this.locked;this.locked=document.pointerLockElement===this.domElement,n&&!this.locked?(this._clearKeys(),(i=this.onLockLost)==null||i.call(this)):!n&&this.locked&&((r=this.onLockAcquired)==null||r.call(this))},this._onVisibility=()=>{document.hidden&&this._clearKeys()},this._onBlur=()=>{this._clearKeys()}}get crouching(){return this.inputActive&&!!this.keys.KeyC}get inputActive(){return this.locked||this.mobileMode&&this.mobileActive}isLocomoting(){var e;if(!this.inputActive)return!1;if(this.mobileMode&&this.mobileActive){const t=((e=this.mobileControls)==null?void 0:e.move)??this.mobileMove;return(t.strength??Math.hypot(t.x,t.y))>.08}return!!(this.keys.KeyW||this.keys.KeyS||this.keys.KeyA||this.keys.KeyD||this.keys.ArrowUp||this.keys.ArrowDown||this.keys.ArrowLeft||this.keys.ArrowRight)}_eyeHeight(){return hn.lerp(bi,fv,this.crouchBlend)}_collisionRadius(){return hn.lerp(Ai,pv,this.crouchBlend)}_clearKeys(){this.keys={}}connect(){window.addEventListener("keydown",this._onKeyDown),window.addEventListener("keyup",this._onKeyUp),document.addEventListener("mousemove",this._onMouseMove),document.addEventListener("pointerlockchange",this._onLockChange),document.addEventListener("visibilitychange",this._onVisibility),window.addEventListener("blur",this._onBlur)}setMobileMode(e,t=null){this.mobileMode=e,this.mobileControls=t}startMobile(){var e;this.mobileActive=!0,(e=this.onLockAcquired)==null||e.call(this)}requestLock(){this.mobileMode||this.locked||this.domElement.requestPointerLock()}isLocked(){return this.locked}setColliders(e){this.colliders=e}_unstuck(){this.crouchBlend=0,this.position.set(k/2,bi,k/2),this.vy=0,this.grounded=!0,this.groundY=0,this._jumpFromY=0}_feetY(){return this.position.y-this._eyeHeight()}_horizontalProbeY(){return hn.lerp(this.position.y,this._feetY()+mv*.42,this.crouchBlend)}_overlapsXZ(e,t,n,i=this._collisionRadius()){return!(e+i<=n.minX||e-i>=n.maxX||t+i<=n.minZ||t-i>=n.maxZ)}_maxJumpFeet(){return Pr*Pr/(2*Jr)}_canStandOn(e,t=this._jumpFromY){const n=e-t;return n<=Mn?!0:e>ed+.01?!1:n<=this._maxJumpFeet()+FE}_standingFeetY(e,t){if(this.groundY<=Mn)return 0;for(const n of this.colliders)if(!(!n.standable||n.standTopY===void 0)&&this._overlapsXZ(e,t,n,Ai)&&Math.abs(this.groundY-n.standTopY)<Mn)return n.standTopY;return null}_syncPose(){this.position.y=this.groundY+this._eyeHeight()}_landingFeetY(e,t,n,i,r){if(i>0)return null;const o=n+i*r;let a=null;o<=Mn&&(a=0);for(const l of this.colliders){if(!l.standable||l.standTopY===void 0||!this._overlapsXZ(e,t,l,Ai))continue;const c=l.standTopY;if(!this._canStandOn(c,this._jumpFromY))continue;const u=n>=c-Mn&&o<=c+Mn,h=o<=c+Mn&&n>=c-.55&&n<=c+Mn*1.5;!u&&!h||(a===null||c>a)&&(a=c)}return a}_applyLook(e=0){this.camera.position.set(this.position.x,this.position.y+e,this.position.z),this.camera.up.set(0,1,0),uh.set(this.pitch,this.yaw,0),this.camera.quaternion.setFromEuler(uh),this.camera.updateMatrixWorld(!0)}_syncWalkFromCamera(){this.camera.getWorldDirection(Nn),Nn.y=0,Nn.lengthSq()<1e-10?Nn.set(0,0,-1):Nn.normalize(),Vr.crossVectors(Nn,OE).normalize()}_blocksHorizontal(e,t){if(e.isCeiling)return!1;const n=e.standTopY??e.maxY;if(e.isFurniture&&n!==void 0){if(this.grounded&&this.groundY>=n-Mn)return!1;const i=this.grounded?this.groundY:this._feetY();if(i<n-Mn){const r=this.grounded?this.groundY:this._jumpFromY;if(!this._canStandOn(n,r)&&i>=e.minY-.2&&i<=n+.15)return!0}}return!(t<e.minY-.2||t>e.maxY+.2)}_insideWall(e,t){const n=this._horizontalProbeY(),i=this._collisionRadius();for(const r of this.colliders)if(this._blocksHorizontal(r,n)&&!(e+i<=r.minX||e-i>=r.maxX||t+i<=r.minZ||t-i>=r.maxZ))return!0;return!1}_pushOut(e,t){const n=this._horizontalProbeY(),i=this._collisionRadius();for(let r=0;r<14;r++){let o=!1;for(const a of this.colliders){if(!this._blocksHorizontal(a,n)||e+i<=a.minX||e-i>=a.maxX||t+i<=a.minZ||t-i>=a.maxZ)continue;const l=e+i-a.minX,c=a.maxX-(e-i),u=t+i-a.minZ,h=a.maxZ-(t-i),d=Math.min(l,c,u,h);d===l?e-=l:d===c?e+=c:d===u?t-=u:t+=h,o=!0}if(!o)break}return{px:e,pz:t}}resolvePenetration(){if(!this._insideWall(this.position.x,this.position.z))return;const e=this._pushOut(this.position.x,this.position.z);this.position.x=e.px,this.position.z=e.pz}_applyMobileLook(){if(!this.mobileMode||!this.mobileActive||!this.mobileControls)return;const{dx:e,dy:t}=this.mobileControls.consumeLook();e===0&&t===0||(this.yaw-=e*Ru,this.pitch-=t*Ru,this.pitch=hn.clamp(this.pitch,-Ir,Ir))}_tryMobileJump(){var e;!this.mobileMode||!this.mobileActive||!this.mobileControls||this.mobileControls.consumeJump()&&this.grounded&&!this.crouching&&(this.vy=Pr,this.grounded=!1,this._jumpFromY=this.groundY,(e=this.onJump)==null||e.call(this))}update(e){var _,m,p;if(!this.inputActive)return;this._applyMobileLook(),this._tryMobileJump();const t=this.crouching?1:0;this.crouchBlend+=(t-this.crouchBlend)*Math.min(1,_v*e),this.grounded&&this._syncPose(),this._applyLook(0),this._syncWalkFromCamera(),cn.set(0,0,0);let n=0;if(this.mobileMode&&this.mobileActive){const E=((_=this.mobileControls)==null?void 0:_.move)??this.mobileMove,{x:T,y:v}=E;n=E.strength??Math.hypot(T,v),cn.addScaledVector(Nn,-v),cn.addScaledVector(Vr,T)}else(this.keys.KeyW||this.keys.ArrowUp)&&cn.add(Nn),(this.keys.KeyS||this.keys.ArrowDown)&&cn.sub(Nn),(this.keys.KeyA||this.keys.ArrowLeft)&&cn.sub(Vr),(this.keys.KeyD||this.keys.ArrowRight)&&cn.add(Vr);const i=this.keys.ShiftLeft||this.keys.ShiftRight,r=this.mobileMode&&this.mobileActive&&n>=Av,o=!this.crouching&&(i||r),a=this.crouching?gv:o?IE:PE,l=this.position.x,c=this.position.z;let u=0;if(cn.lengthSq()>0){cn.normalize().multiplyScalar(a*e);const E=this.position.x+cn.x,T=this.position.z+cn.z;if(!this._insideWall(E,T))this.position.x=E,this.position.z=T;else{const v=this._pushOut(E,T);this.position.x=v.px,this.position.z=v.pz}u=Math.hypot(this.position.x-l,this.position.z-c),this.grounded&&(this.bob+=e*DE*(this.crouching?.75:o?1.3:1))}else this.grounded&&(this.bob*=.85);u>0&&this.grounded&&((m=this.onMove)==null||m.call(this,u,o,this.crouching,a));const h=this.grounded,d=this._feetY();if(this.grounded){const E=this._standingFeetY(this.position.x,this.position.z);E===null?(this.grounded=!1,this.vy-=Jr*e,this.position.y+=this.vy*e):(this.groundY=E,this._syncPose(),this.vy=0)}else{this.vy-=Jr*e;let E=this.position.y+this.vy*e;E>ml&&(E=ml,this.vy=0);const T=this._landingFeetY(this.position.x,this.position.z,d,this.vy,e);if(T!==null){const v=Math.abs(this.vy);this.groundY=T,this._syncPose(),this.vy=0,this.grounded=!0,h||(p=this.onLand)==null||p.call(this,v)}else this.position.y=E}this.resolvePenetration();const f=hn.lerp(UE,NE,this.crouchBlend),g=this.grounded?Math.sin(this.bob)*f:0;this._applyLook(g)}}const kE="/backroom/",zE=`${kE}assets/${encodeURIComponent("01. Government Funding.mp3")}`,HE=2,GE=2.75,VE=1.4;class WE{constructor(){this.ctx=null,this.master=null,this.sfxGain=null,this.bgmGain=null,this.bgmBuffer=null,this.bgmSource=null,this._stepAccum=0,this._bgmLoading=null}_ensure(){if(this.ctx)return!0;try{return this.ctx=new AudioContext,this.master=this.ctx.createGain(),this.master.gain.value=1,this.master.connect(this.ctx.destination),this.sfxGain=this.ctx.createGain(),this.sfxGain.gain.value=2.1,this.sfxGain.connect(this.master),!0}catch{return!1}}async preload(){return this.bgmBuffer?this.bgmBuffer:this._bgmLoading?this._bgmLoading:(this._bgmLoading=fetch(zE).then(e=>{if(!e.ok)throw new Error(`BGM load failed: ${e.status}`);return e.arrayBuffer()}).then(e=>this._ensure()?this.ctx.decodeAudioData(e):null).then(e=>(this.bgmBuffer=e,e)).catch(e=>(console.warn("[audio] background music unavailable",e),null)),this._bgmLoading)}start(){if(!this._ensure()||(this.ctx.state==="suspended"&&this.ctx.resume(),this.bgmSource))return;const e=()=>{if(!this.bgmBuffer||this.bgmSource)return;const t=this.ctx.createBufferSource();t.buffer=this.bgmBuffer,t.loop=!0,this.bgmGain=this.ctx.createGain(),this.bgmGain.gain.value=.42,t.connect(this.bgmGain),this.bgmGain.connect(this.master),t.start(),this.bgmSource=t};if(this.bgmBuffer){e();return}this.preload().then(e)}onLand(e=4){if(!this._ensure())return;this.ctx.state==="suspended"&&this.ctx.resume();const t=Math.min(1,Math.max(.3,e/7.5));this._stepAccum=0,this._playFootstep(!1,!1,{land:!0,impact:t})}onJump(){this._ensure()&&(this.ctx.state==="suspended"&&this.ctx.resume(),this._playFootstep(!1,!1,{jump:!0}))}onMove(e,t,n=!1,i=3.2){if(!this._ensure()||(this.ctx.state==="suspended"&&this.ctx.resume(),e<1e-5||i<.1))return;this._stepAccum+=e;const o=i/(n?VE:t?GE:HE);for(;this._stepAccum>=o;)this._stepAccum-=o,this._playFootstep(t,n)}_playFootstep(e,t,{jump:n=!1,land:i=!1,impact:r=1}={}){const o=this.ctx,a=o.currentTime;let l,c,u,h,d;n?(l=.065,c=.22,u=128,h=860,d=250):i?(l=.12,c=.3+r*.38,u=72+r*48,h=620,d=175):(l=t?.12:e?.075:.1,c=t?.24:e?.42:.34,u=t?88:e?118:102,h=t?480:e?1050:780,d=t?165:e?285:220);const f=o.createOscillator();f.type="sine",f.frequency.value=u+Math.random()*28;const g=o.createGain();g.gain.setValueAtTime(c*1.35,a),g.gain.exponentialRampToValueAtTime(.001,a+l),f.connect(g),g.connect(this.sfxGain),f.start(a),f.stop(a+l+.02);const _=Math.max(1,Math.floor(o.sampleRate*l)),m=o.createBuffer(1,_,o.sampleRate),p=m.getChannelData(0);for(let A=0;A<_;A++){const w=Math.pow(1-A/_,1.4);p[A]=(Math.random()*2-1)*w}const E=o.createBufferSource();E.buffer=m;const T=o.createBiquadFilter();T.type="lowpass",T.frequency.value=h,T.Q.value=.55;const v=o.createBiquadFilter();v.type="bandpass",v.frequency.value=d+Math.random()*70,v.Q.value=.65;const R=o.createGain();R.gain.setValueAtTime(c,a),R.gain.exponentialRampToValueAtTime(.001,a+l*.92),E.connect(T),T.connect(v),v.connect(R),R.connect(this.sfxGain),E.start(a),E.stop(a+l+.02)}}const XE={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		}`};function Xd(){if(typeof window>"u")return!1;const s=window.matchMedia("(pointer: coarse)").matches,e=navigator.maxTouchPoints>0,t=/Android|iPhone|iPad|iPod|Mobile|webOS|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);return s&&e||t}function mo(){return typeof window>"u"||window.matchMedia("(orientation: landscape)").matches?!0:window.matchMedia("(orientation: portrait)").matches?!1:window.innerWidth>=window.innerHeight}function wo(){if(typeof window>"u")return{width:800,height:600};let s=window.innerWidth,e=window.innerHeight;const t=mo();return t&&s<e?[s,e]=[e,s]:!t&&s>e&&([s,e]=[e,s]),{width:Math.max(1,s),height:Math.max(1,e)}}function Yd(){if(typeof window>"u")return{width:800,height:600,top:0,left:0};const s=window.visualViewport;if(s){let n=Math.max(0,Math.round(s.offsetTop));const i=Math.max(0,Math.round(s.offsetLeft)),r=Math.max(1,Math.round(s.width));let o=Math.max(1,Math.round(s.height));const a=Math.max(0,Math.round(s.pageTop-window.scrollY));a>n&&(n=a);const l=Math.round(-document.documentElement.getBoundingClientRect().top);if(l>n&&(n=l),Xd()&&mo()){const c=Math.max(0,Math.round(window.innerHeight-s.height-s.offsetTop));n===0&&c>0&&(n=c)}return o=Math.max(1,Math.min(o,Math.round(window.innerHeight-n))),{width:r,height:o,top:n,left:i}}const{width:e,height:t}=wo();return{width:e,height:t,top:0,left:0}}function eT(s=Yd()){if(typeof document>"u")return s;const e=document.documentElement;return e.style.setProperty("--vv-top",`${s.top}px`),e.style.setProperty("--vv-left",`${s.left}px`),e.style.setProperty("--vv-width",`${s.width}px`),e.style.setProperty("--vv-height",`${s.height}px`),s}function Sa(s,e=Yd()){s&&(s.style.position="fixed",s.style.top=`${e.top}px`,s.style.left=`${e.left}px`,s.style.width=`${e.width}px`,s.style.height=`${e.height}px`,s.style.right="auto",s.style.bottom="auto",s.style.boxSizing="border-box")}function ri(s){s(),requestAnimationFrame(()=>{s(),requestAnimationFrame(s)});for(const e of[120,320,520])window.setTimeout(s,e)}let tT=0;function nT(){return tT}const iT={uniforms:{tDiffuse:{value:null},time:{value:0},resolution:{value:new Oe(1280,720)},intensity:{value:.16},blurAmount:{value:.58},wobble:{value:.0022},glitchBoost:{value:0}},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
      gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
  ...
  `};function sT(){return new ic(iT)}function rT(s,e){s.uniforms.time.value=e,s.uniforms.glitchBoost.value=nT()}function qd(s,e,t,n=1){s.uniforms.resolution.value.set(e*n,t*n)}function sc(s){return s.getPixelRatio()*Bv}function Kd(s,e,t){const n=sc(s);return new Oe(1/(e*n),1/(t*n))}function oT(s,e,t){const{width:n,height:i}=wo(),r=sc(s),o=new ZE(s);o.setPixelRatio(r),o.setSize(n,i),o.addPass(new JE(e,t));const a=new ic(QE);a.material.uniforms.resolution.value.copy(Kd(s,n,i)),o.addPass(a);const l=sT();return qd(l,n,i,r),o.addPass(l),{composer:o,fxaa:a,noise:l,render(c=0){rT(l,c),o.render()}}}function aT(s,e,t,n){const i=sc(s);s.setSize(t,n,!1),e.composer.setPixelRatio(i),e.composer.setSize(t,n),e.fxaa.material.uniforms.resolution.value.copy(Kd(s,t,n)),qd(e.noise,t,n,i)}const lT="1.0.0",cT="277",uT="2026-06-26 18:20:01",hT="dev";function dT(){const s=[`v${lT}`];return s.push(`PR #${cT}`),s.push(uT,hT),s.join(" · ")}const fT=52,pT=.12;class mT{constructor(e){this.root=e,this.active=!1,this.move={x:0,y:0,strength:0},this.look={dx:0,dy:0},this._jumpQueued=!1,this._stickBase=e.querySelector(".mc-stick-base"),this._stickKnob=e.querySelector(".mc-stick-knob"),this._lookZone=e.querySelector(".mc-look-zone"),this._btnJump=e.querySelector(".mc-btn-jump"),this._stickTouchId=null,this._stickOrigin={x:0,y:0},this._lookTouchId=null,this._lookLast={x:0,y:0},this._onStickStart=t=>this._stickDown(t),this._onStickMove=t=>this._stickMove(t),this._onStickEnd=t=>this._stickUp(t),this._onLookStart=t=>this._lookDown(t),this._onLookMove=t=>this._lookMove(t),this._onLookEnd=t=>this._lookUp(t),this._onJump=t=>{var n;t.preventDefault(),this._jumpQueued=!0,(n=this._btnJump)==null||n.classList.add("pressed"),window.setTimeout(()=>{var i;return(i=this._btnJump)==null?void 0:i.classList.remove("pressed")},120)}}mount(){var e,t,n,i,r,o,a,l,c;(e=this._stickBase)==null||e.addEventListener("touchstart",this._onStickStart,{passive:!1}),(t=this._stickBase)==null||t.addEventListener("touchmove",this._onStickMove,{passive:!1}),(n=this._stickBase)==null||n.addEventListener("touchend",this._onStickEnd),(i=this._stickBase)==null||i.addEventListener("touchcancel",this._onStickEnd),(r=this._lookZone)==null||r.addEventListener("touchstart",this._onLookStart,{passive:!1}),(o=this._lookZone)==null||o.addEventListener("touchmove",this._onLookMove,{passive:!1}),(a=this._lookZone)==null||a.addEventListener("touchend",this._onLookEnd),(l=this._lookZone)==null||l.addEventListener("touchcancel",this._onLookEnd),(c=this._btnJump)==null||c.addEventListener("touchstart",this._onJump,{passive:!1})}show(){this.active=!0,this.root.hidden=!1,this.root.classList.add("visible")}hide(){this.active=!1,this.root.classList.remove("visible"),this.root.hidden=!0,this._reset()}consumeJump(){return this._jumpQueued?(this._jumpQueued=!1,!0):!1}consumeLook(){const e=this.look.dx,t=this.look.dy;return this.look.dx=0,this.look.dy=0,{dx:e,dy:t}}_reset(){var e,t;this.move.x=0,this.move.y=0,this.move.strength=0,this.look.dx=0,this.look.dy=0,this._jumpQueued=!1,this._stickTouchId=null,this._lookTouchId=null,(e=this._btnJump)==null||e.classList.remove("pressed"),(t=this._stickKnob)==null||t.style.setProperty("transform","translate(-50%, -50%)")}_stickDown(e){if(!this.active||this._stickTouchId!==null)return;const t=e.changedTouches[0];if(!t)return;e.preventDefault(),this._stickTouchId=t.identifier;const n=this._stickBase.getBoundingClientRect();this._stickOrigin.x=n.left+n.width/2,this._stickOrigin.y=n.top+n.height/2,this._updateStick(t.clientX,t.clientY)}_stickMove(e){if(this._stickTouchId===null)return;const t=this._findTouch(e,this._stickTouchId);t&&(e.preventDefault(),this._updateStick(t.clientX,t.clientY))}_stickUp(e){var n;this._stickTouchId===null||!this._findTouch(e,this._stickTouchId)&&e.type!=="touchcancel"||(this._stickTouchId=null,this.move.x=0,this.move.y=0,this.move.strength=0,(n=this._stickKnob)==null||n.style.setProperty("transform","translate(-50%, -50%)"))}_updateStick(e,t){var u;let n=e-this._stickOrigin.x,i=t-this._stickOrigin.y;const r=Math.hypot(n,i),o=fT;r>o&&(n=n/r*o,i=i/r*o),(u=this._stickKnob)==null||u.style.setProperty("transform",`translate(calc(-50% + ${n}px), calc(-50% + ${i}px))`);const a=n/o,l=i/o,c=Math.hypot(a,l);c<pT?(this.move.x=0,this.move.y=0,this.move.strength=0):(this.move.x=a,this.move.y=l,this.move.strength=c)}_lookDown(e){if(!this.active||this._lookTouchId!==null)return;const t=e.changedTouches[0];t&&(e.preventDefault(),this._lookTouchId=t.identifier,this._lookLast.x=t.clientX,this._lookLast.y=t.clientY)}_lookMove(e){if(this._lookTouchId===null)return;const t=this._findTouch(e,this._lookTouchId);t&&(e.preventDefault(),this.look.dx+=t.clientX-this._lookLast.x,this.look.dy+=t.clientY-this._lookLast.y,this._lookLast.x=t.clientX,this._lookLast.y=t.clientY)}_lookUp(e){this._lookTouchId===null||!this._findTouch(e,this._lookTouchId)&&e.type!=="touchcancel"||(this._lookTouchId=null)}_findTouch(e,t){for(const n of e.changedTouches)if(n.identifier===t)return n;for(const n of e.touches)if(n.identifier===t)return n;return null}}const Dt=Xd();document.documentElement.classList.toggle("mobile",Dt);if(Dt){const s=document.querySelector("#overlay .hint-controls");s&&(s.innerHTML="Move: left stick (tilt to run)<br />Look: drag right<br />Jump: button")}const Jn=document.getElementById("overlay"),gT=document.getElementById("hud"),_T=document.getElementById("vignette"),os=document.getElementById("crosshair"),dh=document.getElementById("build-label"),Ea=document.getElementById("build-badge"),fh=document.getElementById("build-version"),jt=document.getElementById("resume-prompt"),bl=document.getElementById("mobile-controls"),Si=document.getElementById("portrait-prompt"),Qn=Dt&&bl?new mT(bl):null;Qn&&Qn.mount();const $d=dT();dh&&(dh.textContent=$d);fh&&(fh.textContent=$d);const go=wo(),Mt=new hv({antialias:!1,powerPreference:"high-performance"});Mt.setPixelRatio(Math.min(window.devicePixelRatio,1));Mt.setSize(go.width,go.height,!1);Mt.outputColorSpace=qe;Mt.toneMapping=mh;Mt.toneMappingExposure=kv;document.body.appendChild(Mt.domElement);function xs(){const s=eT();Jn&&(Jn.scrollTop=0),Sa(Si,s),Sa(bl,s),Sa(jt,s)}xs();window.addEventListener("resize",()=>ri(xs));window.addEventListener("orientationchange",()=>ri(xs));window.visualViewport&&(window.visualViewport.addEventListener("resize",()=>ri(xs)),window.visualViewport.addEventListener("scroll",()=>ri(xs)));function jd(s){s.style.position="fixed",s.style.inset="0",s.style.width="100%",s.style.height="100%",s.style.display="block",s.style.zIndex="1",s.style.touchAction="none"}jd(Mt.domElement);Mt.domElement.style.visibility="hidden";function Ta(s,e){const{width:t,height:n}=wo();s.aspect=t/n,s.updateProjectionMatrix(),aT(Mt,e,t,n),jd(Mt.domElement),xs()}function Wr(){if(!os)return;const s=Mt.domElement.getBoundingClientRect();os.style.left=`${s.left+s.width/2}px`,os.style.top=`${s.top+s.height/2}px`}const Sn=new Op;Sn.background=new Me(sd);Sn.fog=new kl(sd,wv,Rv);const Zn=new Ut(id,go.width/go.height,Mv,yv);Zn.position.set(k/2,bi,k/2);Sn.add(new pm(Pv,Iv));Sn.add(new am(Dv,Uv,Nv));const un=new WE;async function xT(){var L;const s=document.getElementById("hint-status"),e="Loading… please wait",t=Dt?"Tap to start":"Click to start",n="Please rotate your device";function i(){if(!(!s||!A)){if(s.classList.remove("loading","ready","rotate"),Dt&&!mo()){s.textContent=n,s.classList.add("rotate");return}s.textContent=t,s.classList.add("ready")}}s&&(s.textContent=e,s.classList.add("loading")),Jn.style.cursor="wait";const r=new Yh,o=await iM(r),a=await tM(r),l=await Zv(r),c=sM(o,a,l),u=await ey(),h=await fy();await un.preload();const d=new LE(Sn,c,u,h),f=new Iy(Sn,h==null?void 0:h.entities),g=new Zy((L=h==null?void 0:h.entities)==null?void 0:L.library,Sn),_=new BE(Zn,Mt.domElement);let m=()=>!0;Dt&&Qn&&(_.setMobileMode(!0,Qn),jt&&(jt.hidden=!0),m=O=>{const z=mo();return document.documentElement.classList.toggle("portrait-blocked",!z),z?(Si&&(Si.classList.remove("visible"),Si.hidden=!0),O?(Qn.show(),_.startMobile()):i(),!0):(Qn.hide(),_.mobileActive=!1,O&&Si&&(Si.hidden=!1,Si.classList.add("visible")),!1)},window.addEventListener("orientationchange",()=>{ri(()=>{Ta(Zn,v),Wr(),m(R),R||i()})})),_.connect();function p(){jt&&(jt.hidden=!1,jt.classList.add("visible"))}function E(){jt&&(jt.classList.remove("visible"),jt.hidden=!0)}function T(){!A||!R||Dt||_.isLocked()||_.requestLock()}_.onLockLost=()=>{R&&!Dt&&p()},_.onLockAcquired=E,_.onMove=(O,z,$,K)=>{R&&un.onMove(O,z,$,K)},_.onJump=()=>{R&&un.onJump()},_.onLand=O=>{R&&un.onLand(O)},Mt.domElement.addEventListener("click",()=>{var O;((O=un.ctx)==null?void 0:O.state)==="suspended"&&un.ctx.resume()}),Mt.domElement.addEventListener("click",T),jt==null||jt.addEventListener("click",T);const v=oT(Mt,Sn,Zn);Ta(Zn,v);let R=!1,A=!1;d.preloadAround(Zn,(O,z)=>{s&&!A&&(s.classList.add("loading"),s.innerHTML=`Building nearby rooms… ${O}/${z}<br /><span class="hint-wait">Please wait</span>`)}).then(()=>{_.setColliders(d.getColliders()),f.setColliders(d.getColliders()),A=!0,Mt.domElement.style.visibility="visible",Wr(),Jn.style.cursor="pointer",i()}).catch(O=>{console.error(O),A=!0,Mt.domElement.style.visibility="visible",Jn.style.cursor="pointer",s&&(s.classList.remove("loading"),s.textContent="Load error — please refresh.")}),Jn.addEventListener("click",()=>{var O;((O=un.ctx)==null?void 0:O.state)==="suspended"&&un.ctx.resume(),A&&(Dt&&!m(R)||(Dt||_.requestLock(),R||(R=!0,Dt&&Qn&&(_.startMobile(),Qn.show()),Jn.classList.add("hidden"),gT.classList.add("visible"),_T.classList.add("visible"),Dt||os==null||os.classList.add("visible"),Wr(),Ea==null||Ea.classList.add("visible"),un.start(),f.spawnAtStart(_),g.begin(_))))}),Jn.addEventListener("touchstart",()=>{var O;((O=un.ctx)==null?void 0:O.state)==="suspended"&&un.ctx.resume()},{passive:!0});const w=new qh;let D=0;function S(){requestAnimationFrame(S);const O=Math.min(w.getDelta(),.05);D+=O,d.tick(O),R&&nE(Sn,D),d.preloading||(d.update(_.position),R&&d.hasPendingLoads()&&d.processLoadQueue(_.position),d.consumeColliderRebuild()&&(_.setColliders(d.getColliders()),f.setColliders(d.getColliders()),_.resolvePenetration())),R&&(!Dt||m(!0))&&(_.update(O),f.update(O,_),g.update(O,_,d.getColliders())),A?v.render(D):Mt.render(Sn,Zn)}S();const y=()=>{Ta(Zn,v),Wr(),Dt&&(m(R),R||i())};window.addEventListener("resize",()=>ri(y)),window.visualViewport&&(window.visualViewport.addEventListener("resize",()=>ri(y)),window.visualViewport.addEventListener("scroll",()=>ri(y))),Dt&&y()}xT().catch(s=>{console.error(s);const e=document.getElementById("hint-status");e&&(e.classList.remove("loading"),e.textContent="Load error — please refresh.")});
