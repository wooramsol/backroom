...
void main() {
  ...
  `};function ty(){return new xl(ey)}function ny(i,e){i.uniforms.time.value=e}function Zh(i,e,t,n=1){i.uniforms.resolution.value.set(e*n,t*n)}function vl(i){return i.getPixelRatio()*Bx}function Jh(i,e,t){const n=vl(i);return new ke(1/(e*n),1/(t*n))}function iy(i,e,t){const n=window.innerWidth,s=window.innerHeight,r=vl(i),o=new ZS(i);o.setPixelRatio(r),o.setSize(n,s),o.addPass(new JS(e,t));const a=new xl(QS);a.material.uniforms.resolution.value.copy(Jh(i,n,s)),o.addPass(a);const l=ty();return Zh(l,n,s,r),o.addPass(l),{composer:o,fxaa:a,noise:l,render(c=0){ny(l,c),o.render()}}}function sy(i,e,t,n){const s=vl(i);i.setSize(t,n),e.composer.setPixelRatio(s),e.composer.setSize(t,n),e.fxaa.material.uniforms.resolution.value.copy(Jh(i,t,n)),Zh(e.noise,t,n,s)}const ry="1.0.0",oy="91f0474",ay="2026-06-24 09:05:51",ly="dev";function cy(){return`v${ry} · ${oy} · ${ay} · ${ly}`}function uy(){if(typeof window>"u")return!1;const i=window.matchMedia("(pointer: coarse)").matches,e=navigator.maxTouchPoints>0,t=/Android|iPhone|iPad|iPod|Mobile|webOS|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);return i&&e||t}function hy(){var i,e;return typeof window>"u"?!0:(e=(i=window.screen)==null?void 0:i.orientation)!=null&&e.type?window.screen.orientation.type.startsWith("landscape"):window.innerWidth>=window.innerHeight}const fy=52,dy=.12;class py{constructor(e){this.root=e,this.active=!1,this.move={x:0,y:0},this.look={dx:0,dy:0},this.run=!1,this._jumpQueued=!1,this._stickBase=e.querySelector(".mc-stick-base"),this._stickKnob=e.querySelector(".mc-stick-knob"),this._lookZone=e.querySelector(".mc-look-zone"),this._btnRun=e.querySelector(".mc-btn-run"),this._btnJump=e.querySelector(".mc-btn-jump"),this._rotatePrompt=document.getElementById("mobile-rotate"),this._stickTouchId=null,this._stickOrigin={x:0,y:0},this._lookTouchId=null,this._lookLast={x:0,y:0},this._onOrientation=()=>this._syncRotatePrompt(),this._onStickStart=t=>this._stickDown(t),this._onStickMove=t=>this._stickMove(t),this._onStickEnd=t=>this._stickUp(t),this._onLookStart=t=>this._lookDown(t),this._onLookMove=t=>this._lookMove(t),this._onLookEnd=t=>this._lookUp(t),this._onRunDown=t=>{var n;t.preventDefault(),this.run=!0,(n=this._btnRun)==null||n.classList.add("pressed")},this._onRunUp=t=>{var n;t.preventDefault(),this.run=!1,(n=this._btnRun)==null||n.classList.remove("pressed")},this._onJump=t=>{var n;t.preventDefault(),this._jumpQueued=!0,(n=this._btnJump)==null||n.classList.add("pressed"),window.setTimeout(()=>{var s;return(s=this._btnJump)==null?void 0:s.classList.remove("pressed")},120)}}mount(){var e,t,n,s,r,o,a,l,c,u,h,f,d;(e=this._stickBase)==null||e.addEventListener("touchstart",this._onStickStart,{passive:!1}),(t=this._stickBase)==null||t.addEventListener("touchmove",this._onStickMove,{passive:!1}),(n=this._stickBase)==null||n.addEventListener("touchend",this._onStickEnd),(s=this._stickBase)==null||s.addEventListener("touchcancel",this._onStickEnd),(r=this._lookZone)==null||r.addEventListener("touchstart",this._onLookStart,{passive:!1}),(o=this._lookZone)==null||o.addEventListener("touchmove",this._onLookMove,{passive:!1}),(a=this._lookZone)==null||a.addEventListener("touchend",this._onLookEnd),(l=this._lookZone)==null||l.addEventListener("touchcancel",this._onLookEnd),(c=this._btnRun)==null||c.addEventListener("touchstart",this._onRunDown,{passive:!1}),(u=this._btnRun)==null||u.addEventListener("touchend",this._onRunUp),(h=this._btnRun)==null||h.addEventListener("touchcancel",this._onRunUp),(f=this._btnJump)==null||f.addEventListener("touchstart",this._onJump,{passive:!1}),window.addEventListener("orientationchange",this._onOrientation),window.addEventListener("resize",this._onOrientation),this._syncRotatePrompt(),(d=screen.orientation)!=null&&d.lock&&screen.orientation.lock("landscape").catch(()=>{})}show(){this.active=!0,this.root.hidden=!1,this.root.classList.add("visible"),this._syncRotatePrompt()}hide(){this.active=!1,this.root.classList.remove("visible"),this.root.hidden=!0,this._reset()}consumeJump(){return this._jumpQueued?(this._jumpQueued=!1,!0):!1}consumeLook(){const e=this.look.dx,t=this.look.dy;return this.look.dx=0,this.look.dy=0,{dx:e,dy:t}}_syncRotatePrompt(){if(!this._rotatePrompt)return;const e=this.active&&!hy();this._rotatePrompt.hidden=!e,this._rotatePrompt.classList.toggle("visible",e)}_reset(){var e,t,n;this.move.x=0,this.move.y=0,this.look.dx=0,this.look.dy=0,this.run=!1,this._jumpQueued=!1,this._stickTouchId=null,this._lookTouchId=null,(e=this._btnRun)==null||e.classList.remove("pressed"),(t=this._btnJump)==null||t.classList.remove("pressed"),(n=this._stickKnob)==null||n.style.setProperty("transform","translate(-50%, -50%)")}_stickDown(e){if(!this.active||this._stickTouchId!==null)return;const t=e.changedTouches[0];if(!t)return;e.preventDefault(),this._stickTouchId=t.identifier;const n=this._stickBase.getBoundingClientRect();this._stickOrigin.x=n.left+n.width/2,this._stickOrigin.y=n.top+n.height/2,this._updateStick(t.clientX,t.clientY)}_stickMove(e){if(this._stickTouchId===null)return;const t=this._findTouch(e,this._stickTouchId);t&&(e.preventDefault(),this._updateStick(t.clientX,t.clientY))}_stickUp(e){var n;this._stickTouchId===null||!this._findTouch(e,this._stickTouchId)&&e.type!=="touchcancel"||(this._stickTouchId=null,this.move.x=0,this.move.y=0,(n=this._stickKnob)==null||n.style.setProperty("transform","translate(-50%, -50%)"))}_updateStick(e,t){var u;let n=e-this._stickOrigin.x,s=t-this._stickOrigin.y;const r=Math.hypot(n,s),o=fy;r>o&&(n=n/r*o,s=s/r*o),(u=this._stickKnob)==null||u.style.setProperty("transform",`translate(calc(-50% + ${n}px), calc(-50% + ${s}px))`);const a=n/o,l=s/o;Math.hypot(a,l)<dy?(this.move.x=0,this.move.y=0):(this.move.x=a,this.move.y=l)}_lookDown(e){if(!this.active||this._lookTouchId!==null)return;const t=e.changedTouches[0];t&&(e.preventDefault(),this._lookTouchId=t.identifier,this._lookLast.x=t.clientX,this._lookLast.y=t.clientY)}_lookMove(e){if(this._lookTouchId===null)return;const t=this._findTouch(e,this._lookTouchId);t&&(e.preventDefault(),this.look.dx+=t.clientX-this._lookLast.x,this.look.dy+=t.clientY-this._lookLast.y,this._lookLast.x=t.clientX,this._lookLast.y=t.clientY)}_lookUp(e){this._lookTouchId===null||!this._findTouch(e,this._lookTouchId)&&e.type!=="touchcancel"||(this._lookTouchId=null)}_findTouch(e,t){for(const n of e.changedTouches)if(n.identifier===t)return n;for(const n of e.touches)if(n.identifier===t)return n;return null}}const Dn=uy();document.documentElement.classList.toggle("mobile",Dn);const Oi=document.getElementById("overlay"),my=document.getElementById("hud"),gy=document.getElementById("vignette"),Yi=document.getElementById("crosshair"),Au=document.getElementById("build-label"),Vo=document.getElementById("build-badge"),wu=document.getElementById("build-version"),nn=document.getElementById("resume-prompt"),Ru=document.getElementById("mobile-controls"),ki=Dn&&Ru?new py(Ru):null;ki&&ki.mount();const Qh=cy();Au&&(Au.textContent=Qh);wu&&(wu.textContent=Qh);function Wo(){if(!Yi)return;const i=Tt.domElement.getBoundingClientRect();Yi.style.left=`${i.left+i.width/2}px`,Yi.style.top=`${i.top+i.height/2}px`}const Tt=new hx({antialias:!1,powerPreference:"high-performance"});Tt.setPixelRatio(Math.min(window.devicePixelRatio,1));Tt.setSize(window.innerWidth,window.innerHeight);Tt.outputColorSpace=it;Tt.toneMapping=Lu;Tt.toneMappingExposure=kx;Tt.domElement.style.cssText="position:fixed;inset:0;z-index:1;visibility:hidden";document.body.appendChild(Tt.domElement);const jn=new Bd;jn.background=new be(gh);jn.fog=new el(gh,wx,Rx);const fi=new It(Mx,window.innerWidth/window.innerHeight,Sx,yx);fi.position.set(k/2,Vi,k/2);jn.add(new _p(Px,Dx));jn.add(new up(Ix,Ux,Nx));const sn=new WS;async function _y(){const i=document.getElementById("hint-status"),e="Loading… please wait",t=Dn?"Tap to start":"Click to start";i&&(i.textContent=e),Oi.style.cursor="wait";const n=new ah,s=await iv(n),r=await tv(n),o=await Zx(n),a=sv(s,r,o),l=await Qv();await sn.preload();const c=new PS(jn,a,l),u=new BS(fi,Tt.domElement);if(Dn&&ki){u.setMobileMode(!0,ki),nn&&(nn.hidden=!0);const v=document.querySelector("#overlay .hint-controls");v&&(v.innerHTML="Move: left stick<br />Look: drag right<br />Run / Jump: buttons<br />Hold phone sideways")}u.connect();function h(){nn&&(nn.hidden=!1,nn.classList.add("visible"))}function f(){nn&&(nn.classList.remove("visible"),nn.hidden=!0)}function d(){!m||!_||Dn||u.isLocked()||u.requestLock()}u.onLockLost=()=>{_&&!Dn&&h()},u.onLockAcquired=f,u.onMove=(v,w,C,A)=>{_&&sn.onMove(v,w,C,A)},u.onJump=()=>{_&&sn.onJump()},u.onLand=v=>{_&&sn.onLand(v)},Tt.domElement.addEventListener("click",()=>{var v;((v=sn.ctx)==null?void 0:v.state)==="suspended"&&sn.ctx.resume()}),Tt.domElement.addEventListener("click",d),nn==null||nn.addEventListener("click",d);const g=iy(Tt,jn,fi);let _=!1,m=!1;c.preloadAround(fi,(v,w)=>{i&&!m&&(i.innerHTML=`Building nearby rooms… ${v}/${w}<br />Please wait`)}).then(()=>{u.setColliders(c.getColliders()),m=!0,Tt.domElement.style.visibility="visible",Wo(),Oi.style.cursor="pointer",i&&(i.textContent=t)}).catch(v=>{console.error(v),m=!0,Tt.domElement.style.visibility="visible",Oi.style.cursor="pointer",i&&(i.textContent="Load error — please refresh.")}),Oi.addEventListener("click",()=>{var v;((v=sn.ctx)==null?void 0:v.state)==="suspended"&&sn.ctx.resume(),m&&(Dn||u.requestLock(),_||(_=!0,Dn&&ki&&(u.startMobile(),ki.show()),Oi.classList.add("hidden"),my.classList.add("visible"),gy.classList.add("visible"),Dn||Yi==null||Yi.classList.add("visible"),Wo(),Vo==null||Vo.classList.add("visible"),sn.start()))}),Oi.addEventListener("touchstart",()=>{var v;((v=sn.ctx)==null?void 0:v.state)==="suspended"&&sn.ctx.resume()},{passive:!0});const p=new lh;let T=0;function E(){requestAnimationFrame(E);const v=Math.min(p.getDelta(),.05);T+=v,c.tick(v),rS(jn,T),c.preloading||(c.update(u.position),_&&c.hasPendingLoads()&&c.processLoadQueue(u.position),c.consumeColliderRebuild()&&(u.setColliders(c.getColliders()),u.resolvePenetration())),_&&u.update(v),m?g.render(T):Tt.render(jn,fi),!c.preloading&&_&&c.processLoadQueue(u.position)}E(),window.addEventListener("resize",()=>{const v=window.innerWidth,w=window.innerHeight;fi.aspect=v/w,fi.updateProjectionMatrix(),sy(Tt,g,v,w),Wo()})}_y().catch(i=>{console.error(i);const e=document.getElementById("hint-status");e&&(e.textContent="Load error — please refresh.")});
