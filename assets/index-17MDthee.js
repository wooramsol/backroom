...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ln,depthTest:!1,depthWrite:!1})}function vo(){return new Zt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ba(),fragmentShader:`
		...
		`,blending:ln,depthTest:!1,depthWrite:!1})}function So(){return new Zt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ba(),fragmentShader:`
...
`)}function im(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function Oi(i){return i!==""}function Do(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Lo(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const sm=/^[ \t]*#include +<([\w\d./]+)>/gm;function ca(i){return i.replace(sm,am)}const rm=new Map;function am(i,e){let t=Fe[e];if(t===void 0){const n=rm.get(e);if(n!==void 0)t=Fe[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return ca(t)}const om=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Uo(i){return i.replace(om,lm)}function lm(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Io(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function cm(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===il?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===dc?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===an&&(e="SHADOWMAP_TYPE_VSM"),e}function um(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case _i:case gi:e="ENVMAP_TYPE_CUBE";break;case Bs:e="ENVMAP_TYPE_CUBE_UV";break}return e}function hm(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case gi:e="ENVMAP_MODE_REFRACTION";break}return e}function fm(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case sl:e="ENVMAP_BLENDING_MULTIPLY";break;case Lc:e="ENVMAP_BLENDING_MIX";break;case Uc:e="ENVMAP_BLENDING_ADD";break}return e}function dm(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function pm(i,e,t,n){const s=i.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=cm(t),c=um(t),u=hm(t),h=fm(t),f=dm(t),p=tm(t),g=nm(r),M=s.createProgram();let m,d,A=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+d);const b=A+m+a,y=A+d+o,I=Ro(s,s.VERTEX_SHADER,b),D=Ro(s,s.FRAGMENT_SHADER,y);s.attachShader(M,I),s.attachShader(M,D),t.index0AttributeName!==void 0?s.bindAttribLocation(M,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(M,0,"position"),s.linkProgram(M);function R(P){if(i.debug.checkShaderErrors){const W=s.getProgramInfoLog(M).trim(),k=s.getShaderInfoLog(I).trim(),$=s.getShaderInfoLog(D).trim();let Z=!0,q=!0;if(s.getProgramParameter(M,s.LINK_STATUS)===!1)if(Z=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,M,I,D);else{const j=Po(s,I,"vertex"),H=Po(s,D,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(M,s.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`};class Vs{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error("THREE.Pass: .render() must be implemented in derived pass.")}dispose(){}}const Fg=new Rl(-1,1,1,-1,0,1);class Og extends dn{constructor(){super(),this.setAttribute("position",new un([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new un([0,2,0,0,2,0],2))}}const Bg=new Og;class zg{constructor(e){this._mesh=new yt(Bg,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,Fg)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}}class nc extends Vs{constructor(e,t="tDiffuse"){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof Zt?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=El.clone(e.uniforms),this.material=new Zt({name:e.name!==void 0?e.name:"unspecified",defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new zg(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}}class tl extends Vs{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){const s=e.getContext(),r=e.state;r.buffers.color.setMask(!1),r.buffers.depth.setMask(!1),r.buffers.color.setLocked(!0),r.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),r.buffers.stencil.setTest(!0),r.buffers.stencil.setOp(s.REPLACE,s.REPLACE,s.REPLACE),r.buffers.stencil.setFunc(s.ALWAYS,a,4294967295),r.buffers.stencil.setClear(o),r.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),r.buffers.color.setLocked(!1),r.buffers.depth.setLocked(!1),r.buffers.color.setMask(!0),r.buffers.depth.setMask(!0),r.buffers.stencil.setLocked(!1),r.buffers.stencil.setFunc(s.EQUAL,1,4294967295),r.buffers.stencil.setOp(s.KEEP,s.KEEP,s.KEEP),r.buffers.stencil.setLocked(!0)}}class kg extends Vs{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}}class Hg{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){const n=e.getSize(new Ye);this._width=n.width,this._height=n.height,t=new bn(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:Mi}),t.texture.name="EffectComposer.rt1"}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name="EffectComposer.rt2",this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new nc(Ng),this.copyPass.material.blending=ln,this.clock=new Cl}swapBuffers(){const e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){const t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){e===void 0&&(e=this.clock.getDelta());const t=this.renderer.getRenderTarget();let n=!1;for(let s=0,r=this.passes.length;s<r;s++){const a=this.passes[s];if(a.enabled!==!1){if(a.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(s),a.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),a.needsSwap){if(n){const o=this.renderer.getContext(),l=this.renderer.state.buffers.stencil;l.setFunc(o.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),l.setFunc(o.EQUAL,1,4294967295)}this.swapBuffers()}tl!==void 0&&(a instanceof tl?n=!0:a instanceof kg&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){const t=this.renderer.getSize(new Ye);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;const n=this._width*this._pixelRatio,s=this._height*this._pixelRatio;this.renderTarget1.setSize(n,s),this.renderTarget2.setSize(n,s);for(let r=0;r<this.passes.length;r++)this.passes[r].setSize(n,s)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}}class Gg extends Vs{constructor(e,t,n=null,s=null,r=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=s,this.clearAlpha=r,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this._oldClearColor=new ke}render(e,t,n){const s=e.autoClear;e.autoClear=!1;let r,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(r=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==!0&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(r),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=s}}const Vg={name:"FXAAShader",uniforms:{tDiffuse:{value:null},resolution:{value:new Ye(1/1024,1/512)}},vertexShader:`
		...
		}`};function Ra(i){return i.getPixelRatio()*u_}function ic(i,e,t){const n=Ra(i);return new Ye(1/(e*n),1/(t*n))}function Wg(i,e,t){const n=window.innerWidth,s=window.innerHeight,r=new Hg(i);r.setPixelRatio(Ra(i)),r.setSize(n,s),r.addPass(new Gg(e,t));const a=new nc(Vg);return a.material.uniforms.resolution.value.copy(ic(i,n,s)),r.addPass(a),{composer:r,fxaa:a,render(){r.render()}}}function Xg(i,e,t,n){const s=Ra(i);i.setSize(t,n),e.composer.setPixelRatio(s),e.composer.setSize(t,n),e.fxaa.material.uniforms.resolution.value.copy(ic(i,t,n))}const qg="1.0.0",Yg="694274a",Kg="2026-06-21 14:11:42",$g="dev";function Zg(){return`v${qg} · ${Yg} · ${Kg} · ${$g}`}const Ni=document.getElementById("overlay"),Jg=document.getElementById("hud"),jg=document.getElementById("vignette"),pi=document.getElementById("crosshair"),nl=document.getElementById("build-label"),Hi=document.getElementById("build-badge"),rn=document.getElementById("resume-prompt"),sc=Zg();nl&&(nl.textContent=sc);Hi&&(Hi.textContent=sc);function bs(){if(!pi)return;const i=At.domElement.getBoundingClientRect();pi.style.left=`${i.left+i.width/2}px`,pi.style.top=`${i.top+i.height/2}px`}const At=new Gm({antialias:!1,powerPreference:"high-performance"});At.setPixelRatio(Math.min(window.devicePixelRatio,1));At.setSize(window.innerWidth,window.innerHeight);At.outputColorSpace=xt;At.toneMapping=rl;At.toneMappingExposure=h_;At.domElement.style.cssText="position:fixed;inset:0;z-index:1;visibility:hidden";document.body.appendChild(At.domElement);const Si=new Vu;Si.background=new ke(zl);Si.fog=new ya(zl,jm,Qm);const oi=new Ft(qm,window.innerWidth/window.innerHeight,Ym,50);oi.position.set(S/2,Bi,S/2);Si.add(new ih(t_,n_));Si.add(new nh(i_,s_,r_));async function Qg(){const i=new th,e=await b_(i),t=await y_(i),n=A_(e,t),s=new Rg(Si,n),r=new Ig(oi,At.domElement);s.init(r.position),r.connect();function a(){rn&&(rn.hidden=!1,rn.classList.add("visible"))}function o(){rn&&(rn.classList.remove("visible"),rn.hidden=!0)}function l(){!h||!u||r.isLocked()||r.requestLock()}r.onLockLost=()=>{u&&a()},r.onLockAcquired=o,At.domElement.addEventListener("click",l),rn==null||rn.addEventListener("click",l);const c=Wg(At,Si,oi);let u=!1,h=!1;const f=document.querySelector("#overlay .hint"),p="Click to start<br />WASD · Move &nbsp; Shift · Run &nbsp; Space · Jump &nbsp; Mouse · Look";f&&(f.textContent="Building nearby rooms… (one-time)"),Ni.style.cursor="wait",s.preloadAround(oi,(d,A)=>{f&&!h&&(f.innerHTML=`Building nearby rooms… ${d}/${A}<br/>Preparing the area within view distance`)}).then(()=>{for(let d=0;d<5;d++)c.render();r.setColliders(s.getColliders()),h=!0,At.domElement.style.visibility="visible",bs(),Ni.style.cursor="pointer",f&&(f.innerHTML=p)}).catch(d=>{console.error(d),h=!0,At.domElement.style.visibility="visible",Ni.style.cursor="pointer",f&&(f.textContent="Load error — please refresh.")}),Ni.addEventListener("click",()=>{h&&(r.requestLock(),u||(u=!0,Ni.classList.add("hidden"),Jg.classList.add("visible"),jg.classList.add("visible"),pi==null||pi.classList.add("visible"),bs(),Hi==null||Hi.classList.add("visible")))});const g=new Cl,M=16.7;function m(){requestAnimationFrame(m);const d=performance.now(),A=Math.min(g.getDelta(),.05);if(s.tick(A),s.preloading||(s.update(r.position),s.consumeColliderRebuild()&&(s.flushColliders(),r.setColliders(s.getColliders()),r.resolvePenetration())),u&&(r.update(A),bs()),c.render(),!s.preloading){const b=performance.now()-d,y=Math.max(2,Math.min(6,M-b));s.processLoadQueue(r.position,y)}}m(),window.addEventListener("resize",()=>{const d=window.innerWidth,A=window.innerHeight;oi.aspect=d/A,oi.updateProjectionMatrix(),Xg(At,c,d,A),bs()})}Qg().catch(i=>{console.error(i);const e=document.querySelector("#overlay .hint");e&&(e.textContent="Load error — please refresh.")});
