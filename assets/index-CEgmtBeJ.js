...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      ${e}`))}function sE(s){var i,r;const e=Bd(),t=s.map||null;t&&(t.colorSpace=qe);const n=new Mo({map:t,color:((r=(i=s.color)==null?void 0:i.clone)==null?void 0:r.call(i))??new Me(12564640),emissiveMap:e,emissive:new Me(13421772),emissiveIntensity:.65});return n.userData.chunkOwned=!0,n.userData.chairGlitch=!0,n.onBeforeCompile=o=>{o.uniforms.uGlitchTime={value:0},o.uniforms.uGlitchAmp={value:1},n.userData.glitchUniforms=o.uniforms,o.vertexShader=o.vertexShader.replace("#include <common>",`#include <common>
      ...
      uniform float uGlitchTime;`),iE(o)},n}function rE(s){s.userData.chairGlitch=!0,Qr.add(s),s.traverse(e=>{if(!e.isMesh||!e.material)return;const n=(Array.isArray(e.material)?e.material:[e.material]).map(i=>sE(i));e.material=n.length===1?n[0]:n})}function oE(s,e,t){var i,r;if(!((i=s.isMesh)!=null&&i.material))return;const n=Array.isArray(s.material)?s.material:[s.material];for(const o of n){if(!((r=o.userData)!=null&&r.chairGlitch))continue;const a=o.userData.glitchUniforms;a&&(a.uGlitchTime.value=e,a.uGlitchAmp.value=t),o.emissiveIntensity=.5+Math.random()*.95}}function aE(s,e){if(!Qr.size)return;(Math.floor(e*60)&1)===0&&nE();const n=(Math.random()<.11?2.2:1)*(1+Math.sin(e*61)*.3+Math.random()*.55);for(const i of Qr){if(!i.parent){Qr.delete(i);continue}i.traverse(r=>oE(r,e,n))}}const vi=new Ot;function lE(s,e,t){e.updateMatrixWorld(!0),vi.setFromObject(s);const n={minX:vi.min.x,maxX:vi.max.x,minZ:vi.min.z,maxZ:vi.max.z,topY:vi.max.y,bottomY:vi.min.y};return t.push(n),n}function cE(s,e,t,n){let i=0;const r=Math.max(.22,t*.38);for(const o of n)s+r>o.minX&&s-r<o.maxX&&e+r>o.minZ&&e-r<o.maxZ&&(i=Math.max(i,o.topY));return i}const Ju=new Ot,Qu={cx:0,cz:0};function uE(s,e,t){e.updateMatrixWorld(!0),Ju.setFromObject(s),s.position.y+=t-Ju.min.y}function hE(s,e,t,n){if(!t||e.cx!==Qu.cx||e.cz!==Qu.cz)return;const i={x:z/2+2.6,z:z/2-2.4,yaw:Math.PI*.12};if(!si(i.x,i.z,e.innerWalls))return;const r=my(t);r.rotation.y=i.yaw,r.position.set(i.x,0,i.z),uE(r,s,0),r.userData.chunkOwned=!0,s.add(r);const o=Od(r,s);o.standable=!1,n.push(o)}function dE(s,e,t,n,i){t&&hE(s,e,t.car,n)}const po=new Ot,eh=new Gt,fE=[["floor_normal",28],["floor_tipped",18],["wall_lean",24],["wall_embedded",14],["ceiling_stuck",10],["floor_embedded",6]],pE=[["floor_normal",38],["floor_tipped",32],["floor_embedded",18],["wall_lean",12]],mE=[["floor_normal",32],["floor_tipped",28],["floor_embedded",14],["ceiling_stuck",10]],gE=[["floor_normal",38],["floor_tipped",32],["floor_embedded",18],["ceiling_stuck",12]];function $i(s,e,t){e.updateMatrixWorld(!0),po.setFromObject(s),s.position.y+=t-po.min.y}function _E(s,e,t){e.updateMatrixWorld(!0),po.setFromObject(s),s.position.y+=t-po.max.y}function Tl(s,e,t=.55,n=48){for(let i=0;i<n;i++){const r=e.range(t,z-t),o=e.range(t,z-t);if(si(r,o,s))return{x:r,z:o}}return null}function xE(s){const e=St*.5+.04,t=.8,n=[{axis:"z",pos:e,span0:t,span1:z-t},{axis:"z",pos:z-e,span0:t,span1:z-t},{axis:"x",pos:e,span0:t,span1:z-t},{axis:"x",pos:z-e,span0:t,span1:z-t}];return[...s,...n]}function vE(s,e,t){if(s.axis==="z"){const r=si(e,s.pos+.55,t),o=si(e,s.pos-.55,t);return r&&!o?.55:o&&!r?-.55:r?.55:-.55}const n=si(s.pos+.55,e,t),i=si(s.pos-.55,e,t);return n&&!i?.55:i&&!n?-.55:n?.55:-.55}function ME(s,e,t,n){const i=[...s];for(let r=i.length-1;r>0;r--){const o=n.int(0,r);[i[r],i[o]]=[i[o],i[r]]}for(let r=0;r<24;r++){const o=i[r%i.length],a=n.range(o.span0+t*.5,o.span1-t*.5),l=vE(o,a,e),c=o.axis==="z"?a:o.pos+l,u=o.axis==="z"?o.pos+l:a;if(!si(c,u,e))continue;const h=o.axis==="z"?l>0?0:Math.PI:l>0?-Math.PI/2:Math.PI/2;return{x:c,z:u,yaw:h,wall:o,offset:l}}return null}function yE(s,e,t,n,i,r){const{height:o,depth:a}=i,l=t.supportY??0;switch(s.rotation.set(0,0,0),s.position.set(t.x,0,t.z),e){case"floor_normal":s.rotation.y=t.yaw??n.range(0,Math.PI*2),$i(s,r,l);break;case"floor_tipped":s.rotation.y=n.range(0,Math.PI*2),eh.set(n.range(1.1,1.65),s.rotation.y,n.range(-.35,.35)),s.setRotationFromEuler(eh),$i(s,r,l+n.range(-.01,.02));break;case"wall_lean":{const c=n.range(.22,.48);s.rotation.y=t.yaw+n.range(-.2,.2),(t.wall.axis==="z"?"x":"z")==="x"?s.rotation.x=t.offset>0?-c:c:s.rotation.z=t.offset>0?c:-c;const h=a*n.range(.22,.42);t.wall.axis==="z"?s.position.z-=Math.sign(t.offset)*h:s.position.x-=Math.sign(t.offset)*h,$i(s,r,l);break}case"wall_embedded":{s.rotation.y=t.yaw+n.range(-.15,.15);const c=a*n.range(.42,.72);t.wall.axis==="z"?s.position.z-=Math.sign(t.offset)*c:s.position.x-=Math.sign(t.offset)*c,s.rotation.x=n.range(-.12,.12),$i(s,r,l+n.range(-.03,.05));break}case"ceiling_stuck":s.rotation.y=n.range(0,Math.PI*2),s.rotation.x=Math.PI+n.range(-.22,.22),s.rotation.z=n.range(-.18,.18),_E(s,r,Ci-.006+n.range(0,o*.22));break;case"floor_embedded":s.rotation.y=n.range(0,Math.PI*2),s.rotation.z=n.range(-.18,.18),$i(s,r,l-o*n.range(.15,.35));break;default:s.rotation.y=n.range(0,Math.PI*2),$i(s,r,l)}}function SE(s,e=!1,t=!1){return t?s.pickWeighted(e?gE:mE):s.pickWeighted(e?pE:fE)}function EE(s,e,t){for(const n of e){const[i,r]=n.split(",").map(Number),o=s.x-i,a=s.z-r;if(o*o+a*a<t*t)return!0}return!1}function TE(s,e,t,n,i,r,o){e.userData.chunkOwned=!0,s.add(e),n.push(Od(e,s)),t.furnitureId==="chairGlb"&&rE(e),lE(e,s,o),i.add(`${r.x.toFixed(2)},${r.z.toFixed(2)}`)}function kd(s,e,t,n,i,r,o,a={}){if(!t)return!1;const l=vd(t),c=l.userData;c.furnitureKind=a.kind||(c.isPile?"pile":"chair");const u=SE(n,a.pileMode,!!a.spot);let h=null;if(a.spot)h={...a.spot,yaw:a.spot.yaw??n.range(0,Math.PI*2)};else if(u==="floor_normal"||u==="floor_tipped"||u==="floor_embedded"){const f=Tl(e.innerWalls,n,c.footprint*.45);if(!f)return!1;h={...f,yaw:n.range(0,Math.PI*2)}}else if(u==="ceiling_stuck"){const f=Tl(e.innerWalls,n,c.footprint*.4);if(!f)return!1;h={...f}}else{const f=xE(e.innerWalls);if(h=ME(f,e.innerWalls,c.footprint,n),!h)return!1}h.supportY=cE(h.x,h.z,c.footprint,o);const d=a.minSep??c.footprint*.72;return EE(h,i,d)?!1:(yE(l,u,h,n,c,s),TE(s,l,c,r,i,h,o),!0)}function th(s,e,t,n,i,r,o){const a=Md(t,n);return kd(s,e,a,n,i,r,o,{kind:"prop"})}function bE(s,e,t,n,i,r,o){const a=Tl(e.innerWalls,n,1.2,72);if(!a)return 0;const l=n.int(2,14),c=n.range(.55,1.35);let u=0;for(let h=0;h<l*5&&u<l;h++){const d=n.range(0,Math.PI*2),f=n.range(.02,c)*Math.sqrt(n.range(.15,1)),g={x:a.x+Math.cos(d)*f,z:a.z+Math.sin(d)*f,yaw:n.range(0,Math.PI*2)};if(g.x<.45||g.x>z-.45||g.z<.45||g.z>z-.45||!si(g.x,g.z,e.innerWalls))continue;const _=Md(t,n);kd(s,e,_,n,i,r,o,{spot:g,pileMode:!0,minSep:.26,kind:"pile"})&&u++}return u}function AE(s,e,t,n=null){var c,u;if(!((c=t==null?void 0:t.allProps)!=null&&c.length)&&!n)return{colliders:[]};const i=[],r=[],o=ms(e.cx,e.cz,881),a=new Set;let l=0;if((u=t==null?void 0:t.allProps)!=null&&u.length&&o.chance(.5)){o.chance(.3)&&(l+=bE(s,e,t,o,a,i,r));const h=l>0?o.int(0,2):o.int(1,2);let d=0;for(let f=0;f<h*6&&d<h;f++)th(s,e,t,o,a,i,r)&&d++;if(l+=d,l===0)for(let f=0;f<4&&!th(s,e,t,o,a,i,r);f++);}return n&&dE(s,e,n,i),s.userData.furnitureColliders=i,{colliders:i}}const nc=new Pi(z,z);nc.translate(z/2,z/2,0);nc.userData.shared=!0;const zd=new Pi(Cu,Cu);zd.userData.shared=!0;const Hd=new Pi(Fv,Ov);Hd.userData.shared=!0;const nh=new tn().setFromEuler(new Gt(Math.PI/2,0,0)),Hr=new I,ih=new I(1,1,1),Gr=new Ne;function sh(s,e=Ci){s.boundingSphere=new xn(new I(z/2,e*.5,z/2),Math.hypot(z,e)*.75)}function wE(s,e,t,n,i,r){const{geometry:o}=eE(e,t.wallTex,n,i,r);if(o){o.computeBoundingBox(),o.computeBoundingSphere();const a=new At(o,t.wall);a.frustumCulled=!1,s.add(a)}}function RE(s,e,t,n){const i=nc.clone();Xv(i,gl,t,n);const r=new At(i,e.floor);r.rotation.x=-Math.PI/2,r.frustumCulled=!1,s.add(r)}function CE(s,e,t,n,i){const{gapY:r,tileY:o}=XS(e),a=Eo,{tx0:l,tx1:c,tz0:u,tz1:h}=WS(n,i,z,a),d=[];for(let m=l;m<=c;m++)for(let p=u;p<=h;p++){const{x:T,z:E}=VS(m,p,n,i,a);d.push(T,E)}const f=d.length/2,g=new hl(Hd,t.ceilingGroove,f),_=new hl(zd,t.ceilingTile,f);g.frustumCulled=!1,_.frustumCulled=!1,_.renderOrder=2;for(let m=0;m<f;m++){const p=d[m*2],T=d[m*2+1];Hr.set(p,r,T),Gr.compose(Hr,nh,ih),g.setMatrixAt(m,Gr),Hr.set(p,o,T),Gr.compose(Hr,nh,ih),_.setMatrixAt(m,Gr)}g.instanceMatrix.needsUpdate=!0,_.instanceMatrix.needsUpdate=!0,sh(g,e),sh(_,e),s.add(g),s.add(_)}function LE(s){s.traverse(e=>{var n;if(e.frustumCulled=!1,e.isInstancedMesh||!e.isMesh)return;const t=e.geometry;t&&!((n=t.userData)!=null&&n.shared)&&(t.computeBoundingBox(),t.computeBoundingSphere())})}function Gd(s,e,t=null,n=null){const i=new kt;return i.position.set(s.cx*z,0,s.cz*z),{room:s,group:i,materials:e,furnitureModels:t,specialAssets:n,shellDone:!1,worldX:s.cx*z,worldZ:s.cz*z}}function Vd(s){if(s.shellDone)return;const{room:e,group:t,materials:n}=s,i=e.height;RE(t,n,s.worldX,s.worldZ),CE(t,i,n,s.worldX,s.worldZ),wE(t,e,n,i,s.worldX,s.worldZ),s.furnitureModels&&AE(t,e,s.furnitureModels,s.specialAssets),s.shellDone=!0}function PE(s,e){return s.shellDone||Vd(s),!0}function Wd(s){const{group:e,room:t}=s;return e.userData.room=t,LE(e),e.frustumCulled=!1,e}function rh(s,e,t=null,n=null){const i=Gd(s,e,t,n);return Vd(i),Wd(i)}const IE=["map","normalMap","roughnessMap","metalnessMap","aoMap","emissiveMap","alphaMap","bumpMap"];function oh(s){var e,t;if((e=s==null?void 0:s.userData)!=null&&e.chunkOwned){for(const n of IE){const i=s[n];(t=i==null?void 0:i.userData)!=null&&t.chunkOwned&&i.dispose()}s.dispose()}}function DE(s){var t;const e=s.geometry;if(e&&!((t=e.userData)!=null&&t.shared)&&e.dispose(),!!s.material)if(Array.isArray(s.material))for(const n of s.material)oh(n);else oh(s.material)}function ah(s){s&&s.traverse(e=>{e.isLight||(e.isMesh||e.isInstancedMesh)&&DE(e)})}const lh=2,ch=2,UE=2;class NE{constructor(e,t,n=null,i=null){this.scene=e,this.materials=t,this.furnitureModels=n,this.specialAssets=i,this.chunks=new Map,this.wallMap=new Map,this.colliders=[],this.collidersDirty=!1,this.time=0,this.loadQueue=[],this.pendingKeys=new Set,this.disposeQueue=[],this.despawnPending=[],this.cellCx=NaN,this.cellCz=NaN,this.lastPrefetchEdge=!1,this.preloading=!1}key(e,t){return`${e},${t}`}distToPlayer(e,t,n){const i=e*z+z/2-n.x,r=t*z+z/2-n.z;return i*i+r*r}nearPrefetchEdge(e,t,n){const i=e.x-t*z,r=e.z-n*z,o=z*Ds;return i>o||i<z-o||r>o||r<z-o}ringKeys(e,t,n){const i=new Set;for(let r=t-n;r<=t+n;r++)for(let o=e-n;o<=e+n;o++)i.add(this.key(o,r));return i}computeNeed(e,t,n,i=Jl){const r=this.ringKeys(e,t,i),o=n.x-e*z,a=n.z-t*z,l=i+1;if(o>z*Ds)for(let c=t-i;c<=t+i;c++)r.add(this.key(e+l,c));if(o<z*(1-Ds))for(let c=t-i;c<=t+i;c++)r.add(this.key(e-l,c));if(a>z*Ds)for(let c=e-i;c<=e+i;c++)r.add(this.key(c,t+l));if(a<z*(1-Ds))for(let c=e-i;c<=e+i;c++)r.add(this.key(c,t-l));return r}insertJob(e){const t=e.dist;let n=0,i=this.loadQueue.length;for(;n<i;){const r=n+i>>1;this.loadQueue[r].dist<t?n=r+1:i=r}this.loadQueue.splice(n,0,e)}rebuildColliderList(){const e=GS(this.wallMap);for(const t of this.chunks.values()){const n=t.furnitureColliders;n!=null&&n.length&&e.push(...n)}this.colliders=e,this.collidersDirty=!1}_markCollidersDirty(){this.collidersDirty=!0}addCollidersForRoom(e){Xu(this.wallMap,e),this.rebuildColliderList()}removeCollidersForRoom(e){Yu(this.wallMap,e)&&this.rebuildColliderList()}addFurnitureForChunk(e){const t=e.userData.furnitureColliders||[];return this._markCollidersDirty(),{furnitureColliders:t}}removeFurnitureForChunk(e){this._markCollidersDirty()}consumeColliderRebuild(){return this.collidersDirty?(this.rebuildColliderList(),!0):!1}attachChunk(e,t,n,i){const r=this.key(e,t);Wd(i);const o=i.group,a=this.addFurnitureForChunk(o);this.chunks.set(r,{mesh:o,room:n,...a})}spawnComplete(e,t){const n=ya(e,t);this.addCollidersForRoom(n);const i=rh(n,this.materials,this.furnitureModels,this.specialAssets),r=this.addFurnitureForChunk(i);this.scene.add(i),this.chunks.set(this.key(e,t),{mesh:i,room:n,...r})}despawn(e){const t=this.chunks.get(e);if(!t)return;const{mesh:n,room:i}=t;n&&(this.scene.remove(n),this.disposeQueue.push(n)),this.chunks.delete(e),i&&(this.removeCollidersForRoom(i),kS(i.cx,i.cz))}enqueue(e,t,n){const i=this.key(e,t);this.chunks.has(i)||this.pendingKeys.has(i)||(this.pendingKeys.add(i),this.insertJob({cx:e,cz:t,dist:this.distToPlayer(e,t,n),room:null,build:null}))}init(e){const t=Math.floor(e.x/z),n=Math.floor(e.z/z);this.cellCx=t,this.cellCz=n,this.lastPrefetchEdge=this.nearPrefetchEdge(e,t,n),this.spawnComplete(t,n)}update(e){if(this.preloading)return;const t=Math.floor(e.x/z),n=Math.floor(e.z/z),i=this.nearPrefetchEdge(e,t,n);if(t===this.cellCx&&n===this.cellCz&&i===this.lastPrefetchEdge&&!this.loadQueue.length&&!this.despawnPending.length)return;this.cellCx=t,this.cellCz=n,this.lastPrefetchEdge=i;const r=this.computeNeed(t,n,e),o=new Set(this.despawnPending);for(const a of this.chunks.keys()){if(r.has(a)||o.has(a))continue;const[l,c]=a.split(",").map(Number);Math.max(Math.abs(l-t),Math.abs(c-n))>Lv&&this.despawnPending.push(a)}this.loadQueue=this.loadQueue.filter(a=>{var c;const l=this.key(a.cx,a.cz);return r.has(l)?!0:(a.room&&!this.chunks.has(l)&&(Yu(this.wallMap,a.room),this._markCollidersDirty()),(c=a.build)!=null&&c.group&&(a.build.group.parent&&this.scene.remove(a.build.group),ah(a.build.group)),!1)});for(const a of this.pendingKeys)!r.has(a)&&!this.chunks.has(a)&&this.pendingKeys.delete(a);for(const a of r)if(!this.chunks.has(a)){const[l,c]=a.split(",").map(Number);this.enqueue(l,c,e)}}processLoadQueue(e){let t=0;for(;this.loadQueue.length&&t<UE;){const n=this.loadQueue[0],i=this.key(n.cx,n.cz);if(!n.room){n.room=ya(n.cx,n.cz),n.build=Gd(n.room,this.materials,this.furnitureModels,this.specialAssets),this.chunks.has(i)||(Xu(this.wallMap,n.room),this._markCollidersDirty());continue}n.build.shellDone||PE(n.build),n.build.group.parent||this.scene.add(n.build.group),this.attachChunk(n.cx,n.cz,n.room,n.build),this.loadQueue.shift(),this.pendingKeys.delete(i),t++}}tick(e){this.time+=e;for(let t=0;t<lh&&this.disposeQueue.length;t++)ah(this.disposeQueue.shift());for(let t=0;t<lh&&this.despawnPending.length;t++)this.despawn(this.despawnPending.shift())}getColliders(){return this.colliders}_spawnChunkComplete(e,t){const n=this.key(e,t),i=ya(e,t);this.addCollidersForRoom(i);const r=rh(i,this.materials,this.furnitureModels,this.specialAssets),o=this.addFurnitureForChunk(r);this.scene.add(r),this.chunks.set(n,{mesh:r,room:i,...o}),this.pendingKeys.delete(n)}_spawnChunkSafe(e,t){try{this._spawnChunkComplete(e,t)}catch(n){throw console.error(`Chunk build failed (${e}, ${t})`,n),n}}async preloadAround(e,t){const n=e.position,i=Math.floor(n.x/z),r=Math.floor(n.z/z),o=[];for(let a=r-Dr;a<=r+Dr;a++)for(let l=i-Dr;l<=i+Dr;l++)this.chunks.has(this.key(l,a))||o.push({cx:l,cz:a});o.sort((a,l)=>this.distToPlayer(a.cx,a.cz,n)-this.distToPlayer(l.cx,l.cz,n)),this.preloading=!0,this.loadQueue.length=0,this.pendingKeys.clear();try{const a=o.length;let l=0;for(let c=0;c<o.length;c+=ch){const u=Math.min(c+ch,o.length);for(let h=c;h<u;h++){const{cx:d,cz:f}=o[h];this._spawnChunkSafe(d,f),l++}t==null||t(l,a||1),await new Promise(h=>requestAnimationFrame(h))}this.rebuildColliderList(),t==null||t(a||1,a||1)}finally{this.preloading=!1}}hasPendingLoads(){return!this.preloading&&this.loadQueue.length>0}}const FE=3.2,OE=5.8,BE=9,kE=.035,zE=.018,Mn=.09,HE=.44,uh=new Gt(0,0,0,"YXZ"),GE=new I(0,1,0),Nn=new I,Vr=new I,un=new I;class VE{constructor(e,t){this.camera=e,this.domElement=t,this.position=new I(z/2,bi,z/2),this.yaw=0,this.pitch=0,this.keys={},this.locked=!1,this.mobileMode=!1,this.mobileActive=!1,this.mobileMove={x:0,y:0},this.mobileControls=null,this.colliders=[],this.bob=0,this.vy=0,this.grounded=!0,this.groundY=0,this._jumpFromY=0,this.crouchBlend=0,this.onMove=null,this.onJump=null,this.onLand=null,this.onLockLost=null,this.onLockAcquired=null,this.camera.rotation.order="YXZ",this._onKeyDown=n=>{var i;n.code==="Space"&&(n.preventDefault(),this.locked&&this.grounded&&!this.crouching&&(this.vy=Pr,this.grounded=!1,this._jumpFromY=this.groundY,(i=this.onJump)==null||i.call(this))),this.keys[n.code]=!0,n.code==="KeyR"&&this._unstuck()},this._onKeyUp=n=>{this.keys[n.code]=!1},this._onMouseMove=n=>{this.locked&&(this.yaw-=n.movementX*wu,this.pitch-=n.movementY*wu,this.pitch=Jt.clamp(this.pitch,-Ir,Ir))},this._onLockChange=()=>{var i,r;const n=this.locked;this.locked=document.pointerLockElement===this.domElement,n&&!this.locked?(this._clearKeys(),(i=this.onLockLost)==null||i.call(this)):!n&&this.locked&&((r=this.onLockAcquired)==null||r.call(this))},this._onVisibility=()=>{document.hidden&&this._clearKeys()},this._onBlur=()=>{this._clearKeys()}}get crouching(){return this.inputActive&&!!this.keys.KeyC}get inputActive(){return this.locked||this.mobileMode&&this.mobileActive}isLocomoting(){var e;if(!this.inputActive)return!1;if(this.mobileMode&&this.mobileActive){const t=((e=this.mobileControls)==null?void 0:e.move)??this.mobileMove;return(t.strength??Math.hypot(t.x,t.y))>.08}return!!(this.keys.KeyW||this.keys.KeyS||this.keys.KeyA||this.keys.KeyD||this.keys.ArrowUp||this.keys.ArrowDown||this.keys.ArrowLeft||this.keys.ArrowRight)}_eyeHeight(){return Jt.lerp(bi,fv,this.crouchBlend)}_collisionRadius(){return Jt.lerp(Ai,pv,this.crouchBlend)}_clearKeys(){this.keys={}}connect(){window.addEventListener("keydown",this._onKeyDown),window.addEventListener("keyup",this._onKeyUp),document.addEventListener("mousemove",this._onMouseMove),document.addEventListener("pointerlockchange",this._onLockChange),document.addEventListener("visibilitychange",this._onVisibility),window.addEventListener("blur",this._onBlur)}setMobileMode(e,t=null){this.mobileMode=e,this.mobileControls=t}startMobile(){var e;this.mobileActive=!0,(e=this.onLockAcquired)==null||e.call(this)}requestLock(){this.mobileMode||this.locked||this.domElement.requestPointerLock()}isLocked(){return this.locked}setColliders(e){this.colliders=e}_unstuck(){this.crouchBlend=0,this.position.set(z/2,bi,z/2),this.vy=0,this.grounded=!0,this.groundY=0,this._jumpFromY=0}_feetY(){return this.position.y-this._eyeHeight()}_horizontalProbeY(){return Jt.lerp(this.position.y,this._feetY()+mv*.42,this.crouchBlend)}_overlapsXZ(e,t,n,i=this._collisionRadius()){return!(e+i<=n.minX||e-i>=n.maxX||t+i<=n.minZ||t-i>=n.maxZ)}_maxJumpFeet(){return Pr*Pr/(2*Jr)}_canStandOn(e,t=this._jumpFromY){const n=e-t;return n<=Mn?!0:e>ed+.01?!1:n<=this._maxJumpFeet()+HE}_standingFeetY(e,t){if(this.groundY<=Mn)return 0;for(const n of this.colliders)if(!(!n.standable||n.standTopY===void 0)&&this._overlapsXZ(e,t,n,Ai)&&Math.abs(this.groundY-n.standTopY)<Mn)return n.standTopY;return null}_syncPose(){this.position.y=this.groundY+this._eyeHeight()}_landingFeetY(e,t,n,i,r){if(i>0)return null;const o=n+i*r;let a=null;o<=Mn&&(a=0);for(const l of this.colliders){if(!l.standable||l.standTopY===void 0||!this._overlapsXZ(e,t,l,Ai))continue;const c=l.standTopY;if(!this._canStandOn(c,this._jumpFromY))continue;const u=n>=c-Mn&&o<=c+Mn,h=o<=c+Mn&&n>=c-.55&&n<=c+Mn*1.5;!u&&!h||(a===null||c>a)&&(a=c)}return a}_applyLook(e=0){this.camera.position.set(this.position.x,this.position.y+e,this.position.z),this.camera.up.set(0,1,0),uh.set(this.pitch,this.yaw,0),this.camera.quaternion.setFromEuler(uh),this.camera.updateMatrixWorld(!0)}_syncWalkFromCamera(){this.camera.getWorldDirection(Nn),Nn.y=0,Nn.lengthSq()<1e-10?Nn.set(0,0,-1):Nn.normalize(),Vr.crossVectors(Nn,GE).normalize()}_blocksHorizontal(e,t){if(e.isCeiling)return!1;const n=e.standTopY??e.maxY;if(e.isFurniture&&n!==void 0){if(this.grounded&&this.groundY>=n-Mn)return!1;const i=this.grounded?this.groundY:this._feetY();if(i<n-Mn){const r=this.grounded?this.groundY:this._jumpFromY;if(!this._canStandOn(n,r)&&i>=e.minY-.2&&i<=n+.15)return!0}}return!(t<e.minY-.2||t>e.maxY+.2)}_insideWall(e,t){const n=this._horizontalProbeY(),i=this._collisionRadius();for(const r of this.colliders)if(this._blocksHorizontal(r,n)&&!(e+i<=r.minX||e-i>=r.maxX||t+i<=r.minZ||t-i>=r.maxZ))return!0;return!1}_pushOut(e,t){const n=this._horizontalProbeY(),i=this._collisionRadius();for(let r=0;r<14;r++){let o=!1;for(const a of this.colliders){if(!this._blocksHorizontal(a,n)||e+i<=a.minX||e-i>=a.maxX||t+i<=a.minZ||t-i>=a.maxZ)continue;const l=e+i-a.minX,c=a.maxX-(e-i),u=t+i-a.minZ,h=a.maxZ-(t-i),d=Math.min(l,c,u,h);d===l?e-=l:d===c?e+=c:d===u?t-=u:t+=h,o=!0}if(!o)break}return{px:e,pz:t}}resolvePenetration(){if(!this._insideWall(this.position.x,this.position.z))return;const e=this._pushOut(this.position.x,this.position.z);this.position.x=e.px,this.position.z=e.pz}_applyMobileLook(){if(!this.mobileMode||!this.mobileActive||!this.mobileControls)return;const{dx:e,dy:t}=this.mobileControls.consumeLook();e===0&&t===0||(this.yaw-=e*Ru,this.pitch-=t*Ru,this.pitch=Jt.clamp(this.pitch,-Ir,Ir))}_tryMobileJump(){var e;!this.mobileMode||!this.mobileActive||!this.mobileControls||this.mobileControls.consumeJump()&&this.grounded&&!this.crouching&&(this.vy=Pr,this.grounded=!1,this._jumpFromY=this.groundY,(e=this.onJump)==null||e.call(this))}update(e){var _,m,p;if(!this.inputActive)return;this._applyMobileLook(),this._tryMobileJump();const t=this.crouching?1:0;this.crouchBlend+=(t-this.crouchBlend)*Math.min(1,_v*e),this.grounded&&this._syncPose(),this._applyLook(0),this._syncWalkFromCamera(),un.set(0,0,0);let n=0;if(this.mobileMode&&this.mobileActive){const T=((_=this.mobileControls)==null?void 0:_.move)??this.mobileMove,{x:E,y:M}=T;n=T.strength??Math.hypot(E,M),un.addScaledVector(Nn,-M),un.addScaledVector(Vr,E)}else(this.keys.KeyW||this.keys.ArrowUp)&&un.add(Nn),(this.keys.KeyS||this.keys.ArrowDown)&&un.sub(Nn),(this.keys.KeyA||this.keys.ArrowLeft)&&un.sub(Vr),(this.keys.KeyD||this.keys.ArrowRight)&&un.add(Vr);const i=this.keys.ShiftLeft||this.keys.ShiftRight,r=this.mobileMode&&this.mobileActive&&n>=Av,o=!this.crouching&&(i||r),a=this.crouching?gv:o?OE:FE,l=this.position.x,c=this.position.z;let u=0;if(un.lengthSq()>0){un.normalize().multiplyScalar(a*e);const T=this.position.x+un.x,E=this.position.z+un.z;if(!this._insideWall(T,E))this.position.x=T,this.position.z=E;else{const M=this._pushOut(T,E);this.position.x=M.px,this.position.z=M.pz}u=Math.hypot(this.position.x-l,this.position.z-c),this.grounded&&(this.bob+=e*BE*(this.crouching?.75:o?1.3:1))}else this.grounded&&(this.bob*=.85);u>0&&this.grounded&&((m=this.onMove)==null||m.call(this,u,o,this.crouching,a));const h=this.grounded,d=this._feetY();if(this.grounded){const T=this._standingFeetY(this.position.x,this.position.z);T===null?(this.grounded=!1,this.vy-=Jr*e,this.position.y+=this.vy*e):(this.groundY=T,this._syncPose(),this.vy=0)}else{this.vy-=Jr*e;let T=this.position.y+this.vy*e;T>ml&&(T=ml,this.vy=0);const E=this._landingFeetY(this.position.x,this.position.z,d,this.vy,e);if(E!==null){const M=Math.abs(this.vy);this.groundY=E,this._syncPose(),this.vy=0,this.grounded=!0,h||(p=this.onLand)==null||p.call(this,M)}else this.position.y=T}this.resolvePenetration();const f=Jt.lerp(kE,zE,this.crouchBlend),g=this.grounded?Math.sin(this.bob)*f:0;this._applyLook(g)}}const WE="/backroom/",XE=`${WE}assets/${encodeURIComponent("01. Government Funding.mp3")}`,YE=2,qE=2.75,KE=1.4;class $E{constructor(){this.ctx=null,this.master=null,this.sfxGain=null,this.bgmGain=null,this.bgmBuffer=null,this.bgmSource=null,this._stepAccum=0,this._bgmLoading=null}_ensure(){if(this.ctx)return!0;try{return this.ctx=new AudioContext,this.master=this.ctx.createGain(),this.master.gain.value=1,this.master.connect(this.ctx.destination),this.sfxGain=this.ctx.createGain(),this.sfxGain.gain.value=2.1,this.sfxGain.connect(this.master),!0}catch{return!1}}async preload(){return this.bgmBuffer?this.bgmBuffer:this._bgmLoading?this._bgmLoading:(this._bgmLoading=fetch(XE).then(e=>{if(!e.ok)throw new Error(`BGM load failed: ${e.status}`);return e.arrayBuffer()}).then(e=>this._ensure()?this.ctx.decodeAudioData(e):null).then(e=>(this.bgmBuffer=e,e)).catch(e=>(console.warn("[audio] background music unavailable",e),null)),this._bgmLoading)}start(){if(!this._ensure()||(this.ctx.state==="suspended"&&this.ctx.resume(),this.bgmSource))return;const e=()=>{if(!this.bgmBuffer||this.bgmSource)return;const t=this.ctx.createBufferSource();t.buffer=this.bgmBuffer,t.loop=!0,this.bgmGain=this.ctx.createGain(),this.bgmGain.gain.value=.42,t.connect(this.bgmGain),this.bgmGain.connect(this.master),t.start(),this.bgmSource=t};if(this.bgmBuffer){e();return}this.preload().then(e)}onLand(e=4){if(!this._ensure())return;this.ctx.state==="suspended"&&this.ctx.resume();const t=Math.min(1,Math.max(.3,e/7.5));this._stepAccum=0,this._playFootstep(!1,!1,{land:!0,impact:t})}onJump(){this._ensure()&&(this.ctx.state==="suspended"&&this.ctx.resume(),this._playFootstep(!1,!1,{jump:!0}))}onMove(e,t,n=!1,i=3.2){if(!this._ensure()||(this.ctx.state==="suspended"&&this.ctx.resume(),e<1e-5||i<.1))return;this._stepAccum+=e;const o=i/(n?KE:t?qE:YE);for(;this._stepAccum>=o;)this._stepAccum-=o,this._playFootstep(t,n)}_playFootstep(e,t,{jump:n=!1,land:i=!1,impact:r=1}={}){const o=this.ctx,a=o.currentTime;let l,c,u,h,d;n?(l=.065,c=.22,u=128,h=860,d=250):i?(l=.12,c=.3+r*.38,u=72+r*48,h=620,d=175):(l=t?.12:e?.075:.1,c=t?.24:e?.42:.34,u=t?88:e?118:102,h=t?480:e?1050:780,d=t?165:e?285:220);const f=o.createOscillator();f.type="sine",f.frequency.value=u+Math.random()*28;const g=o.createGain();g.gain.setValueAtTime(c*1.35,a),g.gain.exponentialRampToValueAtTime(.001,a+l),f.connect(g),g.connect(this.sfxGain),f.start(a),f.stop(a+l+.02);const _=Math.max(1,Math.floor(o.sampleRate*l)),m=o.createBuffer(1,_,o.sampleRate),p=m.getChannelData(0);for(let w=0;w<_;w++){const R=Math.pow(1-w/_,1.4);p[w]=(Math.random()*2-1)*R}const T=o.createBufferSource();T.buffer=m;const E=o.createBiquadFilter();E.type="lowpass",E.frequency.value=h,E.Q.value=.55;const M=o.createBiquadFilter();M.type="bandpass",M.frequency.value=d+Math.random()*70,M.Q.value=.65;const A=o.createGain();A.gain.setValueAtTime(c,a),A.gain.exponentialRampToValueAtTime(.001,a+l*.92),T.connect(E),E.connect(M),M.connect(A),A.connect(this.sfxGain),T.start(a),T.stop(a+l+.02)}}const jE={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		}`};class Ao{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error("THREE.Pass: .render() must be implemented in derived pass.")}dispose(){}}const ZE=new yo(-1,1,1,-1,0,1);class JE extends sn{constructor(){super(),this.setAttribute("position",new _n([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new _n([0,2,0,0,2,0],2))}}const QE=new JE;class eT{constructor(e){this._mesh=new At(QE,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,ZE)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}}class ic extends Ao{constructor(e,t="tDiffuse"){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof bn?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Uh.clone(e.uniforms),this.material=new bn({name:e.name!==void 0?e.name:"unspecified",defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new eT(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}}class hh extends Ao{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){const i=e.getContext(),r=e.state;r.buffers.color.setMask(!1),r.buffers.depth.setMask(!1),r.buffers.color.setLocked(!0),r.buffers.depth.setLocked(!0);let o,a;this.inverse?(o=0,a=1):(o=1,a=0),r.buffers.stencil.setTest(!0),r.buffers.stencil.setOp(i.REPLACE,i.REPLACE,i.REPLACE),r.buffers.stencil.setFunc(i.ALWAYS,o,4294967295),r.buffers.stencil.setClear(a),r.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),r.buffers.color.setLocked(!1),r.buffers.depth.setLocked(!1),r.buffers.color.setMask(!0),r.buffers.depth.setMask(!0),r.buffers.stencil.setLocked(!1),r.buffers.stencil.setFunc(i.EQUAL,1,4294967295),r.buffers.stencil.setOp(i.KEEP,i.KEEP,i.KEEP),r.buffers.stencil.setLocked(!0)}}class tT extends Ao{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}}class nT{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){const n=e.getSize(new Oe);this._width=n.width,this._height=n.height,t=new ai(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:vs}),t.texture.name="EffectComposer.rt1"}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name="EffectComposer.rt2",this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new ic(jE),this.copyPass.material.blending=Gn,this.clock=new qh}swapBuffers(){const e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){const t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){e===void 0&&(e=this.clock.getDelta());const t=this.renderer.getRenderTarget();let n=!1;for(let i=0,r=this.passes.length;i<r;i++){const o=this.passes[i];if(o.enabled!==!1){if(o.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(i),o.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),o.needsSwap){if(n){const a=this.renderer.getContext(),l=this.renderer.state.buffers.stencil;l.setFunc(a.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),l.setFunc(a.EQUAL,1,4294967295)}this.swapBuffers()}hh!==void 0&&(o instanceof hh?n=!0:o instanceof tT&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){const t=this.renderer.getSize(new Oe);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;const n=this._width*this._pixelRatio,i=this._height*this._pixelRatio;this.renderTarget1.setSize(n,i),this.renderTarget2.setSize(n,i);for(let r=0;r<this.passes.length;r++)this.passes[r].setSize(n,i)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}}class iT extends Ao{constructor(e,t,n=null,i=null,r=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=i,this.clearAlpha=r,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this._oldClearColor=new Me}render(e,t,n){const i=e.autoClear;e.autoClear=!1;let r,o;this.overrideMaterial!==null&&(o=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(r=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==!0&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(r),this.overrideMaterial!==null&&(this.scene.overrideMaterial=o),e.autoClear=i}}const sT={name:"FXAAShader",uniforms:{tDiffuse:{value:null},resolution:{value:new Oe(1/1024,1/512)}},vertexShader:`
		...
		}`};function Xd(){if(typeof window>"u")return!1;const s=window.matchMedia("(pointer: coarse)").matches,e=navigator.maxTouchPoints>0,t=/Android|iPhone|iPad|iPod|Mobile|webOS|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);return s&&e||t}function mo(){return typeof window>"u"||window.matchMedia("(orientation: landscape)").matches?!0:window.matchMedia("(orientation: portrait)").matches?!1:window.innerWidth>=window.innerHeight}function wo(){if(typeof window>"u")return{width:800,height:600};let s=window.innerWidth,e=window.innerHeight;const t=mo();return t&&s<e?[s,e]=[e,s]:!t&&s>e&&([s,e]=[e,s]),{width:Math.max(1,s),height:Math.max(1,e)}}function Yd(){if(typeof window>"u")return{width:800,height:600,top:0,left:0};const s=window.visualViewport;if(s){let n=Math.max(0,Math.round(s.offsetTop));const i=Math.max(0,Math.round(s.offsetLeft)),r=Math.max(1,Math.round(s.width));let o=Math.max(1,Math.round(s.height));const a=Math.max(0,Math.round(s.pageTop-window.scrollY));a>n&&(n=a);const l=Math.round(-document.documentElement.getBoundingClientRect().top);if(l>n&&(n=l),Xd()&&mo()){const c=Math.max(0,Math.round(window.innerHeight-s.height-s.offsetTop));n===0&&c>0&&(n=c)}return o=Math.max(1,Math.min(o,Math.round(window.innerHeight-n))),{width:r,height:o,top:n,left:i}}const{width:e,height:t}=wo();return{width:e,height:t,top:0,left:0}}function rT(s=Yd()){if(typeof document>"u")return s;const e=document.documentElement;return e.style.setProperty("--vv-top",`${s.top}px`),e.style.setProperty("--vv-left",`${s.left}px`),e.style.setProperty("--vv-width",`${s.width}px`),e.style.setProperty("--vv-height",`${s.height}px`),s}function Sa(s,e=Yd()){s&&(s.style.position="fixed",s.style.top=`${e.top}px`,s.style.left=`${e.left}px`,s.style.width=`${e.width}px`,s.style.height=`${e.height}px`,s.style.right="auto",s.style.bottom="auto",s.style.boxSizing="border-box")}function ri(s){s(),requestAnimationFrame(()=>{s(),requestAnimationFrame(s)});for(const e of[120,320,520])window.setTimeout(s,e)}let oT=0;function aT(){return oT}const lT={uniforms:{tDiffuse:{value:null},time:{value:0},resolution:{value:new Oe(1280,720)},intensity:{value:.16},blurAmount:{value:.58},wobble:{value:.0022},glitchBoost:{value:0}},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
      gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
