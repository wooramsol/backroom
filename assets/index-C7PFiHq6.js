...
`)}function I5(i,e){let t;switch(e){case _a:t="Linear";break;case ga:t="Reinhard";break;case xa:t="Cineon";break;case X9:t="ACESFilmic";break;case Ma:t="AgX";break;case Sa:t="Neutral";break;case va:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Si=new O;function N5(){W0.getLuminanceCoefficients(Si);const i=Si.x.toFixed(4),e=Si.y.toFixed(4),t=Si.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function F5(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(In).join(`
...
#define LOW_PRECISION`),e}function W5(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===G9?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Zr?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===at&&(e="SHADOWMAP_TYPE_VSM"),e}function X5(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case mn:case _n:e="ENVMAP_TYPE_CUBE";break;case Bi:e="ENVMAP_TYPE_CUBE_UV";break}return e}function q5(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case _n:e="ENVMAP_MODE_REFRACTION";break}return e}function Y5(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case W9:e="ENVMAP_BLENDING_MULTIPLY";break;case pa:e="ENVMAP_BLENDING_MIX";break;case ma:e="ENVMAP_BLENDING_ADD";break}return e}function K5(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Z5(i,e,t,n){const s=i.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=W5(t),c=X5(t),u=q5(t),h=Y5(t),f=K5(t),m=F5(t),g=O5(r),M=s.createProgram();let p,d,b=t.glslVersion?"#version "+t.glslVersion+`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}Mn.BlurDirectionX=new B0(1,0);Mn.BlurDirectionY=new B0(0,1);function Y6(i,e,t){const n=new W6(i);n.setPixelRatio(i.getPixelRatio()*br),n.addPass(new X6(e,t));const s=new Mn(new B0(window.innerWidth,window.innerHeight),q8,Y8,K8);return n.addPass(s),{composer:n,bloom:s}}function K6(i,e,t,n,s){i.setSize(n,s),e.setPixelRatio(i.getPixelRatio()*br),e.setSize(n,s),t.resolution.set(n,s)}const Dn=document.getElementById("overlay"),Z6=document.getElementById("hud"),$6=document.getElementById("vignette"),ze=new T8({antialias:!1,powerPreference:"high-performance"});y8.init();ze.setPixelRatio(Math.min(window.devicePixelRatio,1.5));ze.setSize(window.innerWidth,window.innerHeight);ze.outputColorSpace=Ae;ze.toneMapping=X9;ze.toneMappingExposure=Z8;ze.domElement.style.cssText="position:fixed;inset:0;z-index:1;visibility:hidden";document.body.appendChild(ze.domElement);const Sn=new b2;Sn.background=new O0(Er);Sn.fog=new Ms(Er,N8,F8);const un=new Be(D8,window.innerWidth/window.innerHeight,U8,50);un.layers.enableAll();un.position.set(A/2,Nn,A/2);Sn.add(new O2(B8,z8));Sn.add(new F2(H8,k8,V8));async function J6(){const i=new N2,e=await n6(i),t=e6(),n=Pr(t,wr,A,A),s={wallTex:e,carpetTex:t,carpet:Lr(n),lightPanelOn:new Xn({color:os}),lightPanelOff:new Xn({color:G8})},r=new L6(Sn,s),a=new B6(un,ze.domElement);r.init(a.position),a.connect();const{composer:o,bloom:l}=Y6(ze,Sn,un);let c=!1,u=!1;const h=document.querySelector("#overlay .hint"),f="클릭하여 시작<br />WASD · 이동 &nbsp; Shift · 달리기 &nbsp; Space · 점프 &nbsp; 마우스 · 시야";h&&(h.textContent="주변 공간 생성 중… (처음 한 번만)"),Dn.style.cursor="wait",r.preloadAround(a.position,(b,y)=>{h&&!u&&(h.innerHTML=`주변 공간 생성 중… ${b}/${y}<br/>시야 거리만큼 미리 만들고 있습니다`)}).then(()=>{for(let b=0;b<5;b++)o.render();a.setColliders(r.getColliders()),u=!0,ze.domElement.style.visibility="visible",Dn.style.cursor="pointer",h&&(h.innerHTML=f)}).catch(b=>{console.error(b),u=!0,ze.domElement.style.visibility="visible",Dn.style.cursor="pointer",h&&(h.textContent="로딩 오류 — 새로고침 해주세요.")}),Dn.addEventListener("click",()=>{u&&(a.requestLock(),c||(c=!0,Dn.classList.add("hidden"),Z6.classList.add("visible"),$6.classList.add("visible")))});const m=new mr;let g=0;const M=new O0(os),p=16.7;function d(){requestAnimationFrame(d);const b=performance.now(),y=Math.min(m.getDelta(),.05);g+=y,r.tick(y),r.preloading||(r.update(a.position),r.flushColliders()),a.setColliders(r.getColliders()),r.consumeColliderRebuild()&&a.resolvePenetration(),c&&a.update(y);for(const{light:S,panel:I,face:L}of r.getFixtures()){const R=.94+Math.sin(g*8+I.phase)*.04;S.intensity=Ar*I.bright*R,L.material.color.copy(M).multiplyScalar(yr*I.bright*R)}if(o.render(),!r.preloading){const S=performance.now()-b;let I=Math.max(3,Math.min(8,p-S));r.hasPendingLoads()&&(I=Math.max(I,14)),r.processLoadQueue(a.position,I)}}d(),window.addEventListener("resize",()=>{const b=window.innerWidth,y=window.innerHeight;un.aspect=b/y,un.updateProjectionMatrix(),K6(ze,o,l,b,y)})}J6().catch(i=>{console.error(i);const e=document.querySelector("#overlay .hint");e&&(e.textContent="로딩 오류 — 새로고침 해주세요.")});
