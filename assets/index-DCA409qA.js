...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:$n,depthTest:!1,depthWrite:!1})}function zu(){return new wn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:dl(),fragmentShader:`
		...
		`,blending:$n,depthTest:!1,depthWrite:!1})}function Bu(){return new wn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:dl(),fragmentShader:`
...
#define LOW_PRECISION`),e}function eM(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===cf?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Jd?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===kn&&(e="SHADOWMAP_TYPE_VSM"),e}function tM(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case _s:case xs:e="ENVMAP_TYPE_CUBE";break;case Po:e="ENVMAP_TYPE_CUBE_UV";break}return e}function nM(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case xs:e="ENVMAP_MODE_REFRACTION";break}return e}function iM(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Wc:e="ENVMAP_BLENDING_MULTIPLY";break;case _p:e="ENVMAP_BLENDING_MIX";break;case xp:e="ENVMAP_BLENDING_ADD";break}return e}function sM(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function rM(i,e,t,n){const s=i.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const c=eM(t),l=tM(t),u=nM(t),h=iM(t),f=sM(t),d=Yv(t),g=qv(r),_=s.createProgram();let m,p,T=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      ${e}`))}function YT(i){var s,r;const e=Nd(),t=i.map||null;t&&(t.colorSpace=lt);const n=new Xf({map:t,color:((r=(s=i.color)==null?void 0:s.clone)==null?void 0:r.call(s))??new De(12564640),emissiveMap:e,emissive:new De(13421772),emissiveIntensity:.65});return n.userData.chunkOwned=!0,n.userData.chairGlitch=!0,n.onBeforeCompile=o=>{o.uniforms.uGlitchTime={value:0},o.uniforms.uGlitchAmp={value:1},n.userData.glitchUniforms=o.uniforms,o.vertexShader=o.vertexShader.replace("#include <common>",`#include <common>
      ...
      uniform float uGlitchTime;`),XT(o)},n}function qT(i){i.userData.chairGlitch=!0,i.traverse(e=>{if(!e.isMesh||!e.material)return;const n=(Array.isArray(e.material)?e.material:[e.material]).map(s=>YT(s));e.material=n.length===1?n[0]:n})}function $T(i){var t,n;let e=i;for(;e;){if(((t=e.userData)==null?void 0:t.furnitureId)==="chairGlb")return!0;if((n=e.userData)!=null&&n.furnitureId)return!1;e=e.parent}return!1}function KT(i,e){const t=Math.floor(e*60);(t&7)===0&&WT();const s=(Math.random()<.11?2.2:1)*(1+Math.sin(e*61)*.3+Math.random()*.55);i.traverse(r=>{var a,c;if(!((a=r.isMesh)!=null&&a.material)||!$T(r))return;const o=Array.isArray(r.material)?r.material:[r.material];for(const l of o){if(!((c=l.userData)!=null&&c.chairGlitch))continue;const u=l.userData.glitchUniforms;u&&(u.uGlitchTime.value=e,u.uGlitchAmp.value=s),(t&3)===0&&(l.emissiveIntensity=.5+Math.random()*.95)}})}const Ci=new Kt;function ZT(i,e,t){e.updateMatrixWorld(!0),Ci.setFromObject(i);const n={minX:Ci.min.x,maxX:Ci.max.x,minZ:Ci.min.z,maxZ:Ci.max.z,topY:Ci.max.y,bottomY:Ci.min.y};return t.push(n),n}function jT(i,e,t,n){let s=0;const r=Math.max(.22,t*.38);for(const o of n)i+r>o.minX&&i-r<o.maxX&&e+r>o.minZ&&e-r<o.maxZ&&(s=Math.max(s,o.topY));return s}const Co=new Kt,qh=new Wt,JT=[["floor_normal",28],["floor_tipped",18],["wall_lean",24],["wall_embedded",14],["ceiling_stuck",10],["floor_embedded",6]],QT=[["floor_normal",38],["floor_tipped",32],["floor_embedded",18],["wall_lean",12]],eb=[["floor_normal",32],["floor_tipped",28],["floor_embedded",14],["ceiling_stuck",10]],tb=[["floor_normal",38],["floor_tipped",32],["floor_embedded",18],["ceiling_stuck",12]];function rs(i,e,t){e.updateMatrixWorld(!0),Co.setFromObject(i),i.position.y+=t-Co.min.y}function nb(i,e,t){e.updateMatrixWorld(!0),Co.setFromObject(i),i.position.y+=t-Co.max.y}function Gc(i,e,t=.55,n=48){for(let s=0;s<n;s++){const r=e.range(t,se-t),o=e.range(t,se-t);if(Sn(r,o,i))return{x:r,z:o}}return null}function ib(i){const e=xt*.5+.04,t=.8,n=[{axis:"z",pos:e,span0:t,span1:se-t},{axis:"z",pos:se-e,span0:t,span1:se-t},{axis:"x",pos:e,span0:t,span1:se-t},{axis:"x",pos:se-e,span0:t,span1:se-t}];return[...i,...n]}function sb(i,e,t){if(i.axis==="z"){const r=Sn(e,i.pos+.55,t),o=Sn(e,i.pos-.55,t);return r&&!o?.55:o&&!r?-.55:r?.55:-.55}const n=Sn(i.pos+.55,e,t),s=Sn(i.pos-.55,e,t);return n&&!s?.55:s&&!n?-.55:n?.55:-.55}function rb(i,e,t,n){const s=[...i];for(let r=s.length-1;r>0;r--){const o=n.int(0,r);[s[r],s[o]]=[s[o],s[r]]}for(let r=0;r<24;r++){const o=s[r%s.length],a=n.range(o.span0+t*.5,o.span1-t*.5),c=sb(o,a,e),l=o.axis==="z"?a:o.pos+c,u=o.axis==="z"?o.pos+c:a;if(!Sn(l,u,e))continue;const h=o.axis==="z"?c>0?0:Math.PI:c>0?-Math.PI/2:Math.PI/2;return{x:l,z:u,yaw:h,wall:o,offset:c}}return null}function ob(i,e,t,n,s,r){const{height:o,depth:a}=s,c=t.supportY??0;switch(i.rotation.set(0,0,0),i.position.set(t.x,0,t.z),e){case"floor_normal":i.rotation.y=t.yaw??n.range(0,Math.PI*2),rs(i,r,c);break;case"floor_tipped":i.rotation.y=n.range(0,Math.PI*2),qh.set(n.range(1.1,1.65),i.rotation.y,n.range(-.35,.35)),i.setRotationFromEuler(qh),rs(i,r,c+n.range(-.01,.02));break;case"wall_lean":{const l=n.range(.22,.48);i.rotation.y=t.yaw+n.range(-.2,.2),(t.wall.axis==="z"?"x":"z")==="x"?i.rotation.x=t.offset>0?-l:l:i.rotation.z=t.offset>0?l:-l;const h=a*n.range(.22,.42);t.wall.axis==="z"?i.position.z-=Math.sign(t.offset)*h:i.position.x-=Math.sign(t.offset)*h,rs(i,r,c);break}case"wall_embedded":{i.rotation.y=t.yaw+n.range(-.15,.15);const l=a*n.range(.42,.72);t.wall.axis==="z"?i.position.z-=Math.sign(t.offset)*l:i.position.x-=Math.sign(t.offset)*l,i.rotation.x=n.range(-.12,.12),rs(i,r,c+n.range(-.03,.05));break}case"ceiling_stuck":i.rotation.y=n.range(0,Math.PI*2),i.rotation.x=Math.PI+n.range(-.22,.22),i.rotation.z=n.range(-.18,.18),nb(i,r,Bi-.006+n.range(0,o*.22));break;case"floor_embedded":i.rotation.y=n.range(0,Math.PI*2),i.rotation.z=n.range(-.18,.18),rs(i,r,c-o*n.range(.15,.35));break;default:i.rotation.y=n.range(0,Math.PI*2),rs(i,r,c)}}function ab(i,e=!1,t=!1){return t?i.pickWeighted(e?tb:eb):i.pickWeighted(e?QT:JT)}function cb(i,e,t){for(const n of e){const[s,r]=n.split(",").map(Number),o=i.x-s,a=i.z-r;if(o*o+a*a<t*t)return!0}return!1}function lb(i,e,t,n,s,r,o){e.userData.chunkOwned=!0,i.add(e),n.push(VT(e,i)),t.furnitureId==="chairGlb"&&qT(e),ZT(e,i,o),s.add(`${r.x.toFixed(2)},${r.z.toFixed(2)}`)}function Ud(i,e,t,n,s,r,o,a={}){if(!t)return!1;const c=SS(t),l=c.userData;l.furnitureKind=a.kind||(l.isPile?"pile":"chair");const u=ab(n,a.pileMode,!!a.spot);let h=null;if(a.spot)h={...a.spot,yaw:a.spot.yaw??n.range(0,Math.PI*2)};else if(u==="floor_normal"||u==="floor_tipped"||u==="floor_embedded"){const d=Gc(e.innerWalls,n,l.footprint*.45);if(!d)return!1;h={...d,yaw:n.range(0,Math.PI*2)}}else if(u==="ceiling_stuck"){const d=Gc(e.innerWalls,n,l.footprint*.4);if(!d)return!1;h={...d}}else{const d=ib(e.innerWalls);if(h=rb(d,e.innerWalls,l.footprint,n),!h)return!1}h.supportY=jT(h.x,h.z,l.footprint,o);const f=a.minSep??l.footprint*.72;return cb(h,s,f)?!1:(ob(c,u,h,n,l,i),lb(i,c,l,r,s,h,o),!0)}function $h(i,e,t,n,s,r,o){const a=_d(t,n);return Ud(i,e,a,n,s,r,o,{kind:"prop"})}function ub(i,e,t,n,s,r,o){const a=Gc(e.innerWalls,n,1.2,72);if(!a)return 0;const c=n.int(2,14),l=n.range(.55,1.35);let u=0;for(let h=0;h<c*5&&u<c;h++){const f=n.range(0,Math.PI*2),d=n.range(.02,l)*Math.sqrt(n.range(.15,1)),g={x:a.x+Math.cos(f)*d,z:a.z+Math.sin(f)*d,yaw:n.range(0,Math.PI*2)};if(g.x<.45||g.x>se-.45||g.z<.45||g.z>se-.45||!Sn(g.x,g.z,e.innerWalls))continue;const _=_d(t,n);Ud(i,e,_,n,s,r,o,{spot:g,pileMode:!0,minSep:.26,kind:"pile"})&&u++}return u}function hb(i,e,t){var u;if(!((u=t==null?void 0:t.allProps)!=null&&u.length))return{colliders:[]};const n=[],s=[],r=bo(e.cx,e.cz,881);if(!r.chance(.5))return i.userData.furnitureColliders=n,{colliders:n};const o=new Set;let a=0;r.chance(.3)&&(a+=ub(i,e,t,r,o,n,s));const c=a>0?r.int(0,2):r.int(1,2);let l=0;for(let h=0;h<c*6&&l<c;h++)$h(i,e,t,r,o,n,s)&&l++;if(a+=l,a===0)for(let h=0;h<4&&!$h(i,e,t,r,o,n,s);h++);return i.userData.furnitureColliders=n,{colliders:n}}const bl=new Gi(se,se);bl.translate(se/2,se/2,0);bl.userData.shared=!0;const Fd=new Gi(ah,ah);Fd.userData.shared=!0;const Od=new Gi(ay,cy);Od.userData.shared=!0;const Kh=new ti().setFromEuler(new Wt(Math.PI/2,0,0)),ao=new L,Zh=new L(1,1,1),co=new He;function jh(i,e=Bi){i.boundingSphere=new gn(new L(se/2,e*.5,se/2),Math.hypot(se,e)*.75)}function fb(i,e,t,n,s,r){const{geometry:o}=kT(e,t.wallTex,n,s,r);if(o){o.computeBoundingBox(),o.computeBoundingSphere();const a=new Dt(o,t.wall);a.frustumCulled=!1,i.add(a)}}function db(i,e,t,n){const s=bl.clone();gy(s,dy,t,n);const r=new Dt(s,e.floor);r.rotation.x=-Math.PI/2,r.frustumCulled=!1,i.add(r)}function pb(i,e,t,n,s){const{gapY:r,tileY:o}=KE(e),a=Uo,{tx0:c,tx1:l,tz0:u,tz1:h}=$E(n,s,se,a),f=[];for(let m=c;m<=l;m++)for(let p=u;p<=h;p++){const{x:T,z:S}=qE(m,p,n,s,a);f.push(T,S)}const d=f.length/2,g=new Ec(Od,t.ceilingGroove,d),_=new Ec(Fd,t.ceilingTile,d);g.frustumCulled=!1,_.frustumCulled=!1,_.renderOrder=2;for(let m=0;m<d;m++){const p=f[m*2],T=f[m*2+1];ao.set(p,r,T),co.compose(ao,Kh,Zh),g.setMatrixAt(m,co),ao.set(p,o,T),co.compose(ao,Kh,Zh),_.setMatrixAt(m,co)}g.instanceMatrix.needsUpdate=!0,_.instanceMatrix.needsUpdate=!0,jh(g,e),jh(_,e),i.add(g),i.add(_)}function mb(i){i.traverse(e=>{var n;if(e.frustumCulled=!1,e.isInstancedMesh||!e.isMesh)return;const t=e.geometry;t&&!((n=t.userData)!=null&&n.shared)&&(t.computeBoundingBox(),t.computeBoundingSphere())})}function zd(i,e,t=null){const n=new pn;return n.position.set(i.cx*se,0,i.cz*se),{room:i,group:n,materials:e,furnitureModels:t,shellDone:!1,buildStage:0,worldX:i.cx*se,worldZ:i.cz*se}}function gb(i){for(;!i.shellDone&&!Bd(i););}function Bd(i){if(i.shellDone)return!0;const{room:e,group:t,materials:n}=i,s=e.height;switch(i.buildStage){case 0:return db(t,n,i.worldX,i.worldZ),i.buildStage=1,!1;case 1:return pb(t,s,n,i.worldX,i.worldZ),i.buildStage=2,!1;case 2:return fb(t,e,n,s,i.worldX,i.worldZ),i.buildStage=3,!1;default:return i.furnitureModels&&hb(t,e,i.furnitureModels),i.shellDone=!0,!0}}function kd(i){const{group:e,room:t}=i;return e.userData.room=t,mb(e),e.frustumCulled=!1,e}function Jh(i,e,t=null){const n=zd(i,e,t);return gb(n),kd(n)}const _b=["map","normalMap","roughnessMap","metalnessMap","aoMap","emissiveMap","alphaMap","bumpMap"];function Qh(i){var e,t;if((e=i==null?void 0:i.userData)!=null&&e.chunkOwned){for(const n of _b){const s=i[n];(t=s==null?void 0:s.userData)!=null&&t.chunkOwned&&s.dispose()}i.dispose()}}function xb(i){var t;const e=i.geometry;if(e&&!((t=e.userData)!=null&&t.shared)&&e.dispose(),!!i.material)if(Array.isArray(i.material))for(const n of i.material)Qh(n);else Qh(i.material)}function ef(i){i&&i.traverse(e=>{e.isLight||(e.isMesh||e.isInstancedMesh)&&xb(e)})}const vb=2,tf=2;class Mb{constructor(e,t,n=null){this.scene=e,this.materials=t,this.furnitureModels=n,this.chunks=new Map,this.wallMap=new Map,this.colliders=[],this.collidersDirty=!1,this.time=0,this.loadQueue=[],this.pendingKeys=new Set,this.disposeQueue=[],this.despawnPending=[],this.cellCx=NaN,this.cellCz=NaN,this.lastPrefetchEdge=!1,this.preloading=!1}key(e,t){return`${e},${t}`}distToPlayer(e,t,n){const s=e*se+se/2-n.x,r=t*se+se/2-n.z;return s*s+r*r}nearPrefetchEdge(e,t,n){const s=e.x-t*se,r=e.z-n*se,o=se*Gs;return s>o||s<se-o||r>o||r<se-o}ringKeys(e,t,n){const s=new Set;for(let r=t-n;r<=t+n;r++)for(let o=e-n;o<=e+n;o++)s.add(this.key(o,r));return s}computeNeed(e,t,n,s=this.nearPrefetchEdge(n,e,t)){const r=s?rd:sd,o=this.ringKeys(e,t,r),a=n.x-e*se,c=n.z-t*se,l=r+1;if(a>se*Gs)for(let u=t-r;u<=t+r;u++)o.add(this.key(e+l,u));if(a<se*(1-Gs))for(let u=t-r;u<=t+r;u++)o.add(this.key(e-l,u));if(c>se*Gs)for(let u=e-r;u<=e+r;u++)o.add(this.key(u,t+l));if(c<se*(1-Gs))for(let u=e-r;u<=e+r;u++)o.add(this.key(u,t-l));return o}insertJob(e){const t=e.dist;let n=0,s=this.loadQueue.length;for(;n<s;){const r=n+s>>1;this.loadQueue[r].dist<t?n=r+1:s=r}this.loadQueue.splice(n,0,e)}rebuildColliderList(){const e=YE(this.wallMap);for(const t of this.chunks.values()){const n=t.furnitureColliders;n!=null&&n.length&&e.push(...n)}this.colliders=e,this.collidersDirty=!1}_markCollidersDirty(){this.collidersDirty=!0}addCollidersForRoom(e){Uh(this.wallMap,e),this._markCollidersDirty()}removeCollidersForRoom(e){Fh(this.wallMap,e)&&this._markCollidersDirty()}addFurnitureForChunk(e){const t=e.userData.furnitureColliders||[];return this._markCollidersDirty(),{furnitureColliders:t}}removeFurnitureForChunk(e){this._markCollidersDirty()}consumeColliderRebuild(){return this.collidersDirty?(this.rebuildColliderList(),!0):!1}attachChunk(e,t,n,s){const r=this.key(e,t);kd(s);const o=s.group,a=this.addFurnitureForChunk(o);this.chunks.set(r,{mesh:o,room:n,...a})}spawnComplete(e,t){const n=Da(e,t);this.addCollidersForRoom(n);const s=Jh(n,this.materials,this.furnitureModels),r=this.addFurnitureForChunk(s);this.scene.add(s),this.chunks.set(this.key(e,t),{mesh:s,room:n,...r})}despawn(e){const t=this.chunks.get(e);if(!t)return;const{mesh:n,room:s}=t;n&&(this.scene.remove(n),this.disposeQueue.push(n)),this.chunks.delete(e),s&&this.removeCollidersForRoom(s)}enqueue(e,t,n){const s=this.key(e,t);this.chunks.has(s)||this.pendingKeys.has(s)||(this.pendingKeys.add(s),this.insertJob({cx:e,cz:t,dist:this.distToPlayer(e,t,n),room:null,build:null}))}init(e){const t=Math.floor(e.x/se),n=Math.floor(e.z/se);this.cellCx=t,this.cellCz=n,this.lastPrefetchEdge=this.nearPrefetchEdge(e,t,n),this.chunks.has(this.key(t,n))||this.spawnComplete(t,n)}update(e){if(this.preloading)return;const t=Math.floor(e.x/se),n=Math.floor(e.z/se),s=this.nearPrefetchEdge(e,t,n);if(t===this.cellCx&&n===this.cellCz&&s===this.lastPrefetchEdge&&!this.loadQueue.length&&!this.despawnPending.length)return;this.cellCx=t,this.cellCz=n,this.lastPrefetchEdge=s;const r=this.computeNeed(t,n,e,s),o=new Set(this.despawnPending);for(const u of this.chunks.keys()){if(r.has(u)||o.has(u))continue;const[h,f]=u.split(",").map(Number);Math.max(Math.abs(h-t),Math.abs(f-n))>ty&&this.despawnPending.push(u)}this.loadQueue=this.loadQueue.filter(u=>{var f;const h=this.key(u.cx,u.cz);return r.has(h)?!0:(u.room&&!this.chunks.has(h)&&(Fh(this.wallMap,u.room),this._markCollidersDirty()),(f=u.build)!=null&&f.group&&(u.build.group.parent&&this.scene.remove(u.build.group),ef(u.build.group)),!1)});for(const u of this.pendingKeys)!r.has(u)&&!this.chunks.has(u)&&this.pendingKeys.delete(u);const a=this.loadQueue.length,c=a>6?1:a>2?tf:tf+1,l=[];for(const u of r){if(this.chunks.has(u)||this.pendingKeys.has(u))continue;const[h,f]=u.split(",").map(Number);l.push({x:h,z:f,dist:this.distToPlayer(h,f,e)})}l.sort((u,h)=>u.dist-h.dist);for(let u=0;u<Math.min(c,l.length);u++){const{x:h,z:f}=l[u];this.enqueue(h,f,e)}}processLoadQueue(){if(!this.loadQueue.length)return;const e=this.loadQueue[0],t=this.key(e.cx,e.cz);if(!e.room){e.room=Da(e.cx,e.cz),e.build=zd(e.room,this.materials,this.furnitureModels),this.chunks.has(t)||(Uh(this.wallMap,e.room),this._markCollidersDirty());return}if(!e.build.shellDone){Bd(e.build);return}e.build.group.parent||this.scene.add(e.build.group),this.attachChunk(e.cx,e.cz,e.room,e.build),this.loadQueue.shift(),this.pendingKeys.delete(t)}tick(e){this.time+=e,this.disposeQueue.length&&ef(this.disposeQueue.shift());for(let t=0;t<vb&&this.despawnPending.length;t++)this.despawn(this.despawnPending.shift())}getColliders(){return this.colliders}_spawnChunkComplete(e,t){const n=this.key(e,t),s=Da(e,t);this.addCollidersForRoom(s);const r=Jh(s,this.materials,this.furnitureModels),o=this.addFurnitureForChunk(r);this.scene.add(r),this.chunks.set(n,{mesh:r,room:s,...o}),this.pendingKeys.delete(n)}_spawnChunkSafe(e,t){try{this._spawnChunkComplete(e,t)}catch(n){throw console.error(`Chunk build failed (${e}, ${t})`,n),n}}async preloadAround(e,{onProgress:t,onBootstrapReady:n,onComplete:s}={}){const r=e.position,o=Math.floor(r.x/se),a=Math.floor(r.z/se),c=u=>{const h=[];for(let f=a-u;f<=a+u;f++)for(let d=o-u;d<=o+u;d++)this.chunks.has(this.key(d,f))||h.push({cx:d,cz:f});return h.sort((f,d)=>this.distToPlayer(f.cx,f.cz,r)-this.distToPlayer(d.cx,d.cz,r)),h};this.preloading=!0,this.loadQueue.length=0,this.pendingKeys.clear();const l=c(ey);try{let u=0;for(const{cx:h,cz:f}of l)this._spawnChunkSafe(h,f),u++,t==null||t(u,l.length||1);this.init(r),this.rebuildColliderList(),n==null||n(),s==null||s()}catch(u){throw this.preloading=!1,u}this.preloading=!1}hasPendingLoads(){return!this.preloading&&this.loadQueue.length>0}isStreaming(){return this.hasPendingLoads()}}const yb=3.2,Sb=5.8,Eb=9,Tb=.035,bb=.018,nf=.09,Ia=Bi-.1,sf=new Wt(0,0,0,"YXZ"),wb=new L(0,1,0),ui=new L,Na=new L,zn=new L;class Ab{constructor(e,t){this.camera=e,this.domElement=t,this.position=new L(se/2,Zn,se/2),this.yaw=0,this.pitch=0,this.keys={},this.locked=!1,this.colliders=[],this.nearbyColliders=[],this.colliderQueryX=NaN,this.colliderQueryZ=NaN,this.bob=0,this.vy=0,this.grounded=!0,this.groundY=0,this.crouchBlend=0,this.onMove=null,this.onJump=null,this.onLand=null,this.onLockLost=null,this.onLockAcquired=null,this.camera.rotation.order="YXZ",this._onKeyDown=n=>{var s;n.code==="Space"&&(n.preventDefault(),this.locked&&this.grounded&&!this.crouching&&(this.vy=VM,this.grounded=!1,(s=this.onJump)==null||s.call(this))),this.keys[n.code]=!0,n.code==="KeyR"&&this._unstuck()},this._onKeyUp=n=>{this.keys[n.code]=!1},this._onMouseMove=n=>{this.locked&&(this.yaw-=n.movementX*rh,this.pitch-=n.movementY*rh,this.pitch=Ni.clamp(this.pitch,-oh,oh))},this._onLockChange=()=>{var s,r;const n=this.locked;this.locked=document.pointerLockElement===this.domElement,n&&!this.locked?(this._clearKeys(),(s=this.onLockLost)==null||s.call(this)):!n&&this.locked&&((r=this.onLockAcquired)==null||r.call(this))},this._onVisibility=()=>{document.hidden&&this._clearKeys()},this._onBlur=()=>{this._clearKeys()}}get crouching(){return this.locked&&!!this.keys.KeyC}_eyeHeight(){return Ni.lerp(Zn,UM,this.crouchBlend)}_collisionRadius(){return Ni.lerp(ki,FM,this.crouchBlend)}_clearKeys(){this.keys={}}connect(){window.addEventListener("keydown",this._onKeyDown),window.addEventListener("keyup",this._onKeyUp),document.addEventListener("mousemove",this._onMouseMove),document.addEventListener("pointerlockchange",this._onLockChange),document.addEventListener("visibilitychange",this._onVisibility),window.addEventListener("blur",this._onBlur)}requestLock(){this.locked||this.domElement.requestPointerLock()}isLocked(){return this.locked}setColliders(e){this.colliders=e,this.colliderQueryX=NaN,this.colliderQueryZ=NaN}setPosition(e,t,n){this.position.set(e,t,n),this._applyLook()}_queryColliders(){const e=this.position.x,t=this.position.z;if(e===this.colliderQueryX&&t===this.colliderQueryZ&&this.nearbyColliders.length)return this.nearbyColliders;const n=se*1.25,s=[];for(const r of this.colliders)e+n<r.minX||e-n>r.maxX||t+n<r.minZ||t-n>r.maxZ||s.push(r);return this.nearbyColliders=s,this.colliderQueryX=e,this.colliderQueryZ=t,s}_unstuck(){this.crouchBlend=0,this.position.set(se/2,Zn,se/2),this.vy=0,this.grounded=!0,this.groundY=0}_feetY(){return this.position.y-this._eyeHeight()}_eyeOnSupport(e){return e+this._eyeHeight()}_horizontalProbeY(){return Ni.lerp(this.position.y,this._feetY()+OM*.42,this.crouchBlend)}_overlapsXZ(e,t,n,s=this._collisionRadius()){return!(e+s<=n.minX||e-s>=n.maxX||t+s<=n.minZ||t-s>=n.maxZ)}_findSupportY(e,t,n,s,r){let o=0;const a=n+s*r,c=ki;for(const l of this._queryColliders()){if(!l.standable||l.standTopY===void 0||!this._overlapsXZ(e,t,l,c))continue;const u=l.standTopY,h=Math.abs(n-u)<nf,f=s<=0&&a<=u+nf&&n>=u-.65;(h||f)&&(o=Math.max(o,u))}return o}_applyLook(e=0){this.camera.position.set(this.position.x,this.position.y+e,this.position.z),this.camera.up.set(0,1,0),sf.set(this.pitch,this.yaw,0),this.camera.quaternion.setFromEuler(sf),this.camera.updateMatrixWorld(!0)}_syncWalkFromCamera(){this.camera.getWorldDirection(ui),ui.y=0,ui.lengthSq()<1e-10?ui.set(0,0,-1):ui.normalize(),Na.crossVectors(ui,wb).normalize()}_blocksHorizontal(e,t){return!(e.isCeiling||t<e.minY-.2||t>e.maxY+.2)}_insideWall(e,t){const n=this._horizontalProbeY(),s=this._collisionRadius();for(const r of this._queryColliders())if(this._blocksHorizontal(r,n)&&!(e+s<=r.minX||e-s>=r.maxX||t+s<=r.minZ||t-s>=r.maxZ))return!0;return!1}_pushOut(e,t){const n=this._horizontalProbeY(),s=this._collisionRadius();for(let r=0;r<14;r++){let o=!1;for(const a of this._queryColliders()){if(!this._blocksHorizontal(a,n)||e+s<=a.minX||e-s>=a.maxX||t+s<=a.minZ||t-s>=a.maxZ)continue;const c=e+s-a.minX,l=a.maxX-(e-s),u=t+s-a.minZ,h=a.maxZ-(t-s),f=Math.min(c,l,u,h);f===c?e-=c:f===l?e+=l:f===u?t-=u:t+=h,o=!0}if(!o)break}return{px:e,pz:t}}resolvePenetration(){if(!this._insideWall(this.position.x,this.position.z))return;const e=this._pushOut(this.position.x,this.position.z);this.position.x=e.px,this.position.z=e.pz}update(e){var _,m;const t=this.crouching?1:0;this.crouchBlend+=(t-this.crouchBlend)*Math.min(1,BM*e),this._applyLook(0),this._syncWalkFromCamera(),zn.set(0,0,0),(this.keys.KeyW||this.keys.ArrowUp)&&zn.add(ui),(this.keys.KeyS||this.keys.ArrowDown)&&zn.sub(ui),(this.keys.KeyA||this.keys.ArrowLeft)&&zn.sub(Na),(this.keys.KeyD||this.keys.ArrowRight)&&zn.add(Na);const n=!this.crouching&&(this.keys.ShiftLeft||this.keys.ShiftRight),s=this.crouching?zM:n?Sb:yb,r=this.position.x,o=this.position.z;let a=0;if(zn.lengthSq()>0){zn.normalize().multiplyScalar(s*e);const p=this.position.x+zn.x,T=this.position.z+zn.z;if(!this._insideWall(p,T))this.position.x=p,this.position.z=T;else{const S=this._pushOut(p,T);this.position.x=S.px,this.position.z=S.pz}a=Math.hypot(this.position.x-r,this.position.z-o),this.grounded&&(this.bob+=e*Eb*(this.crouching?.75:n?1.3:1))}else this.grounded&&(this.bob*=.85);a>0&&this.grounded&&((_=this.onMove)==null||_.call(this,a,n,this.crouching,s));const c=this.grounded,l=this._feetY(),u=this._findSupportY(this.position.x,this.position.z,l,this.vy,e),h=Math.min(this._eyeOnSupport(u),Ia);this.vy-=WM*e;let f=this.position.y+this.vy*e;if(f>Ia&&(f=Ia,this.vy=0),f<=h&&this.vy<=0){const p=Math.abs(this.vy),T=!c;this.position.y=h,this.vy=0,this.grounded=!0,this.groundY=u,T&&((m=this.onLand)==null||m.call(this,p))}else this.position.y=f,this.grounded=!1;this.resolvePenetration();const d=Ni.lerp(Tb,bb,this.crouchBlend),g=this.grounded?Math.sin(this.bob)*d:0;this._applyLook(g)}}const Rb="/backroom/",Cb=`${Rb}assets/${encodeURIComponent("01. Government Funding.mp3")}`,Pb=2,Lb=2.75,Db=1.4;class Ib{constructor(){this.ctx=null,this.master=null,this.sfxGain=null,this.bgmGain=null,this.bgmBuffer=null,this.bgmSource=null,this._stepAccum=0,this._bgmLoading=null}_ensure(){if(this.ctx)return!0;try{return this.ctx=new AudioContext,this.master=this.ctx.createGain(),this.master.gain.value=1,this.master.connect(this.ctx.destination),this.sfxGain=this.ctx.createGain(),this.sfxGain.gain.value=2.1,this.sfxGain.connect(this.master),!0}catch{return!1}}async preload(){return this.bgmBuffer?this.bgmBuffer:this._bgmLoading?this._bgmLoading:(this._bgmLoading=fetch(Cb).then(e=>{if(!e.ok)throw new Error(`BGM load failed: ${e.status}`);return e.arrayBuffer()}).then(e=>this._ensure()?this.ctx.decodeAudioData(e):null).then(e=>(this.bgmBuffer=e,e)).catch(e=>(console.warn("[audio] background music unavailable",e),null)),this._bgmLoading)}start(){if(!this._ensure()||(this.ctx.state==="suspended"&&this.ctx.resume(),this.bgmSource))return;const e=()=>{if(!this.bgmBuffer||this.bgmSource)return;const t=this.ctx.createBufferSource();t.buffer=this.bgmBuffer,t.loop=!0,this.bgmGain=this.ctx.createGain(),this.bgmGain.gain.value=.42,t.connect(this.bgmGain),this.bgmGain.connect(this.master),t.start(),this.bgmSource=t};if(this.bgmBuffer){e();return}this.preload().then(e)}onLand(e=4){if(!this._ensure())return;this.ctx.state==="suspended"&&this.ctx.resume();const t=Math.min(1,Math.max(.3,e/7.5));this._stepAccum=0,this._playFootstep(!1,!1,{land:!0,impact:t})}onJump(){this._ensure()&&(this.ctx.state==="suspended"&&this.ctx.resume(),this._playFootstep(!1,!1,{jump:!0}))}onMove(e,t,n=!1,s=3.2){if(!this._ensure()||(this.ctx.state==="suspended"&&this.ctx.resume(),e<1e-5||s<.1))return;this._stepAccum+=e;const o=s/(n?Db:t?Lb:Pb);for(;this._stepAccum>=o;)this._stepAccum-=o,this._playFootstep(t,n)}_playFootstep(e,t,{jump:n=!1,land:s=!1,impact:r=1}={}){const o=this.ctx,a=o.currentTime;let c,l,u,h,f;n?(c=.065,l=.22,u=128,h=860,f=250):s?(c=.12,l=.3+r*.38,u=72+r*48,h=620,f=175):(c=t?.12:e?.075:.1,l=t?.24:e?.42:.34,u=t?88:e?118:102,h=t?480:e?1050:780,f=t?165:e?285:220);const d=o.createOscillator();d.type="sine",d.frequency.value=u+Math.random()*28;const g=o.createGain();g.gain.setValueAtTime(l*1.35,a),g.gain.exponentialRampToValueAtTime(.001,a+c),d.connect(g),g.connect(this.sfxGain),d.start(a),d.stop(a+c+.02);const _=Math.max(1,Math.floor(o.sampleRate*c)),m=o.createBuffer(1,_,o.sampleRate),p=m.getChannelData(0);for(let C=0;C<_;C++){const A=Math.pow(1-C/_,1.4);p[C]=(Math.random()*2-1)*A}const T=o.createBufferSource();T.buffer=m;const S=o.createBiquadFilter();S.type="lowpass",S.frequency.value=h,S.Q.value=.55;const v=o.createBiquadFilter();v.type="bandpass",v.frequency.value=f+Math.random()*70,v.Q.value=.65;const R=o.createGain();R.gain.setValueAtTime(l,a),R.gain.exponentialRampToValueAtTime(.001,a+c*.92),T.connect(S),S.connect(v),v.connect(R),R.connect(this.sfxGain),T.start(a),T.stop(a+c+.02)}}const Nb={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
  ...
  `};function Wb(){return new wl(Vb)}function Xb(i,e){i.uniforms.time.value=e}function Hd(i,e,t,n=1){i.uniforms.resolution.value.set(e*n,t*n)}function Al(i){return i.getPixelRatio()*ly}function Gd(i,e,t){const n=Al(i);return new ae(1/(e*n),1/(t*n))}function Yb(i,e,t){const n=window.innerWidth,s=window.innerHeight,r=Al(i),o=new kb(i);o.setPixelRatio(r),o.setSize(n,s),o.addPass(new Hb(e,t));const a=new wl(Gb);a.material.uniforms.resolution.value.copy(Gd(i,n,s)),o.addPass(a);const c=Wb();return Hd(c,n,s,r),o.addPass(c),{composer:o,fxaa:a,noise:c,render(l=0){Xb(c,l),o.render()}}}function qb(i,e,t,n){const s=Al(i);i.setSize(t,n),e.composer.setPixelRatio(s),e.composer.setSize(t,n),e.fxaa.material.uniforms.resolution.value.copy(Gd(i,t,n)),Hd(e.noise,t,n,s)}const $b="1.0.0",Kb="9a40af0",Zb="2026-06-23 22:38:51",jb="dev";function Jb(){return`v${$b} · ${Kb} · ${Zb} · ${jb}`}const lo=document.getElementById("overlay"),Qb=document.getElementById("hud"),ew=document.getElementById("vignette"),ms=document.getElementById("crosshair"),of=document.getElementById("build-label"),Ua=document.getElementById("build-badge"),af=document.getElementById("build-version"),Bn=document.getElementById("resume-prompt"),Vd=Jb();of&&(of.textContent=Vd);af&&(af.textContent=Vd);function Fa(){if(!ms)return;const i=Lt.domElement.getBoundingClientRect();ms.style.left=`${i.left+i.width/2}px`,ms.style.top=`${i.top+i.height/2}px`}const Lt=new IM({antialias:!1,powerPreference:"high-performance"});Lt.setPixelRatio(Math.min(window.devicePixelRatio,1));Lt.setSize(window.innerWidth,window.innerHeight);Lt.outputColorSpace=lt;Lt.toneMapping=lf;Lt.toneMappingExposure=uy;Lt.domElement.style.cssText="position:fixed;inset:0;z-index:1;visibility:hidden";document.body.appendChild(Lt.domElement);const Vn=new Am;Vn.background=new De(id);Vn.fog=new tl(id,JM,QM);const Hn=new Ot(XM,window.innerWidth/window.innerHeight,YM,qM);Hn.position.set(se/2,Zn,se/2);Vn.add(new Bg(ny,iy));Vn.add(new Dg(sy,ry,oy));const Pi=new Ib;async function tw(){const i=document.getElementById("hint-status"),e="Loading… please wait";i&&(i.textContent=e),lo.style.cursor="wait";const t=new Kf,[n,s,r]=await Promise.all([by(t),Ey(t),yS()]),o=s.clone();o.wrapS=o.wrapT=Vt,o.userData={...s.userData};const a=wy(n,s,o);Pi.preload();const c=new Mb(Vn,a,r),l=new Ab(Hn,Lt.domElement);l.connect();function u(){Bn&&(Bn.hidden=!1,Bn.classList.add("visible"))}function h(){Bn&&(Bn.classList.remove("visible"),Bn.hidden=!0)}function f(){!_||!g||l.isLocked()||l.requestLock()}l.onLockLost=()=>{g&&u()},l.onLockAcquired=h,l.onMove=(R,C,A,D)=>{g&&Pi.onMove(R,C,A,D)},l.onJump=()=>{g&&Pi.onJump()},l.onLand=R=>{g&&Pi.onLand(R)},Lt.domElement.addEventListener("click",()=>{var R;((R=Pi.ctx)==null?void 0:R.state)==="suspended"&&Pi.ctx.resume()}),Lt.domElement.addEventListener("click",f),Bn==null||Bn.addEventListener("click",f);const d=Yb(Lt,Vn,Hn);let g=!1,_=!1;function m(){var D,E;const R=c.chunks.get("0,0");if(!(R!=null&&R.room))return;const C=((E=(D=R.mesh)==null?void 0:D.userData)==null?void 0:E.furnitureColliders)??[],A=wd(R.room,C);A&&(l.setPosition(A.x,Zn,A.z),Hn.position.set(A.x,Zn,A.z),l.resolvePenetration())}function p(){_||(_=!0,l.setColliders(c.getColliders()),m(),Lt.domElement.style.visibility="visible",Fa(),lo.style.cursor="pointer",i&&(i.innerHTML='Click to start<br /><span style="opacity:0.55;font-size:0.85em">Nearby rooms are ready — more load as you explore</span>'))}c.preloadAround(Hn,{onProgress:(R,C)=>{i&&!_&&(i.innerHTML=`Building starting area… ${R}/${C}`)},onBootstrapReady:p,onComplete:()=>{l.setColliders(c.getColliders())}}).catch(R=>{console.error(R),p(),i&&(i.textContent="Load error — click to retry view.")}),lo.addEventListener("click",()=>{_&&(l.requestLock(),g||(g=!0,lo.classList.add("hidden"),Qb.classList.add("visible"),ew.classList.add("visible"),ms==null||ms.classList.add("visible"),Fa(),Ua==null||Ua.classList.add("visible"),Pi.start()))});const T=new Zf;let S=0;function v(){requestAnimationFrame(v);const R=Math.min(T.getDelta(),.05);S+=R,c.tick(R),!c.preloading&&g&&(c.update(l.position),c.hasPendingLoads()&&c.processLoadQueue(),c.consumeColliderRebuild()&&(l.setColliders(c.getColliders()),l.resolvePenetration())),g&&!c.isStreaming()&&KT(Vn,S),g&&l.update(R),_?g&&c.isStreaming()?Lt.render(Vn,Hn):d.render(S):Lt.render(Vn,Hn)}v(),window.addEventListener("resize",()=>{const R=window.innerWidth,C=window.innerHeight;Hn.aspect=R/C,Hn.updateProjectionMatrix(),qb(Lt,d,R,C),Fa()})}tw().catch(i=>{console.error(i);const e=document.getElementById("hint-status");e&&(e.textContent="Load error — please refresh.")});
