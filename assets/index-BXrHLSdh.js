...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ln,depthTest:!1,depthWrite:!1})}function xo(){return new $t({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Aa(),fragmentShader:`
		...
		`,blending:ln,depthTest:!1,depthWrite:!1})}function Mo(){return new $t({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Aa(),fragmentShader:`
...
`)}function tm(i,e){let t;switch(e){case Fc:t="Linear";break;case Oc:t="Reinhard";break;case Bc:t="Cineon";break;case ll:t="ACESFilmic";break;case kc:t="AgX";break;case Hc:t="Neutral";break;case zc:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Er=new F;function nm(){Ge.getLuminanceCoefficients(Er);const i=Er.x.toFixed(4),e=Er.y.toFixed(4),t=Er.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}function hm(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===al?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===mc?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===an&&(e="SHADOWMAP_TYPE_VSM"),e}function fm(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case vi:case xi:e="ENVMAP_TYPE_CUBE";break;case kr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function dm(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case xi:e="ENVMAP_MODE_REFRACTION";break}return e}function pm(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case ol:e="ENVMAP_BLENDING_MULTIPLY";break;case Ic:e="ENVMAP_BLENDING_MIX";break;case Nc:e="ENVMAP_BLENDING_ADD";break}return e}function mm(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function _m(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=hm(t),c=fm(t),u=dm(t),h=pm(t),f=mm(t),p=im(t),g=rm(s),M=r.createProgram();let m,d,A=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`};class Wr{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error("THREE.Pass: .render() must be implemented in derived pass.")}dispose(){}}const yg=new Ll(-1,1,1,-1,0,1);class Tg extends dn{constructor(){super(),this.setAttribute("position",new un([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new un([0,2,0,0,2,0],2))}}const Ag=new Tg;class bg{constructor(e){this._mesh=new Et(Ag,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,yg)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}}class rc extends Wr{constructor(e,t="tDiffuse"){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof $t?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Al.clone(e.uniforms),this.material=new $t({name:e.name!==void 0?e.name:"unspecified",defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new bg(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}}class rl extends Wr{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){const r=e.getContext(),s=e.state;s.buffers.color.setMask(!1),s.buffers.depth.setMask(!1),s.buffers.color.setLocked(!0),s.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),s.buffers.stencil.setTest(!0),s.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),s.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),s.buffers.stencil.setClear(o),s.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),s.buffers.color.setLocked(!1),s.buffers.depth.setLocked(!1),s.buffers.color.setMask(!0),s.buffers.depth.setMask(!0),s.buffers.stencil.setLocked(!1),s.buffers.stencil.setFunc(r.EQUAL,1,4294967295),s.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),s.buffers.stencil.setLocked(!0)}}class Rg extends Wr{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}}class wg{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){const n=e.getSize(new qe);this._width=n.width,this._height=n.height,t=new An(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:yi}),t.texture.name="EffectComposer.rt1"}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name="EffectComposer.rt2",this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new rc(Eg),this.copyPass.material.blending=ln,this.clock=new Dl}swapBuffers(){const e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){const t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){e===void 0&&(e=this.clock.getDelta());const t=this.renderer.getRenderTarget();let n=!1;for(let r=0,s=this.passes.length;r<s;r++){const a=this.passes[r];if(a.enabled!==!1){if(a.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(r),a.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),a.needsSwap){if(n){const o=this.renderer.getContext(),l=this.renderer.state.buffers.stencil;l.setFunc(o.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),l.setFunc(o.EQUAL,1,4294967295)}this.swapBuffers()}rl!==void 0&&(a instanceof rl?n=!0:a instanceof Rg&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){const t=this.renderer.getSize(new qe);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;const n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let s=0;s<this.passes.length;s++)this.passes[s].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}}class Cg extends Wr{constructor(e,t,n=null,r=null,s=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=s,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this._oldClearColor=new ze}render(e,t,n){const r=e.autoClear;e.autoClear=!1;let s,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(s=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==!0&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(s),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}}const Pg={name:"FXAAShader",uniforms:{tDiffuse:{value:null},resolution:{value:new qe(1/1024,1/512)}},vertexShader:`
		...
		}`};function wa(i){return i.getPixelRatio()*d_}function sc(i,e,t){const n=wa(i);return new qe(1/(e*n),1/(t*n))}function Lg(i,e,t){const n=window.innerWidth,r=window.innerHeight,s=new wg(i);s.setPixelRatio(wa(i)),s.setSize(n,r),s.addPass(new Cg(e,t));const a=new rc(Pg);return a.material.uniforms.resolution.value.copy(sc(i,n,r)),s.addPass(a),{composer:s,fxaa:a,render(){s.render()}}}function Dg(i,e,t,n){const r=wa(i);i.setSize(t,n),e.composer.setPixelRatio(r),e.composer.setSize(t,n),e.fxaa.material.uniforms.resolution.value.copy(sc(i,t,n))}const Ug="1.0.0",Ig="b000062",Ng="2026-06-21 21:14:41",Fg="dev";function Og(){return`v${Ug} · ${Ig} · ${Ng} · ${Fg}`}const Bi=document.getElementById("overlay"),Bg=document.getElementById("hud"),zg=document.getElementById("vignette"),_i=document.getElementById("crosshair"),sl=document.getElementById("build-label"),Wi=document.getElementById("build-badge"),sn=document.getElementById("resume-prompt"),ac=Og();sl&&(sl.textContent=ac);Wi&&(Wi.textContent=ac);function br(){if(!_i)return;const i=At.domElement.getBoundingClientRect();_i.style.left=`${i.left+i.width/2}px`,_i.style.top=`${i.top+i.height/2}px`}const At=new Wm({antialias:!1,powerPreference:"high-performance"});At.setPixelRatio(Math.min(window.devicePixelRatio,1));At.setSize(window.innerWidth,window.innerHeight);At.outputColorSpace=gt;At.toneMapping=ll;At.toneMappingExposure=p_;At.domElement.style.cssText="position:fixed;inset:0;z-index:1;visibility:hidden";document.body.appendChild(At.domElement);const Ei=new Xu;Ei.background=new ze(Hl);Ei.fog=new ya(Hl,t_,n_);const li=new Nt($m,window.innerWidth/window.innerHeight,Zm,50);li.position.set(te/2,Hi,te/2);Ei.add(new sh(r_,s_));Ei.add(new rh(a_,o_,l_));async function kg(){const i=new ih,e=await w_(i),t=await b_(i),n=C_(e,t),r=new mg(Ei,n),s=new Sg(li,At.domElement);r.init(s.position),s.connect();function a(){sn&&(sn.hidden=!1,sn.classList.add("visible"))}function o(){sn&&(sn.classList.remove("visible"),sn.hidden=!0)}function l(){!h||!u||s.isLocked()||s.requestLock()}s.onLockLost=()=>{u&&a()},s.onLockAcquired=o,At.domElement.addEventListener("click",l),sn==null||sn.addEventListener("click",l);const c=Lg(At,Ei,li);let u=!1,h=!1;const f=document.querySelector("#overlay .hint"),p="Click to start<br />WASD · Move &nbsp; Shift · Run &nbsp; Space · Jump &nbsp; Mouse · Look";f&&(f.textContent="Building nearby rooms… (one-time)"),Bi.style.cursor="wait",r.preloadAround(li,(d,A)=>{f&&!h&&(f.innerHTML=`Building nearby rooms… ${d}/${A}<br/>Preparing the area within view distance`)}).then(()=>{for(let d=0;d<5;d++)c.render();s.setColliders(r.getColliders()),h=!0,At.domElement.style.visibility="visible",br(),Bi.style.cursor="pointer",f&&(f.innerHTML=p)}).catch(d=>{console.error(d),h=!0,At.domElement.style.visibility="visible",Bi.style.cursor="pointer",f&&(f.textContent="Load error — please refresh.")}),Bi.addEventListener("click",()=>{h&&(s.requestLock(),u||(u=!0,Bi.classList.add("hidden"),Bg.classList.add("visible"),zg.classList.add("visible"),_i==null||_i.classList.add("visible"),br(),Wi==null||Wi.classList.add("visible")))});const g=new Dl,M=16.7;function m(){requestAnimationFrame(m);const d=performance.now(),A=Math.min(g.getDelta(),.05);if(r.tick(A),r.preloading||(r.update(s.position),r.consumeColliderRebuild()&&(r.flushColliders(),s.setColliders(r.getColliders()),s.resolvePenetration())),u&&(s.update(A),br()),c.render(),!r.preloading){const T=performance.now()-d,E=Math.max(2,Math.min(6,M-T));r.processLoadQueue(s.position,E)}}m(),window.addEventListener("resize",()=>{const d=window.innerWidth,A=window.innerHeight;li.aspect=d/A,li.updateProjectionMatrix(),Dg(At,c,d,A),br()})}kg().catch(i=>{console.error(i);const e=document.querySelector("#overlay .hint");e&&(e.textContent="Load error — please refresh.")});
