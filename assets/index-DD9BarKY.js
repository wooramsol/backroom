...
#endif`,To="gl_FragColor = linearToOutputTexel( gl_FragColor );",yo=`vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ct,depthTest:!1,depthWrite:!1})}function p9(){return new Pe({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ys(),fragmentShader:`
		...
		`,blending:ct,depthTest:!1,depthWrite:!1})}function m9(){return new Pe({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ys(),fragmentShader:`
	...
	`}function F4(i){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const l=o.mapping,c=l===D1||l===U1,u=l===pn||l===mn;if(c||u){let h=e.get(o);const f=h!==void 0?h.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==f)return t===null&&(t=new f9(i)),h=c?t.fromEquirectangular(o,h):t.fromCubemap(o,h),h.texture.pmremVersion=o.pmremVersion,e.set(o,h),h.texture;if(h!==void 0)return h.texture;{const m=o.image;return c&&m&&m.height>0||u&&m&&s(m)?(t===null&&(t=new f9(i)),h=c?t.fromEquirectangular(o):t.fromCubemap(o),h.texture.pmremVersion=o.pmremVersion,e.set(o,h),o.addEventListener("dispose",r),h.texture):null}}}return o}function s(o){let l=0;const c=6;for(let u=0;u<c;u++)o[u]!==void 0&&l++;return l===c}function r(o){const l=o.target;l.removeEventListener("dispose",r);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function O4(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const s=t(n);return s===null&&hn("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function B4(i,e,t,n){const s={},r=new WeakMap;function a(h){const f=h.target;f.index!==null&&e.remove(f.index);for(const g in f.attributes)e.remove(f.attributes[g]);f.removeEventListener("dispose",a),delete s[f.id];const m=r.get(f);m&&(e.remove(m),r.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function o(h,f){return s[f.id]===!0||(f.addEventListener("dispose",a),s[f.id]=!0,t.memory.geometries++),f}function l(h){const f=h.attributes;for(const m in f)e.update(f[m],i.ARRAY_BUFFER)}function c(h){const f=[],m=h.index,g=h.attributes.position;let M=0;if(m!==null){const b=m.array;M=m.version;for(let y=0,S=b.length;y<S;y+=3){const I=b[y+0],L=b[y+1],R=b[y+2];f.push(I,L,L,R,R,I)}}else if(g!==void 0){const b=g.array;M=g.version;for(let y=0,S=b.length/3-1;y<S;y+=3){const I=y+0,L=y+1,R=y+2;f.push(I,L,L,R,R,I)}}else return;const p=new(sr(f)?cr:lr)(f,1);p.version=M;const d=r.get(h);d&&e.remove(d),r.set(h,p)}function u(h){const f=r.get(h);if(f){const m=h.index;m!==null&&f.version<m.version&&c(h)}else c(h);return r.get(h)}return{get:o,update:l,getWireframeAttribute:u}}function z4(i,e,t){let n;function s(f){n=f}let r,a;function o(f){r=f.type,a=f.bytesPerElement}function l(f,m){i.drawElements(n,m,r,f*a),t.update(m,n,1)}function c(f,m,g){g!==0&&(i.drawElementsInstanced(n,m,r,f*a,g),t.update(m,n,g))}function u(f,m,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,m,0,r,f,0,g);let p=0;for(let d=0;d<g;d++)p+=m[d];t.update(p,n,1)}function h(f,m,g,M){if(g===0)return;const p=e.get("WEBGL_multi_draw");if(p===null)for(let d=0;d<f.length;d++)c(f[d]/a,m[d],M[d]);else{p.multiDrawElementsInstancedWEBGL(n,m,0,r,f,0,M,0,g);let d=0;for(let b=0;b<g;b++)d+=m[b]*M[b];t.update(d,n,1)}}this.setMode=s,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function H4(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function k4(i,e,t){const n=new WeakMap,s=new oe;function r(a,o,l){const c=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,h=u!==void 0?u.length:0;let f=n.get(o);if(f===void 0||f.count!==h){let v=function(){N.dispose(),n.delete(o),o.removeEventListener("dispose",v)};var m=v;f!==void 0&&f.texture.dispose();const g=o.morphAttributes.position!==void 0,M=o.morphAttributes.normal!==void 0,p=o.morphAttributes.color!==void 0,d=o.morphAttributes.position||[],b=o.morphAttributes.normal||[],y=o.morphAttributes.color||[];let S=0;g===!0&&(S=1),M===!0&&(S=2),p===!0&&(S=3);let I=o.attributes.position.count*S,L=1;I>e.maxTextureSize&&(L=Math.ceil(I/e.maxTextureSize),I=e.maxTextureSize);const R=new Float32Array(I*L*4*h),N=new rr(R,I,L,h);N.type=Ye,N.needsUpdate=!0;const E=S*4;for(let P=0;P<h;P++){const W=d[P],H=b[P],Z=y[P],$=I*L*4*P;for(let q=0;q<W.count;q++){const j=q*E;g===!0&&(s.fromBufferAttribute(W,q),R[$+j+0]=s.x,R[$+j+1]=s.y,R[$+j+2]=s.z,R[$+j+3]=0),M===!0&&(s.fromBufferAttribute(H,q),R[$+j+4]=s.x,R[$+j+5]=s.y,R[$+j+6]=s.z,R[$+j+7]=0),p===!0&&(s.fromBufferAttribute(Z,q),R[$+j+8]=s.x,R[$+j+9]=s.y,R[$+j+10]=s.z,R[$+j+11]=Z.itemSize===4?s.w:1)}}f={count:h,texture:N,size:new B0(I,L)},n.set(o,f),o.addEventListener("dispose",v)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let g=0;for(let p=0;p<c.length;p++)g+=c[p];const M=o.morphTargetsRelative?1:1-g;l.getUniforms().setValue(i,"morphTargetBaseInfluence",M),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",f.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",f.size)}return{update:r}}function V4(i,e,t,n){let s=new WeakMap;function r(l){const c=n.render.frame,u=l.geometry,h=e.get(l,u);if(s.get(h)!==c&&(e.update(h),s.set(h,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),s.get(l)!==c&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),s.set(l,c))),l.isSkinnedMesh){const f=l.skeleton;s.get(f)!==c&&(f.update(),s.set(f,c))}return h}function a(){s=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:r,dispose:a}}const vr=new _e,_9=new pr(1,1),Mr=new rr,Sr=new l2,Er=new fr,g9=[],x9=[],v9=new Float32Array(16),M9=new Float32Array(9),S9=new Float32Array(4);function Tn(i,e,t){const n=i[0];if(n<=0||n>0)return i;const s=e*t;let r=g9[s];if(r===void 0&&(r=new Float32Array(s),g9[s]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(r,o)}return r}function he(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function fe(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function Hi(i,e){let t=x9[e];t===void 0&&(t=new Int32Array(e),x9[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function G4(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function W4(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(he(t,e))return;i.uniform2fv(this.addr,e),fe(t,e)}}function X4(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(he(t,e))return;i.uniform3fv(this.addr,e),fe(t,e)}}function q4(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(he(t,e))return;i.uniform4fv(this.addr,e),fe(t,e)}}function Y4(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(he(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),fe(t,e)}else{if(he(t,n))return;S9.set(n),i.uniformMatrix2fv(this.addr,!1,S9),fe(t,n)}}function K4(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(he(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),fe(t,e)}else{if(he(t,n))return;M9.set(n),i.uniformMatrix3fv(this.addr,!1,M9),fe(t,n)}}function Z4(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(he(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),fe(t,e)}else{if(he(t,n))return;v9.set(n),i.uniformMatrix4fv(this.addr,!1,v9),fe(t,n)}}function $4(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function J4(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(he(t,e))return;i.uniform2iv(this.addr,e),fe(t,e)}}function j4(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(he(t,e))return;i.uniform3iv(this.addr,e),fe(t,e)}}function Q4(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(he(t,e))return;i.uniform4iv(this.addr,e),fe(t,e)}}function e5(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function t5(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(he(t,e))return;i.uniform2uiv(this.addr,e),fe(t,e)}}function n5(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(he(t,e))return;i.uniform3uiv(this.addr,e),fe(t,e)}}function i5(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(he(t,e))return;i.uniform4uiv(this.addr,e),fe(t,e)}}function s5(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(_9.compareFunction=ir,r=_9):r=vr,t.setTexture2D(e||r,s)}function r5(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||Sr,s)}function a5(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||Er,s)}function o5(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||Mr,s)}function l5(i){switch(i){case 5126:return G4;case 35664:return W4;case 35665:return X4;case 35666:return q4;case 35674:return Y4;case 35675:return K4;case 35676:return Z4;case 5124:case 35670:return $4;case 35667:case 35671:return J4;case 35668:case 35672:return j4;case 35669:case 35673:return Q4;case 5125:return e5;case 36294:return t5;case 36295:return n5;case 36296:return i5;case 35678:case 36198:case 36298:case 36306:case 35682:return s5;case 35679:case 36299:case 36307:return r5;case 35680:case 36300:case 36308:case 36293:return a5;case 36289:case 36303:case 36311:case 36292:return o5}}function c5(i,e){i.uniform1fv(this.addr,e)}function u5(i,e){const t=Tn(e,this.size,2);i.uniform2fv(this.addr,t)}function h5(i,e){const t=Tn(e,this.size,3);i.uniform3fv(this.addr,t)}function f5(i,e){const t=Tn(e,this.size,4);i.uniform4fv(this.addr,t)}function d5(i,e){const t=Tn(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function p5(i,e){const t=Tn(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function m5(i,e){const t=Tn(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function _5(i,e){i.uniform1iv(this.addr,e)}function g5(i,e){i.uniform2iv(this.addr,e)}function x5(i,e){i.uniform3iv(this.addr,e)}function v5(i,e){i.uniform4iv(this.addr,e)}function M5(i,e){i.uniform1uiv(this.addr,e)}function S5(i,e){i.uniform2uiv(this.addr,e)}function E5(i,e){i.uniform3uiv(this.addr,e)}function T5(i,e){i.uniform4uiv(this.addr,e)}function y5(i,e,t){const n=this.cache,s=e.length,r=Hi(t,s);he(n,r)||(i.uniform1iv(this.addr,r),fe(n,r));for(let a=0;a!==s;++a)t.setTexture2D(e[a]||vr,r[a])}function A5(i,e,t){const n=this.cache,s=e.length,r=Hi(t,s);he(n,r)||(i.uniform1iv(this.addr,r),fe(n,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||Sr,r[a])}function b5(i,e,t){const n=this.cache,s=e.length,r=Hi(t,s);he(n,r)||(i.uniform1iv(this.addr,r),fe(n,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||Er,r[a])}function w5(i,e,t){const n=this.cache,s=e.length,r=Hi(t,s);he(n,r)||(i.uniform1iv(this.addr,r),fe(n,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||Mr,r[a])}function R5(i){switch(i){case 5126:return c5;case 35664:return u5;case 35665:return h5;case 35666:return f5;case 35674:return d5;case 35675:return p5;case 35676:return m5;case 5124:case 35670:return _5;case 35667:case 35671:return g5;case 35668:case 35672:return x5;case 35669:case 35673:return v5;case 5125:return M5;case 36294:return S5;case 36295:return E5;case 36296:return T5;case 35678:case 36198:case 36298:case 36306:case 35682:return y5;case 35679:case 36299:case 36307:return A5;case 35680:case 36300:case 36308:case 36293:return b5;case 36289:case 36303:case 36311:case 36292:return w5}}class C5{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=l5(t.type)}}class P5{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=R5(t.type)}}class L5{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(e,t[o.id],n)}}}const g1=/(\w+)(\])?(\[|\.)?/g;function E9(i,e){i.seq.push(e),i.map[e.id]=e}function D5(i,e,t){const n=i.name,s=n.length;for(g1.lastIndex=0;;){const r=g1.exec(n),a=g1.lastIndex;let o=r[1];const l=r[2]==="]",c=r[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===s){E9(t,c===void 0?new C5(o,i,e):new P5(o,i,e));break}else{let h=t.map[o];h===void 0&&(h=new L5(o),E9(t,h)),t=h}}}class Li{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){const r=e.getActiveUniform(t,s),a=e.getUniformLocation(t,r.name);D5(r,a,this)}}setValue(e,t,n,s){const r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){const s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,a=t.length;r!==a;++r){const o=t[r],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,s)}}static seqWithValue(e,t){const n=[];for(let s=0,r=e.length;s!==r;++s){const a=e[s];a.id in t&&n.push(a)}return n}}function T9(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const U5=37297;let I5=0;function N5(i,e){const t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const y9=new I0;function F5(i){W0._getMatrix(y9,W0.workingColorSpace,i);const e=`mat3( ${y9.elements.map(t=>t.toFixed(4))} )`;switch(W0.getTransfer(i)){case Ii:return[e,"LinearTransferOETF"];case J0:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function A9(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),s=i.getShaderInfoLog(e).trim();if(n&&s==="")return"";const r=/ERROR: 0:(\d+)/.exec(s);if(r){const a=parseInt(r[1]);return t.toUpperCase()+`

`+s+`

`+N5(i.getShaderSource(e),a)}else return s}function O5(i,e){const t=F5(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function B5(i,e){let t;switch(e){case Ma:t="Linear";break;case Sa:t="Reinhard";break;case Ea:t="Cineon";break;case Y9:t="ACESFilmic";break;case ya:t="AgX";break;case Aa:t="Neutral";break;case Ta:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Si=new O;function z5(){W0.getLuminanceCoefficients(Si);const i=Si.x.toFixed(4),e=Si.y.toFixed(4),t=Si.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function H5(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Un).join(`
`)}function k5(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function V5(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function Un(i){return i!==""}function b9(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function w9(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const G5=/^[ \t]*#include +<([\w\d./]+)>/gm;function os(i){return i.replace(G5,X5)}const W5=new Map;function X5(i,e){let t=F0[e];if(t===void 0){const n=W5.get(e);if(n!==void 0)t=F0[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return os(t)}const q5=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function R9(i){return i.replace(q5,Y5)}function Y5(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function C9(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function K5(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===X9?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Qr?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===at&&(e="SHADOWMAP_TYPE_VSM"),e}function Z5(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case pn:case mn:e="ENVMAP_TYPE_CUBE";break;case zi:e="ENVMAP_TYPE_CUBE_UV";break}return e}function $5(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case mn:e="ENVMAP_MODE_REFRACTION";break}return e}function J5(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case q9:e="ENVMAP_BLENDING_MULTIPLY";break;case xa:e="ENVMAP_BLENDING_MIX";break;case va:e="ENVMAP_BLENDING_ADD";break}return e}function j5(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Q5(i,e,t,n){const s=i.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=K5(t),c=Z5(t),u=$5(t),h=J5(t),f=j5(t),m=H5(t),g=k5(r),M=s.createProgram();let p,d,b=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+d);const y=b+p+a,S=b+d+o,I=T9(s,s.VERTEX_SHADER,y),L=T9(s,s.FRAGMENT_SHADER,S);s.attachShader(M,I),s.attachShader(M,L),t.index0AttributeName!==void 0?s.bindAttribLocation(M,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(M,0,"position"),s.linkProgram(M);function R(P){if(i.debug.checkShaderErrors){const W=s.getProgramInfoLog(M).trim(),H=s.getShaderInfoLog(I).trim(),Z=s.getShaderInfoLog(L).trim();let $=!0,q=!0;if(s.getProgramParameter(M,s.LINK_STATUS)===!1)if($=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,M,I,L);else{const j=A9(s,I,"vertex"),k=A9(s,L,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(M,s.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`};class Jn{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error("THREE.Pass: .render() must be implemented in derived pass.")}dispose(){}}const G6=new _r(-1,1,1,-1,0,1);class W6 extends yt{constructor(){super(),this.setAttribute("position",new ht([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new ht([0,2,0,0,2,0],2))}}const X6=new W6;class Vr{constructor(e){this._mesh=new we(X6,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,G6)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}}class q6 extends Jn{constructor(e,t="tDiffuse"){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof Pe?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Fi.clone(e.uniforms),this.material=new Pe({name:e.name!==void 0?e.name:"unspecified",defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new Vr(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}}class W9 extends Jn{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){const s=e.getContext(),r=e.state;r.buffers.color.setMask(!1),r.buffers.depth.setMask(!1),r.buffers.color.setLocked(!0),r.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),r.buffers.stencil.setTest(!0),r.buffers.stencil.setOp(s.REPLACE,s.REPLACE,s.REPLACE),r.buffers.stencil.setFunc(s.ALWAYS,a,4294967295),r.buffers.stencil.setClear(o),r.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),r.buffers.color.setLocked(!1),r.buffers.depth.setLocked(!1),r.buffers.color.setMask(!0),r.buffers.depth.setMask(!0),r.buffers.stencil.setLocked(!1),r.buffers.stencil.setFunc(s.EQUAL,1,4294967295),r.buffers.stencil.setOp(s.KEEP,s.KEEP,s.KEEP),r.buffers.stencil.setLocked(!0)}}class Y6 extends Jn{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}}class K6{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){const n=e.getSize(new B0);this._width=n.width,this._height=n.height,t=new Ze(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:Ke}),t.texture.name="EffectComposer.rt1"}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name="EffectComposer.rt2",this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new q6(Ui),this.copyPass.material.blending=ct,this.clock=new gr}swapBuffers(){const e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){const t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){e===void 0&&(e=this.clock.getDelta());const t=this.renderer.getRenderTarget();let n=!1;for(let s=0,r=this.passes.length;s<r;s++){const a=this.passes[s];if(a.enabled!==!1){if(a.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(s),a.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),a.needsSwap){if(n){const o=this.renderer.getContext(),l=this.renderer.state.buffers.stencil;l.setFunc(o.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),l.setFunc(o.EQUAL,1,4294967295)}this.swapBuffers()}W9!==void 0&&(a instanceof W9?n=!0:a instanceof Y6&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){const t=this.renderer.getSize(new B0);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;const n=this._width*this._pixelRatio,s=this._height*this._pixelRatio;this.renderTarget1.setSize(n,s),this.renderTarget2.setSize(n,s);for(let r=0;r<this.passes.length;r++)this.passes[r].setSize(n,s)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}}class Z6 extends Jn{constructor(e,t,n=null,s=null,r=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=s,this.clearAlpha=r,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this._oldClearColor=new O0}render(e,t,n){const s=e.autoClear;e.autoClear=!1;let r,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(r=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==!0&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(r),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=s}}const $6={uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new O0(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}vn.BlurDirectionX=new B0(1,0);vn.BlurDirectionY=new B0(0,1);function J6(i,e,t){const n=new K6(i);n.setPixelRatio(i.getPixelRatio()*Rr),n.addPass(new Z6(e,t));const s=new vn(new B0(window.innerWidth,window.innerHeight),Z8,$8,J8);return n.addPass(s),{composer:n,bloom:s}}function j6(i,e,t,n,s){i.setSize(n,s),e.setPixelRatio(i.getPixelRatio()*Rr),e.setSize(n,s),t.resolution.set(n,s)}const Ln=document.getElementById("overlay"),Q6=document.getElementById("hud"),e7=document.getElementById("vignette"),ze=new w8({antialias:!1,powerPreference:"high-performance"});R8.init();ze.setPixelRatio(Math.min(window.devicePixelRatio,1.5));ze.setSize(window.innerWidth,window.innerHeight);ze.outputColorSpace=Ae;ze.toneMapping=Y9;ze.toneMappingExposure=j8;ze.domElement.style.cssText="position:fixed;inset:0;z-index:1;visibility:hidden";document.body.appendChild(ze.domElement);const Mn=new P2;Mn.background=new O0(yr);Mn.fog=new Ss(yr,B8,z8);const Nn=new Be(N8,window.innerWidth/window.innerHeight,F8,50);Nn.position.set(A/2,In,A/2);const Gr=new k2(k8,V8);Gr.layers.enableAll();Mn.add(Gr);const Wr=new H2(G8,W8,X8);Wr.layers.enableAll();Mn.add(Wr);async function t7(){const i=new z2,e=await r6(i),t=i6(),n=Dr(t,Cr,A,A),s={wallTex:e,carpetTex:t,carpet:Ur(n),lightPanelOn:new Xn({color:ls}),lightPanelOff:new Xn({color:q8})},r=new N6(Mn,s),a=new V6(Nn,ze.domElement);r.init(a.position),a.connect();const{composer:o,bloom:l}=J6(ze,Mn,Nn);let c=!1,u=!1;const h=document.querySelector("#overlay .hint"),f="클릭하여 시작<br />WASD · 이동 &nbsp; Shift · 달리기 &nbsp; Space · 점프 &nbsp; 마우스 · 시야";h&&(h.textContent="주변 공간 생성 중… (처음 한 번만)"),Ln.style.cursor="wait",r.preloadAround(a.position,(b,y)=>{h&&!u&&(h.innerHTML=`주변 공간 생성 중… ${b}/${y}<br/>시야 거리만큼 미리 만들고 있습니다`)}).then(()=>{for(let b=0;b<5;b++)o.render();a.setColliders(r.getColliders()),u=!0,ze.domElement.style.visibility="visible",Ln.style.cursor="pointer",h&&(h.innerHTML=f)}).catch(b=>{console.error(b),u=!0,ze.domElement.style.visibility="visible",Ln.style.cursor="pointer",h&&(h.textContent="로딩 오류 — 새로고침 해주세요.")}),Ln.addEventListener("click",()=>{u&&(a.requestLock(),c||(c=!0,Ln.classList.add("hidden"),Q6.classList.add("visible"),e7.classList.add("visible")))});const m=new gr;let g=0;const M=new O0(ls),p=16.7;function d(){requestAnimationFrame(d);const b=performance.now(),y=Math.min(m.getDelta(),.05);g+=y,r.tick(y),r.preloading||(r.update(a.position),r.flushColliders()),a.setColliders(r.getColliders()),r.consumeColliderRebuild()&&a.resolvePenetration(),c&&a.update(y);for(const{light:S,panel:I,face:L}of r.getFixtures()){const R=.94+Math.sin(g*8+I.phase)*.04;S.intensity=wr*I.bright*R,L.material.color.copy(M).multiplyScalar(br*I.bright*R)}if(o.render(),!r.preloading){const S=performance.now()-b;let I=Math.max(3,Math.min(8,p-S));r.hasPendingLoads()&&(I=Math.max(I,14)),r.processLoadQueue(a.position,I)}}d(),window.addEventListener("resize",()=>{const b=window.innerWidth,y=window.innerHeight;Nn.aspect=b/y,Nn.updateProjectionMatrix(),j6(ze,o,l,b,y)})}t7().catch(i=>{console.error(i);const e=document.querySelector("#overlay .hint");e&&(e.textContent="로딩 오류 — 새로고침 해주세요.")});
