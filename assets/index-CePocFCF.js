...
`].filter(Bi).join(`
`)),a=ca(a),a=Po(a,t),a=Lo(a,t),o=ca(o),o=Po(o,t),o=Lo(o,t),a=Do(a),o=Do(o),t.isRawShaderMaterial!==!0&&(A=`#version 300 es
...
`)+`
`+d);const b=A+m+a,y=A+d+o,I=wo(s,s.VERTEX_SHADER,b),L=wo(s,s.FRAGMENT_SHADER,y);s.attachShader(M,I),s.attachShader(M,L),t.index0AttributeName!==void 0?s.bindAttribLocation(M,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(M,0,"position"),s.linkProgram(M);function R(P){if(i.debug.checkShaderErrors){const W=s.getProgramInfoLog(M).trim(),k=s.getShaderInfoLog(I).trim(),$=s.getShaderInfoLog(L).trim();let Z=!0,q=!0;if(s.getProgramParameter(M,s.LINK_STATUS)===!1)if(Z=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,M,I,L);else{const j=Co(s,I,"vertex"),H=Co(s,L,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(M,s.VALIDATE_STATUS)+`
