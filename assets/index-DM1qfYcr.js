...
`)}function v0(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Ss).join(`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      uniform float uGlitchTime;`),ZM(a)},n}function QM(i){i.userData.chairGlitch=!0,i.traverse(e=>{if(!e.isMesh||!e.material)return;const n=(Array.isArray(e.material)?e.material:[e.material]).map(s=>JM(s));e.material=n.length===1?n[0]:n})}function eS(i){var t,n;let e=i;for(;e;){if(((t=e.userData)==null?void 0:t.furnitureId)==="chairGlb")return!0;if((n=e.userData)!=null&&n.furnitureId)return!1;e=e.parent}return!1}function tS(i,e){(Math.floor(e*60)&1)===0&&jM();const n=(Math.random()<.11?2.2:1)*(1+Math.sin(e*61)*.3+Math.random()*.55);i.traverse(s=>{var a,o;if(!((a=s.isMesh)!=null&&a.material)||!eS(s))return;const r=Array.isArray(s.material)?s.material:[s.material];for(const l of r){if(!((o=l.userData)!=null&&o.chairGlitch))continue;const c=l.userData.glitchUniforms;c&&(c.uGlitchTime.value=e,c.uGlitchAmp.value=n),l.emissiveIntensity=.5+Math.random()*.95}})}const ai=new Vt;function nS(i,e,t){e.updateMatrixWorld(!0),ai.setFromObject(i);const n={minX:ai.min.x,maxX:ai.max.x,minZ:ai.min.z,maxZ:ai.max.z,topY:ai.max.y,bottomY:ai.min.y};return t.push(n),n}function iS(i,e,t,n){let s=0;const r=Math.max(.22,t*.38);for(const a of n)i+r>a.minX&&i-r<a.maxX&&e+r>a.minZ&&e-r<a.maxZ&&(s=Math.max(s,a.topY));return s}const Br=new Vt,uu=new zt,sS=[["floor_normal",28],["floor_tipped",18],["wall_lean",24],["wall_embedded",14],["ceiling_stuck",10],["floor_embedded",6]],rS=[["floor_normal",38],["floor_tipped",32],["floor_embedded",18],["wall_lean",12]],aS=[["floor_normal",32],["floor_tipped",28],["floor_embedded",14],["ceiling_stuck",10]],oS=[["floor_normal",38],["floor_tipped",32],["floor_embedded",18],["ceiling_stuck",12]];function Ni(i,e,t){e.updateMatrixWorld(!0),Br.setFromObject(i),i.position.y+=t-Br.min.y}function lS(i,e,t){e.updateMatrixWorld(!0),Br.setFromObject(i),i.position.y+=t-Br.max.y}function Bo(i,e,t=.55,n=48){for(let s=0;s<n;s++){const r=e.range(t,z-t),a=e.range(t,z-t);if(pi(r,a,i))return{x:r,z:a}}return null}function cS(i){const e=St*.5+.04,t=.8,n=[{axis:"z",pos:e,span0:t,span1:z-t},{axis:"z",pos:z-e,span0:t,span1:z-t},{axis:"x",pos:e,span0:t,span1:z-t},{axis:"x",pos:z-e,span0:t,span1:z-t}];return[...i,...n]}function uS(i,e,t){if(i.axis==="z"){const r=pi(e,i.pos+.55,t),a=pi(e,i.pos-.55,t);return r&&!a?.55:a&&!r?-.55:r?.55:-.55}const n=pi(i.pos+.55,e,t),s=pi(i.pos-.55,e,t);return n&&!s?.55:s&&!n?-.55:n?.55:-.55}function hS(i,e,t,n){const s=[...i];for(let r=s.length-1;r>0;r--){const a=n.int(0,r);[s[r],s[a]]=[s[a],s[r]]}for(let r=0;r<24;r++){const a=s[r%s.length],o=n.range(a.span0+t*.5,a.span1-t*.5),l=uS(a,o,e),c=a.axis==="z"?o:a.pos+l,u=a.axis==="z"?a.pos+l:o;if(!pi(c,u,e))continue;const h=a.axis==="z"?l>0?0:Math.PI:l>0?-Math.PI/2:Math.PI/2;return{x:c,z:u,yaw:h,wall:a,offset:l}}return null}function fS(i,e,t,n,s,r){const{height:a,depth:o}=s,l=t.supportY??0;switch(i.rotation.set(0,0,0),i.position.set(t.x,0,t.z),e){case"floor_normal":i.rotation.y=t.yaw??n.range(0,Math.PI*2),Ni(i,r,l);break;case"floor_tipped":i.rotation.y=n.range(0,Math.PI*2),uu.set(n.range(1.1,1.65),i.rotation.y,n.range(-.35,.35)),i.setRotationFromEuler(uu),Ni(i,r,l+n.range(-.01,.02));break;case"wall_lean":{const c=n.range(.22,.48);i.rotation.y=t.yaw+n.range(-.2,.2),(t.wall.axis==="z"?"x":"z")==="x"?i.rotation.x=t.offset>0?-c:c:i.rotation.z=t.offset>0?c:-c;const h=o*n.range(.22,.42);t.wall.axis==="z"?i.position.z-=Math.sign(t.offset)*h:i.position.x-=Math.sign(t.offset)*h,Ni(i,r,l);break}case"wall_embedded":{i.rotation.y=t.yaw+n.range(-.15,.15);const c=o*n.range(.42,.72);t.wall.axis==="z"?i.position.z-=Math.sign(t.offset)*c:i.position.x-=Math.sign(t.offset)*c,i.rotation.x=n.range(-.12,.12),Ni(i,r,l+n.range(-.03,.05));break}case"ceiling_stuck":i.rotation.y=n.range(0,Math.PI*2),i.rotation.x=Math.PI+n.range(-.22,.22),i.rotation.z=n.range(-.18,.18),lS(i,r,_i-.006+n.range(0,a*.22));break;case"floor_embedded":i.rotation.y=n.range(0,Math.PI*2),i.rotation.z=n.range(-.18,.18),Ni(i,r,l-a*n.range(.15,.35));break;default:i.rotation.y=n.range(0,Math.PI*2),Ni(i,r,l)}}function dS(i,e=!1,t=!1){return t?i.pickWeighted(e?oS:aS):i.pickWeighted(e?rS:sS)}function pS(i,e,t){for(const n of e){const[s,r]=n.split(",").map(Number),a=i.x-s,o=i.z-r;if(a*a+o*o<t*t)return!0}return!1}function mS(i,e,t,n,s,r,a){e.userData.chunkOwned=!0,i.add(e),n.push($M(e,i)),t.furnitureId==="chairGlb"&&QM(e),nS(e,i,a),s.add(`${r.x.toFixed(2)},${r.z.toFixed(2)}`)}function kh(i,e,t,n,s,r,a,o={}){if(!t)return!1;const l=jv(t),c=l.userData;c.furnitureKind=o.kind||(c.isPile?"pile":"chair");const u=dS(n,o.pileMode,!!o.spot);let h=null;if(o.spot)h={...o.spot,yaw:o.spot.yaw??n.range(0,Math.PI*2)};else if(u==="floor_normal"||u==="floor_tipped"||u==="floor_embedded"){const d=Bo(e.innerWalls,n,c.footprint*.45);if(!d)return!1;h={...d,yaw:n.range(0,Math.PI*2)}}else if(u==="ceiling_stuck"){const d=Bo(e.innerWalls,n,c.footprint*.4);if(!d)return!1;h={...d}}else{const d=cS(e.innerWalls);if(h=hS(d,e.innerWalls,c.footprint,n),!h)return!1}h.supportY=iS(h.x,h.z,c.footprint,a);const f=o.minSep??c.footprint*.72;return pS(h,s,f)?!1:(fS(l,u,h,n,c,i),mS(i,l,c,r,s,h,a),!0)}function hu(i,e,t,n,s,r,a){const o=bh(t,n);return kh(i,e,o,n,s,r,a,{kind:"prop"})}function gS(i,e,t,n,s,r,a){const o=Bo(e.innerWalls,n,1.2,72);if(!o)return 0;const l=n.int(2,14),c=n.range(.55,1.35);let u=0;for(let h=0;h<l*5&&u<l;h++){const f=n.range(0,Math.PI*2),d=n.range(.02,c)*Math.sqrt(n.range(.15,1)),g={x:o.x+Math.cos(f)*d,z:o.z+Math.sin(f)*d,yaw:n.range(0,Math.PI*2)};if(g.x<.45||g.x>z-.45||g.z<.45||g.z>z-.45||!pi(g.x,g.z,e.innerWalls))continue;const _=bh(t,n);kh(i,e,_,n,s,r,a,{spot:g,pileMode:!0,minSep:.26,kind:"pile"})&&u++}return u}function _S(i,e,t){var u;if(!((u=t==null?void 0:t.allProps)!=null&&u.length))return{colliders:[]};const n=[],s=[],r=Us(e.cx,e.cz,881);if(!r.chance(.5))return i.userData.furnitureColliders=n,{colliders:n};const a=new Set;let o=0;r.chance(.3)&&(o+=gS(i,e,t,r,a,n,s));const l=o>0?r.int(0,2):r.int(1,2);let c=0;for(let h=0;h<l*6&&c<l;h++)hu(i,e,t,r,a,n,s)&&c++;if(o+=c,o===0)for(let h=0;h<4&&!hu(i,e,t,r,a,n,s);h++);return i.userData.furnitureColliders=n,{colliders:n}}const pl=new xi(z,z);pl.translate(z/2,z/2,0);pl.userData.shared=!0;const Hh=new xi(Wc,Wc);Hh.userData.shared=!0;const Gh=new xi(Dx,Ix);Gh.userData.shared=!0;const fu=new Nn().setFromEuler(new zt(Math.PI/2,0,0)),xr=new D,du=new D(1,1,1),vr=new Ne;function pu(i,e=_i){i.boundingSphere=new hn(new D(z/2,e*.5,z/2),Math.hypot(z,e)*.75)}function xS(i,e,t,n,s,r){const{geometry:a}=YM(e,t.wallTex,n,s,r);if(a){a.computeBoundingBox(),a.computeBoundingSphere();const o=new At(a,t.wall);o.frustumCulled=!1,i.add(o)}}function vS(i,e,t,n){const s=pl.clone();Hx(s,Po,t,n);const r=new At(s,e.floor);r.rotation.x=-Math.PI/2,r.frustumCulled=!1,i.add(r)}function MS(i,e,t,n,s){const{gapY:r,tileY:a}=OM(e),o=Wr,{tx0:l,tx1:c,tz0:u,tz1:h}=FM(n,s,z,o),f=[];for(let m=l;m<=c;m++)for(let p=u;p<=h;p++){const{x:T,z:E}=NM(m,p,n,s,o);f.push(T,E)}const d=f.length/2,g=new Ro(Gh,t.ceilingGroove,d),_=new Ro(Hh,t.ceilingTile,d);g.frustumCulled=!1,_.frustumCulled=!1,_.renderOrder=2;for(let m=0;m<d;m++){const p=f[m*2],T=f[m*2+1];xr.set(p,r,T),vr.compose(xr,fu,du),g.setMatrixAt(m,vr),xr.set(p,a,T),vr.compose(xr,fu,du),_.setMatrixAt(m,vr)}g.instanceMatrix.needsUpdate=!0,_.instanceMatrix.needsUpdate=!0,pu(g,e),pu(_,e),i.add(g),i.add(_)}function SS(i){i.traverse(e=>{var n;if(e.frustumCulled=!1,e.isInstancedMesh||!e.isMesh)return;const t=e.geometry;t&&!((n=t.userData)!=null&&n.shared)&&(t.computeBoundingBox(),t.computeBoundingSphere())})}function Vh(i,e,t=null){const n=new an;return n.position.set(i.cx*z,0,i.cz*z),{room:i,group:n,materials:e,furnitureModels:t,shellDone:!1,worldX:i.cx*z,worldZ:i.cz*z}}function Wh(i){if(i.shellDone)return;const{room:e,group:t,materials:n}=i,s=e.height;vS(t,n,i.worldX,i.worldZ),MS(t,s,n,i.worldX,i.worldZ),xS(t,e,n,s,i.worldX,i.worldZ),i.furnitureModels&&_S(t,e,i.furnitureModels),i.shellDone=!0}function yS(i,e){return i.shellDone||Wh(i),!0}function Xh(i){const{group:e,room:t}=i;return e.userData.room=t,SS(e),e.frustumCulled=!1,e}function mu(i,e,t=null){const n=Vh(i,e,t);return Wh(n),Xh(n)}const ES=["map","normalMap","roughnessMap","metalnessMap","aoMap","emissiveMap","alphaMap","bumpMap"];function gu(i){var e,t;if((e=i==null?void 0:i.userData)!=null&&e.chunkOwned){for(const n of ES){const s=i[n];(t=s==null?void 0:s.userData)!=null&&t.chunkOwned&&s.dispose()}i.dispose()}}function TS(i){var t;const e=i.geometry;if(e&&!((t=e.userData)!=null&&t.shared)&&e.dispose(),!!i.material)if(Array.isArray(i.material))for(const n of i.material)gu(n);else gu(i.material)}function _u(i){i&&i.traverse(e=>{e.isLight||(e.isMesh||e.isInstancedMesh)&&TS(e)})}const bS=2,xu=2,AS=2;class wS{constructor(e,t,n=null){this.scene=e,this.materials=t,this.furnitureModels=n,this.chunks=new Map,this.wallMap=new Map,this.colliders=[],this.collidersDirty=!1,this.time=0,this.loadQueue=[],this.pendingKeys=new Set,this.disposeQueue=[],this.despawnPending=[],this.cellCx=NaN,this.cellCz=NaN,this.lastPrefetchEdge=!1,this.preloading=!1}key(e,t){return`${e},${t}`}distToPlayer(e,t,n){const s=e*z+z/2-n.x,r=t*z+z/2-n.z;return s*s+r*r}nearPrefetchEdge(e,t,n){const s=e.x-t*z,r=e.z-n*z,a=z*ms;return s>a||s<z-a||r>a||r<z-a}ringKeys(e,t,n){const s=new Set;for(let r=t-n;r<=t+n;r++)for(let a=e-n;a<=e+n;a++)s.add(this.key(a,r));return s}computeNeed(e,t,n,s=ul){const r=this.ringKeys(e,t,s),a=n.x-e*z,o=n.z-t*z,l=s+1;if(a>z*ms)for(let c=t-s;c<=t+s;c++)r.add(this.key(e+l,c));if(a<z*(1-ms))for(let c=t-s;c<=t+s;c++)r.add(this.key(e-l,c));if(o>z*ms)for(let c=e-s;c<=e+s;c++)r.add(this.key(c,t+l));if(o<z*(1-ms))for(let c=e-s;c<=e+s;c++)r.add(this.key(c,t-l));return r}insertJob(e){const t=e.dist;let n=0,s=this.loadQueue.length;for(;n<s;){const r=n+s>>1;this.loadQueue[r].dist<t?n=r+1:s=r}this.loadQueue.splice(n,0,e)}rebuildColliderList(){const e=UM(this.wallMap);for(const t of this.chunks.values()){const n=t.furnitureColliders;n!=null&&n.length&&e.push(...n)}this.colliders=e,this.collidersDirty=!1}_markCollidersDirty(){this.collidersDirty=!0}addCollidersForRoom(e){iu(this.wallMap,e),this.rebuildColliderList()}removeCollidersForRoom(e){su(this.wallMap,e)&&this.rebuildColliderList()}addFurnitureForChunk(e){const t=e.userData.furnitureColliders||[];return this._markCollidersDirty(),{furnitureColliders:t}}removeFurnitureForChunk(e){this._markCollidersDirty()}consumeColliderRebuild(){return this.collidersDirty?(this.rebuildColliderList(),!0):!1}attachChunk(e,t,n,s){const r=this.key(e,t);Xh(s);const a=s.group,o=this.addFurnitureForChunk(a);this.chunks.set(r,{mesh:a,room:n,...o})}spawnComplete(e,t){const n=Fa(e,t);this.addCollidersForRoom(n);const s=mu(n,this.materials,this.furnitureModels),r=this.addFurnitureForChunk(s);this.scene.add(s),this.chunks.set(this.key(e,t),{mesh:s,room:n,...r})}despawn(e){const t=this.chunks.get(e);if(!t)return;const{mesh:n,room:s}=t;n&&(this.scene.remove(n),this.disposeQueue.push(n)),this.chunks.delete(e),s&&this.removeCollidersForRoom(s)}enqueue(e,t,n){const s=this.key(e,t);this.chunks.has(s)||this.pendingKeys.has(s)||(this.pendingKeys.add(s),this.insertJob({cx:e,cz:t,dist:this.distToPlayer(e,t,n),room:null,build:null}))}init(e){const t=Math.floor(e.x/z),n=Math.floor(e.z/z);this.cellCx=t,this.cellCz=n,this.lastPrefetchEdge=this.nearPrefetchEdge(e,t,n),this.spawnComplete(t,n)}update(e){if(this.preloading)return;const t=Math.floor(e.x/z),n=Math.floor(e.z/z),s=this.nearPrefetchEdge(e,t,n);if(t===this.cellCx&&n===this.cellCz&&s===this.lastPrefetchEdge&&!this.loadQueue.length&&!this.despawnPending.length)return;this.cellCx=t,this.cellCz=n,this.lastPrefetchEdge=s;const r=this.computeNeed(t,n,e),a=new Set(this.despawnPending);for(const o of this.chunks.keys()){if(r.has(o)||a.has(o))continue;const[l,c]=o.split(",").map(Number);Math.max(Math.abs(l-t),Math.abs(c-n))>Ax&&this.despawnPending.push(o)}this.loadQueue=this.loadQueue.filter(o=>{var c;const l=this.key(o.cx,o.cz);return r.has(l)?!0:(o.room&&!this.chunks.has(l)&&(su(this.wallMap,o.room),this._markCollidersDirty()),(c=o.build)!=null&&c.group&&(o.build.group.parent&&this.scene.remove(o.build.group),_u(o.build.group)),!1)});for(const o of this.pendingKeys)!r.has(o)&&!this.chunks.has(o)&&this.pendingKeys.delete(o);for(const o of r)if(!this.chunks.has(o)){const[l,c]=o.split(",").map(Number);this.enqueue(l,c,e)}}processLoadQueue(e){let t=0;for(;this.loadQueue.length&&t<AS;){const n=this.loadQueue[0],s=this.key(n.cx,n.cz);if(!n.room){n.room=Fa(n.cx,n.cz),n.build=Vh(n.room,this.materials,this.furnitureModels),this.chunks.has(s)||(iu(this.wallMap,n.room),this._markCollidersDirty());continue}n.build.shellDone||yS(n.build),n.build.group.parent||this.scene.add(n.build.group),this.attachChunk(n.cx,n.cz,n.room,n.build),this.loadQueue.shift(),this.pendingKeys.delete(s),t++}}tick(e){this.time+=e,this.disposeQueue.length&&_u(this.disposeQueue.shift());for(let t=0;t<bS&&this.despawnPending.length;t++)this.despawn(this.despawnPending.shift())}getColliders(){return this.colliders}_spawnChunkComplete(e,t){const n=this.key(e,t),s=Fa(e,t);this.addCollidersForRoom(s);const r=mu(s,this.materials,this.furnitureModels),a=this.addFurnitureForChunk(r);this.scene.add(r),this.chunks.set(n,{mesh:r,room:s,...a}),this.pendingKeys.delete(n)}_spawnChunkSafe(e,t){try{this._spawnChunkComplete(e,t)}catch(n){throw console.error(`Chunk build failed (${e}, ${t})`,n),n}}async preloadAround(e,t){const n=e.position,s=Math.floor(n.x/z),r=Math.floor(n.z/z),a=[];for(let o=r-dr;o<=r+dr;o++)for(let l=s-dr;l<=s+dr;l++)this.chunks.has(this.key(l,o))||a.push({cx:l,cz:o});a.sort((o,l)=>this.distToPlayer(o.cx,o.cz,n)-this.distToPlayer(l.cx,l.cz,n)),this.preloading=!0,this.loadQueue.length=0,this.pendingKeys.clear();try{const o=a.length;let l=0;for(let c=0;c<a.length;c+=xu){const u=Math.min(c+xu,a.length);for(let h=c;h<u;h++){const{cx:f,cz:d}=a[h];this._spawnChunkSafe(f,d),l++}t==null||t(l,o||1),await new Promise(h=>requestAnimationFrame(h))}this.rebuildColliderList(),t==null||t(o||1,o||1)}finally{this.preloading=!1}}hasPendingLoads(){return!this.preloading&&this.loadQueue.length>0}}const RS=3.2,CS=5.8,LS=9,PS=.035,DS=.018,vu=.09,Oa=_i-.1,Mu=new zt(0,0,0,"YXZ"),IS=new D(0,1,0),Vn=new D,Ba=new D,An=new D;class US{constructor(e,t){this.camera=e,this.domElement=t,this.position=new D(z/2,ki,z/2),this.yaw=0,this.pitch=0,this.keys={},this.locked=!1,this.colliders=[],this.bob=0,this.vy=0,this.grounded=!0,this.groundY=0,this.crouchBlend=0,this.onMove=null,this.onJump=null,this.onLand=null,this.onLockLost=null,this.onLockAcquired=null,this.camera.rotation.order="YXZ",this._onKeyDown=n=>{var s;n.code==="Space"&&(n.preventDefault(),this.locked&&this.grounded&&!this.crouching&&(this.vy=px,this.grounded=!1,(s=this.onJump)==null||s.call(this))),this.keys[n.code]=!0,n.code==="KeyR"&&this._unstuck()},this._onKeyUp=n=>{this.keys[n.code]=!1},this._onMouseMove=n=>{this.locked&&(this.yaw-=n.movementX*Gc,this.pitch-=n.movementY*Gc,this.pitch=fi.clamp(this.pitch,-Vc,Vc))},this._onLockChange=()=>{var s,r;const n=this.locked;this.locked=document.pointerLockElement===this.domElement,n&&!this.locked?(this._clearKeys(),(s=this.onLockLost)==null||s.call(this)):!n&&this.locked&&((r=this.onLockAcquired)==null||r.call(this))},this._onVisibility=()=>{document.hidden&&this._clearKeys()},this._onBlur=()=>{this._clearKeys()}}get crouching(){return this.locked&&!!this.keys.KeyC}_eyeHeight(){return fi.lerp(ki,ox,this.crouchBlend)}_collisionRadius(){return fi.lerp(Is,lx,this.crouchBlend)}_clearKeys(){this.keys={}}connect(){window.addEventListener("keydown",this._onKeyDown),window.addEventListener("keyup",this._onKeyUp),document.addEventListener("mousemove",this._onMouseMove),document.addEventListener("pointerlockchange",this._onLockChange),document.addEventListener("visibilitychange",this._onVisibility),window.addEventListener("blur",this._onBlur)}requestLock(){this.locked||this.domElement.requestPointerLock()}isLocked(){return this.locked}setColliders(e){this.colliders=e}_unstuck(){this.crouchBlend=0,this.position.set(z/2,ki,z/2),this.vy=0,this.grounded=!0,this.groundY=0}_feetY(){return this.position.y-this._eyeHeight()}_eyeOnSupport(e){return e+this._eyeHeight()}_horizontalProbeY(){return fi.lerp(this.position.y,this._feetY()+cx*.42,this.crouchBlend)}_overlapsXZ(e,t,n,s=this._collisionRadius()){return!(e+s<=n.minX||e-s>=n.maxX||t+s<=n.minZ||t-s>=n.maxZ)}_findSupportY(e,t,n,s,r){let a=0;const o=n+s*r,l=Is;for(const c of this.colliders){if(!c.standable||c.standTopY===void 0||!this._overlapsXZ(e,t,c,l))continue;const u=c.standTopY,h=Math.abs(n-u)<vu,f=s<=0&&o<=u+vu&&n>=u-.65;(h||f)&&(a=Math.max(a,u))}return a}_applyLook(e=0){this.camera.position.set(this.position.x,this.position.y+e,this.position.z),this.camera.up.set(0,1,0),Mu.set(this.pitch,this.yaw,0),this.camera.quaternion.setFromEuler(Mu),this.camera.updateMatrixWorld(!0)}_syncWalkFromCamera(){this.camera.getWorldDirection(Vn),Vn.y=0,Vn.lengthSq()<1e-10?Vn.set(0,0,-1):Vn.normalize(),Ba.crossVectors(Vn,IS).normalize()}_blocksHorizontal(e,t){return!(e.isCeiling||t<e.minY-.2||t>e.maxY+.2)}_insideWall(e,t){const n=this._horizontalProbeY(),s=this._collisionRadius();for(const r of this.colliders)if(this._blocksHorizontal(r,n)&&!(e+s<=r.minX||e-s>=r.maxX||t+s<=r.minZ||t-s>=r.maxZ))return!0;return!1}_pushOut(e,t){const n=this._horizontalProbeY(),s=this._collisionRadius();for(let r=0;r<14;r++){let a=!1;for(const o of this.colliders){if(!this._blocksHorizontal(o,n)||e+s<=o.minX||e-s>=o.maxX||t+s<=o.minZ||t-s>=o.maxZ)continue;const l=e+s-o.minX,c=o.maxX-(e-s),u=t+s-o.minZ,h=o.maxZ-(t-s),f=Math.min(l,c,u,h);f===l?e-=l:f===c?e+=c:f===u?t-=u:t+=h,a=!0}if(!a)break}return{px:e,pz:t}}resolvePenetration(){if(!this._insideWall(this.position.x,this.position.z))return;const e=this._pushOut(this.position.x,this.position.z);this.position.x=e.px,this.position.z=e.pz}update(e){var _,m;const t=this.crouching?1:0;this.crouchBlend+=(t-this.crouchBlend)*Math.min(1,hx*e),this._applyLook(0),this._syncWalkFromCamera(),An.set(0,0,0),(this.keys.KeyW||this.keys.ArrowUp)&&An.add(Vn),(this.keys.KeyS||this.keys.ArrowDown)&&An.sub(Vn),(this.keys.KeyA||this.keys.ArrowLeft)&&An.sub(Ba),(this.keys.KeyD||this.keys.ArrowRight)&&An.add(Ba);const n=!this.crouching&&(this.keys.ShiftLeft||this.keys.ShiftRight),s=this.crouching?ux:n?CS:RS,r=this.position.x,a=this.position.z;let o=0;if(An.lengthSq()>0){An.normalize().multiplyScalar(s*e);const p=this.position.x+An.x,T=this.position.z+An.z;if(!this._insideWall(p,T))this.position.x=p,this.position.z=T;else{const E=this._pushOut(p,T);this.position.x=E.px,this.position.z=E.pz}o=Math.hypot(this.position.x-r,this.position.z-a),this.grounded&&(this.bob+=e*LS*(this.crouching?.75:n?1.3:1))}else this.grounded&&(this.bob*=.85);o>0&&this.grounded&&((_=this.onMove)==null||_.call(this,o,n,this.crouching,s));const l=this.grounded,c=this._feetY(),u=this._findSupportY(this.position.x,this.position.z,c,this.vy,e),h=Math.min(this._eyeOnSupport(u),Oa);this.vy-=mx*e;let f=this.position.y+this.vy*e;if(f>Oa&&(f=Oa,this.vy=0),f<=h&&this.vy<=0){const p=Math.abs(this.vy),T=!l;this.position.y=h,this.vy=0,this.grounded=!0,this.groundY=u,T&&((m=this.onLand)==null||m.call(this,p))}else this.position.y=f,this.grounded=!1;this.resolvePenetration();const d=fi.lerp(PS,DS,this.crouchBlend),g=this.grounded?Math.sin(this.bob)*d:0;this._applyLook(g)}}const NS="/backroom/",FS=`${NS}assets/${encodeURIComponent("01. Government Funding.mp3")}`,OS=2,BS=2.75,zS=1.4;class kS{constructor(){this.ctx=null,this.master=null,this.sfxGain=null,this.bgmGain=null,this.bgmBuffer=null,this.bgmSource=null,this._stepAccum=0,this._bgmLoading=null}_ensure(){if(this.ctx)return!0;try{return this.ctx=new AudioContext,this.master=this.ctx.createGain(),this.master.gain.value=1,this.master.connect(this.ctx.destination),this.sfxGain=this.ctx.createGain(),this.sfxGain.gain.value=2.1,this.sfxGain.connect(this.master),!0}catch{return!1}}async preload(){return this.bgmBuffer?this.bgmBuffer:this._bgmLoading?this._bgmLoading:(this._bgmLoading=fetch(FS).then(e=>{if(!e.ok)throw new Error(`BGM load failed: ${e.status}`);return e.arrayBuffer()}).then(e=>this._ensure()?this.ctx.decodeAudioData(e):null).then(e=>(this.bgmBuffer=e,e)).catch(e=>(console.warn("[audio] background music unavailable",e),null)),this._bgmLoading)}start(){if(!this._ensure()||(this.ctx.state==="suspended"&&this.ctx.resume(),this.bgmSource))return;const e=()=>{if(!this.bgmBuffer||this.bgmSource)return;const t=this.ctx.createBufferSource();t.buffer=this.bgmBuffer,t.loop=!0,this.bgmGain=this.ctx.createGain(),this.bgmGain.gain.value=.42,t.connect(this.bgmGain),this.bgmGain.connect(this.master),t.start(),this.bgmSource=t};if(this.bgmBuffer){e();return}this.preload().then(e)}onLand(e=4){if(!this._ensure())return;this.ctx.state==="suspended"&&this.ctx.resume();const t=Math.min(1,Math.max(.3,e/7.5));this._stepAccum=0,this._playFootstep(!1,!1,{land:!0,impact:t})}onJump(){this._ensure()&&(this.ctx.state==="suspended"&&this.ctx.resume(),this._playFootstep(!1,!1,{jump:!0}))}onMove(e,t,n=!1,s=3.2){if(!this._ensure()||(this.ctx.state==="suspended"&&this.ctx.resume(),e<1e-5||s<.1))return;this._stepAccum+=e;const a=s/(n?zS:t?BS:OS);for(;this._stepAccum>=a;)this._stepAccum-=a,this._playFootstep(t,n)}_playFootstep(e,t,{jump:n=!1,land:s=!1,impact:r=1}={}){const a=this.ctx,o=a.currentTime;let l,c,u,h,f;n?(l=.065,c=.22,u=128,h=860,f=250):s?(l=.12,c=.3+r*.38,u=72+r*48,h=620,f=175):(l=t?.12:e?.075:.1,c=t?.24:e?.42:.34,u=t?88:e?118:102,h=t?480:e?1050:780,f=t?165:e?285:220);const d=a.createOscillator();d.type="sine",d.frequency.value=u+Math.random()*28;const g=a.createGain();g.gain.setValueAtTime(c*1.35,o),g.gain.exponentialRampToValueAtTime(.001,o+l),d.connect(g),g.connect(this.sfxGain),d.start(o),d.stop(o+l+.02);const _=Math.max(1,Math.floor(a.sampleRate*l)),m=a.createBuffer(1,_,a.sampleRate),p=m.getChannelData(0);for(let C=0;C<_;C++){const A=Math.pow(1-C/_,1.4);p[C]=(Math.random()*2-1)*A}const T=a.createBufferSource();T.buffer=m;const E=a.createBiquadFilter();E.type="lowpass",E.frequency.value=h,E.Q.value=.55;const M=a.createBiquadFilter();M.type="bandpass",M.frequency.value=f+Math.random()*70,M.Q.value=.65;const R=a.createGain();R.gain.setValueAtTime(c,o),R.gain.exponentialRampToValueAtTime(.001,o+l*.92),T.connect(E),E.connect(M),M.connect(R),R.connect(this.sfxGain),T.start(o),T.stop(o+l+.02)}}const HS={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
  ...
  `};function ZS(){return new ml(jS)}function JS(i,e){i.uniforms.time.value=e}function Yh(i,e,t,n=1){i.uniforms.resolution.value.set(e*n,t*n)}function gl(i){return i.getPixelRatio()*Ux}function qh(i,e,t){const n=gl(i);return new ze(1/(e*n),1/(t*n))}function QS(i,e,t){const n=window.innerWidth,s=window.innerHeight,r=gl(i),a=new qS(i);a.setPixelRatio(r),a.setSize(n,s),a.addPass(new KS(e,t));const o=new ml($S);o.material.uniforms.resolution.value.copy(qh(i,n,s)),a.addPass(o);const l=ZS();return Yh(l,n,s,r),a.addPass(l),{composer:a,fxaa:o,noise:l,render(c=0){JS(l,c),a.render()}}}function ey(i,e,t,n){const s=gl(i);i.setSize(t,n),e.composer.setPixelRatio(s),e.composer.setSize(t,n),e.fxaa.material.uniforms.resolution.value.copy(qh(i,t,n)),Yh(e.noise,t,n,s)}const ty="1.0.0",ny="7e84c43",iy="2026-06-23 00:54:24",sy="dev";function ry(){return`v${ty} · ${ny} · ${iy} · ${sy}`}const vs=document.getElementById("overlay"),ay=document.getElementById("hud"),oy=document.getElementById("vignette"),Vi=document.getElementById("crosshair"),yu=document.getElementById("build-label"),za=document.getElementById("build-badge"),Eu=document.getElementById("build-version"),wn=document.getElementById("resume-prompt"),Kh=ry();yu&&(yu.textContent=Kh);Eu&&(Eu.textContent=Kh);function ka(){if(!Vi)return;const i=Tt.domElement.getBoundingClientRect();Vi.style.left=`${i.left+i.width/2}px`,Vi.style.top=`${i.top+i.height/2}px`}const Tt=new ax({antialias:!1,powerPreference:"high-performance"});Tt.setPixelRatio(Math.min(window.devicePixelRatio,1));Tt.setSize(window.innerWidth,window.innerHeight);Tt.outputColorSpace=it;Tt.toneMapping=bu;Tt.toneMappingExposure=Nx;Tt.domElement.style.cssText="position:fixed;inset:0;z-index:1;visibility:hidden";document.body.appendChild(Tt.domElement);const qn=new Id;qn.background=new be(hh);qn.fog=new Zo(hh,Ex,Tx);const ui=new It(gx,window.innerWidth/window.innerHeight,_x,xx);ui.position.set(z/2,ki,z/2);qn.add(new fp(wx,Rx));qn.add(new rp(Cx,Lx,Px));const oi=new kS;async function ly(){const i=document.getElementById("hint-status"),e="Loading… please wait",t="Click to start";i&&(i.textContent=e),vs.style.cursor="wait";const n=new nh,s=await Qx(n),r=await Zx(n),a=await qx(n),o=ev(s,r,a),l=await $v();await oi.preload();const c=new wS(qn,o,l),u=new US(ui,Tt.domElement);u.connect();function h(){wn&&(wn.hidden=!1,wn.classList.add("visible"))}function f(){wn&&(wn.classList.remove("visible"),wn.hidden=!0)}function d(){!m||!_||u.isLocked()||u.requestLock()}u.onLockLost=()=>{_&&h()},u.onLockAcquired=f,u.onMove=(M,R,C,A)=>{_&&oi.onMove(M,R,C,A)},u.onJump=()=>{_&&oi.onJump()},u.onLand=M=>{_&&oi.onLand(M)},Tt.domElement.addEventListener("click",()=>{var M;((M=oi.ctx)==null?void 0:M.state)==="suspended"&&oi.ctx.resume()}),Tt.domElement.addEventListener("click",d),wn==null||wn.addEventListener("click",d);const g=QS(Tt,qn,ui);let _=!1,m=!1;c.preloadAround(ui,(M,R)=>{i&&!m&&(i.innerHTML=`Building nearby rooms… ${M}/${R}<br />Please wait`)}).then(()=>{u.setColliders(c.getColliders()),m=!0,Tt.domElement.style.visibility="visible",ka(),vs.style.cursor="pointer",i&&(i.textContent=t)}).catch(M=>{console.error(M),m=!0,Tt.domElement.style.visibility="visible",vs.style.cursor="pointer",i&&(i.textContent="Load error — please refresh.")}),vs.addEventListener("click",()=>{m&&(u.requestLock(),_||(_=!0,vs.classList.add("hidden"),ay.classList.add("visible"),oy.classList.add("visible"),Vi==null||Vi.classList.add("visible"),ka(),za==null||za.classList.add("visible"),oi.start()))});const p=new ih;let T=0;function E(){requestAnimationFrame(E);const M=Math.min(p.getDelta(),.05);T+=M,c.tick(M),tS(qn,T),c.preloading||(c.update(u.position),_&&c.hasPendingLoads()&&c.processLoadQueue(u.position),c.consumeColliderRebuild()&&(u.setColliders(c.getColliders()),u.resolvePenetration())),_&&u.update(M),m?g.render(T):Tt.render(qn,ui),!c.preloading&&_&&c.processLoadQueue(u.position)}E(),window.addEventListener("resize",()=>{const M=window.innerWidth,R=window.innerHeight;ui.aspect=M/R,ui.updateProjectionMatrix(),ey(Tt,g,M,R),ka()})}ly().catch(i=>{console.error(i);const e=document.getElementById("hint-status");e&&(e.textContent="Load error — please refresh.")});
