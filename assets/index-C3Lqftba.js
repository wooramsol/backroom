...
#define LOW_PRECISION`),e}function l5(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===mr?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===c2?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===tt&&(e="SHADOWMAP_TYPE_VSM"),e}function c5(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case un:case hn:e="ENVMAP_TYPE_CUBE";break;case Mi:e="ENVMAP_TYPE_CUBE_UV";break}return e}function u5(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case hn:e="ENVMAP_MODE_REFRACTION";break}return e}function h5(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case _r:e="ENVMAP_BLENDING_MULTIPLY";break;case R2:e="ENVMAP_BLENDING_MIX";break;case C2:e="ENVMAP_BLENDING_ADD";break}return e}function f5(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function d5(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=l5(t),c=c5(t),u=u5(t),h=h5(t),d=f5(t),m=e5(t),v=t5(s),M=r.createProgram();let p,f,b=t.glslVersion?"#version "+t.glslVersion+`
