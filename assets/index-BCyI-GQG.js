...
#endif`,F3="gl_FragColor = linearToOutputTexel( gl_FragColor );",O3=`vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:pt,depthTest:!1,depthWrite:!1})}function Y9(){return new gt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:r9(),fragmentShader:`
		...
		`,blending:pt,depthTest:!1,depthWrite:!1})}function K9(){return new gt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:r9(),fragmentShader:`
		...
		`,blending:pt,depthTest:!1,depthWrite:!1})}function r9(){return`
	...
	`}function Z4(i){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const l=o.mapping,c=l===f1||l===d1,u=l===un||l===hn;if(c||u){let h=e.get(o);const d=h!==void 0?h.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==d)return t===null&&(t=new X9(i)),h=c?t.fromEquirectangular(o,h):t.fromCubemap(o,h),h.texture.pmremVersion=o.pmremVersion,e.set(o,h),h.texture;if(h!==void 0)return h.texture;{const m=o.image;return c&&m&&m.height>0||u&&m&&r(m)?(t===null&&(t=new X9(i)),h=c?t.fromEquirectangular(o):t.fromCubemap(o),h.texture.pmremVersion=o.pmremVersion,e.set(o,h),o.addEventListener("dispose",s),h.texture):null}}}return o}function r(o){let l=0;const c=6;for(let u=0;u<c;u++)o[u]!==void 0&&l++;return l===c}function s(o){const l=o.target;l.removeEventListener("dispose",s);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function $4(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const r=t(n);return r===null&&an("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function j4(i,e,t,n){const r={},s=new WeakMap;function a(h){const d=h.target;d.index!==null&&e.remove(d.index);for(const v in d.attributes)e.remove(d.attributes[v]);d.removeEventListener("dispose",a),delete r[d.id];const m=s.get(d);m&&(e.remove(m),s.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function o(h,d){return r[d.id]===!0||(d.addEventListener("dispose",a),r[d.id]=!0,t.memory.geometries++),d}function l(h){const d=h.attributes;for(const m in d)e.update(d[m],i.ARRAY_BUFFER)}function c(h){const d=[],m=h.index,v=h.attributes.position;let M=0;if(m!==null){const b=m.array;M=m.version;for(let y=0,E=b.length;y<E;y+=3){const U=b[y+0],P=b[y+1],R=b[y+2];d.push(U,P,P,R,R,U)}}else if(v!==void 0){const b=v.array;M=v.version;for(let y=0,E=b.length/3-1;y<E;y+=3){const U=y+0,P=y+1,R=y+2;d.push(U,P,P,R,R,U)}}else return;const p=new(Cr(d)?Ir:Ur)(d,1);p.version=M;const f=s.get(h);f&&e.remove(f),s.set(h,p)}function u(h){const d=s.get(h);if(d){const m=h.index;m!==null&&d.version<m.version&&c(h)}else c(h);return s.get(h)}return{get:o,update:l,getWireframeAttribute:u}}function J4(i,e,t){let n;function r(d){n=d}let s,a;function o(d){s=d.type,a=d.bytesPerElement}function l(d,m){i.drawElements(n,m,s,d*a),t.update(m,n,1)}function c(d,m,v){v!==0&&(i.drawElementsInstanced(n,m,s,d*a,v),t.update(m,n,v))}function u(d,m,v){if(v===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,m,0,s,d,0,v);let p=0;for(let f=0;f<v;f++)p+=m[f];t.update(p,n,1)}function h(d,m,v,M){if(v===0)return;const p=e.get("WEBGL_multi_draw");if(p===null)for(let f=0;f<d.length;f++)c(d[f]/a,m[f],M[f]);else{p.multiDrawElementsInstancedWEBGL(n,m,0,s,d,0,M,0,v);let f=0;for(let b=0;b<v;b++)f+=m[b]*M[b];t.update(f,n,1)}}this.setMode=r,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function Q4(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(s/3);break;case i.LINES:t.lines+=o*(s/2);break;case i.LINE_STRIP:t.lines+=o*(s-1);break;case i.LINE_LOOP:t.lines+=o*s;break;case i.POINTS:t.points+=o*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function eo(i,e,t){const n=new WeakMap,r=new se;function s(a,o,l){const c=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,h=u!==void 0?u.length:0;let d=n.get(o);if(d===void 0||d.count!==h){let x=function(){I.dispose(),n.delete(o),o.removeEventListener("dispose",x)};var m=x;d!==void 0&&d.texture.dispose();const v=o.morphAttributes.position!==void 0,M=o.morphAttributes.normal!==void 0,p=o.morphAttributes.color!==void 0,f=o.morphAttributes.position||[],b=o.morphAttributes.normal||[],y=o.morphAttributes.color||[];let E=0;v===!0&&(E=1),M===!0&&(E=2),p===!0&&(E=3);let U=o.attributes.position.count*E,P=1;U>e.maxTextureSize&&(P=Math.ceil(U/e.maxTextureSize),U=e.maxTextureSize);const R=new Float32Array(U*P*4*h),I=new Pr(R,U,P,h);I.type=ke,I.needsUpdate=!0;const S=E*4;for(let C=0;C<h;C++){const k=f[C],z=b[C],K=y[C],Z=U*P*4*C;for(let X=0;X<k.count;X++){const j=X*S;v===!0&&(r.fromBufferAttribute(k,X),R[Z+j+0]=r.x,R[Z+j+1]=r.y,R[Z+j+2]=r.z,R[Z+j+3]=0),M===!0&&(r.fromBufferAttribute(z,X),R[Z+j+4]=r.x,R[Z+j+5]=r.y,R[Z+j+6]=r.z,R[Z+j+7]=0),p===!0&&(r.fromBufferAttribute(K,X),R[Z+j+8]=r.x,R[Z+j+9]=r.y,R[Z+j+10]=r.z,R[Z+j+11]=K.itemSize===4?r.w:1)}}d={count:h,texture:I,size:new $0(U,P)},n.set(o,d),o.addEventListener("dispose",x)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let v=0;for(let p=0;p<c.length;p++)v+=c[p];const M=o.morphTargetsRelative?1:1-v;l.getUniforms().setValue(i,"morphTargetBaseInfluence",M),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",d.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:s}}function to(i,e,t,n){let r=new WeakMap;function s(l){const c=n.render.frame,u=l.geometry,h=e.get(l,u);if(r.get(h)!==c&&(e.update(h),r.set(h,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),r.get(l)!==c&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),r.set(l,c))),l.isSkinnedMesh){const d=l.skeleton;r.get(d)!==c&&(d.update(),r.set(d,c))}return h}function a(){r=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:s,dispose:a}}const kr=new pe,Z9=new zr(1,1),Wr=new Pr,Xr=new Ms,qr=new Or,$9=[],j9=[],J9=new Float32Array(16),Q9=new Float32Array(9),er=new Float32Array(4);function gn(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=$9[r];if(s===void 0&&(s=new Float32Array(r),$9[r]=s),e!==0){n.toArray(s,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(s,o)}return s}function ce(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function ue(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function Ti(i,e){let t=j9[e];t===void 0&&(t=new Int32Array(e),j9[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function no(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function io(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ce(t,e))return;i.uniform2fv(this.addr,e),ue(t,e)}}function ro(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(ce(t,e))return;i.uniform3fv(this.addr,e),ue(t,e)}}function so(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ce(t,e))return;i.uniform4fv(this.addr,e),ue(t,e)}}function ao(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(ce(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),ue(t,e)}else{if(ce(t,n))return;er.set(n),i.uniformMatrix2fv(this.addr,!1,er),ue(t,n)}}function oo(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(ce(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),ue(t,e)}else{if(ce(t,n))return;Q9.set(n),i.uniformMatrix3fv(this.addr,!1,Q9),ue(t,n)}}function lo(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(ce(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),ue(t,e)}else{if(ce(t,n))return;J9.set(n),i.uniformMatrix4fv(this.addr,!1,J9),ue(t,n)}}function co(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function uo(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ce(t,e))return;i.uniform2iv(this.addr,e),ue(t,e)}}function ho(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(ce(t,e))return;i.uniform3iv(this.addr,e),ue(t,e)}}function fo(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ce(t,e))return;i.uniform4iv(this.addr,e),ue(t,e)}}function po(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function mo(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ce(t,e))return;i.uniform2uiv(this.addr,e),ue(t,e)}}function _o(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(ce(t,e))return;i.uniform3uiv(this.addr,e),ue(t,e)}}function go(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ce(t,e))return;i.uniform4uiv(this.addr,e),ue(t,e)}}function vo(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);let s;this.type===i.SAMPLER_2D_SHADOW?(Z9.compareFunction=Rr,s=Z9):s=kr,t.setTexture2D(e||s,r)}function xo(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||Xr,r)}function Mo(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||qr,r)}function So(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||Wr,r)}function Eo(i){switch(i){case 5126:return no;case 35664:return io;case 35665:return ro;case 35666:return so;case 35674:return ao;case 35675:return oo;case 35676:return lo;case 5124:case 35670:return co;case 35667:case 35671:return uo;case 35668:case 35672:return ho;case 35669:case 35673:return fo;case 5125:return po;case 36294:return mo;case 36295:return _o;case 36296:return go;case 35678:case 36198:case 36298:case 36306:case 35682:return vo;case 35679:case 36299:case 36307:return xo;case 35680:case 36300:case 36308:case 36293:return Mo;case 36289:case 36303:case 36311:case 36292:return So}}function To(i,e){i.uniform1fv(this.addr,e)}function yo(i,e){const t=gn(e,this.size,2);i.uniform2fv(this.addr,t)}function Ao(i,e){const t=gn(e,this.size,3);i.uniform3fv(this.addr,t)}function bo(i,e){const t=gn(e,this.size,4);i.uniform4fv(this.addr,t)}function wo(i,e){const t=gn(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function Ro(i,e){const t=gn(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function Co(i,e){const t=gn(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function Po(i,e){i.uniform1iv(this.addr,e)}function Lo(i,e){i.uniform2iv(this.addr,e)}function Do(i,e){i.uniform3iv(this.addr,e)}function Uo(i,e){i.uniform4iv(this.addr,e)}function Io(i,e){i.uniform1uiv(this.addr,e)}function No(i,e){i.uniform2uiv(this.addr,e)}function Fo(i,e){i.uniform3uiv(this.addr,e)}function Oo(i,e){i.uniform4uiv(this.addr,e)}function Bo(i,e,t){const n=this.cache,r=e.length,s=Ti(t,r);ce(n,s)||(i.uniform1iv(this.addr,s),ue(n,s));for(let a=0;a!==r;++a)t.setTexture2D(e[a]||kr,s[a])}function zo(i,e,t){const n=this.cache,r=e.length,s=Ti(t,r);ce(n,s)||(i.uniform1iv(this.addr,s),ue(n,s));for(let a=0;a!==r;++a)t.setTexture3D(e[a]||Xr,s[a])}function Ho(i,e,t){const n=this.cache,r=e.length,s=Ti(t,r);ce(n,s)||(i.uniform1iv(this.addr,s),ue(n,s));for(let a=0;a!==r;++a)t.setTextureCube(e[a]||qr,s[a])}function Vo(i,e,t){const n=this.cache,r=e.length,s=Ti(t,r);ce(n,s)||(i.uniform1iv(this.addr,s),ue(n,s));for(let a=0;a!==r;++a)t.setTexture2DArray(e[a]||Wr,s[a])}function Go(i){switch(i){case 5126:return To;case 35664:return yo;case 35665:return Ao;case 35666:return bo;case 35674:return wo;case 35675:return Ro;case 35676:return Co;case 5124:case 35670:return Po;case 35667:case 35671:return Lo;case 35668:case 35672:return Do;case 35669:case 35673:return Uo;case 5125:return Io;case 36294:return No;case 36295:return Fo;case 36296:return Oo;case 35678:case 36198:case 36298:case 36306:case 35682:return Bo;case 35679:case 36299:case 36307:return zo;case 35680:case 36300:case 36308:case 36293:return Ho;case 36289:case 36303:case 36311:case 36292:return Vo}}class ko{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Eo(t.type)}}class Wo{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Go(t.type)}}class Xo{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(e,t[o.id],n)}}}const e1=/(\w+)(\])?(\[|\.)?/g;function tr(i,e){i.seq.push(e),i.map[e.id]=e}function qo(i,e,t){const n=i.name,r=n.length;for(e1.lastIndex=0;;){const s=e1.exec(n),a=e1.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===r){tr(t,c===void 0?new ko(o,i,e):new Wo(o,i,e));break}else{let h=t.map[o];h===void 0&&(h=new Xo(o),tr(t,h)),t=h}}}class _i{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=e.getActiveUniform(t,r),a=e.getUniformLocation(t,s.name);qo(s,a,this)}}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,a=t.length;s!==a;++s){const o=t[s],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const a=e[r];a.id in t&&n.push(a)}return n}}function nr(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const Yo=37297;let Ko=0;function Zo(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let a=r;a<s;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const ir=new U0;function $o(i){G0._getMatrix(ir,G0.workingColorSpace,i);const e=`mat3( ${ir.elements.map(t=>t.toFixed(4))} )`;switch(G0.getTransfer(i)){case vi:return[e,"LinearTransferOETF"];case Z0:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function rr(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=i.getShaderInfoLog(e).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const a=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+Zo(i.getShaderSource(e),a)}else return r}function jo(i,e){const t=$o(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function Jo(i,e){let t;switch(e){case L2:t="Linear";break;case D2:t="Reinhard";break;case U2:t="Cineon";break;case vr:t="ACESFilmic";break;case N2:t="AgX";break;case F2:t="Neutral";break;case I2:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const li=new F;function Qo(){G0.getLuminanceCoefficients(li);const i=li.x.toFixed(4),e=li.y.toFixed(4),t=li.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function e5(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(yn).join(`
`)}function t5(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function n5(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),a=s.name;let o=1;s.type===i.FLOAT_MAT2&&(o=2),s.type===i.FLOAT_MAT3&&(o=3),s.type===i.FLOAT_MAT4&&(o=4),t[a]={type:s.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function yn(i){return i!==""}function sr(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function ar(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const i5=/^[ \t]*#include +<([\w\d./]+)>/gm;function V1(i){return i.replace(i5,s5)}const r5=new Map;function s5(i,e){let t=N0[e];if(t===void 0){const n=r5.get(e);if(n!==void 0)t=N0[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return V1(t)}const a5=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function or(i){return i.replace(a5,o5)}function o5(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function lr(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function l5(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===_r?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===u2?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===tt&&(e="SHADOWMAP_TYPE_VSM"),e}function c5(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case un:case hn:e="ENVMAP_TYPE_CUBE";break;case Ei:e="ENVMAP_TYPE_CUBE_UV";break}return e}function u5(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case hn:e="ENVMAP_MODE_REFRACTION";break}return e}function h5(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case gr:e="ENVMAP_BLENDING_MULTIPLY";break;case C2:e="ENVMAP_BLENDING_MIX";break;case P2:e="ENVMAP_BLENDING_ADD";break}return e}function f5(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function d5(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=l5(t),c=c5(t),u=u5(t),h=h5(t),d=f5(t),m=e5(t),v=t5(s),M=r.createProgram();let p,f,b=t.glslVersion?"#version "+t.glslVersion+`
