...
`)+`
`+p);const y=T+m+o,v=T+p+a,R=Nc(s,s.VERTEX_SHADER,y),C=Nc(s,s.FRAGMENT_SHADER,v);s.attachShader(_,R),s.attachShader(_,C),t.index0AttributeName!==void 0?s.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function A(P){if(i.debug.checkShaderErrors){const W=s.getProgramInfoLog(_).trim(),z=s.getShaderInfoLog(R).trim(),$=s.getShaderInfoLog(C).trim();let j=!0,Y=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(j=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,_,R,C);else{const J=Oc(s,R,"vertex"),H=Oc(s,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      ${e}`))}function nS(i){var s,r;const e=Wh(),t=i.map||null;t&&(t.colorSpace=it);const n=new ih({map:t,color:((r=(s=i.color)==null?void 0:s.clone)==null?void 0:r.call(s))??new be(12564640),emissiveMap:e,emissive:new be(13421772),emissiveIntensity:.65});return n.userData.chunkOwned=!0,n.userData.chairGlitch=!0,n.onBeforeCompile=o=>{o.uniforms.uGlitchTime={value:0},o.uniforms.uGlitchAmp={value:1},n.userData.glitchUniforms=o.uniforms,o.vertexShader=o.vertexShader.replace("#include <common>",`#include <common>
      ...
      uniform float uGlitchTime;`),tS(o)},n}function iS(i){i.userData.chairGlitch=!0,i.traverse(e=>{if(!e.isMesh||!e.material)return;const n=(Array.isArray(e.material)?e.material:[e.material]).map(s=>nS(s));e.material=n.length===1?n[0]:n})}function sS(i){var t,n;let e=i;for(;e;){if(((t=e.userData)==null?void 0:t.furnitureId)==="chairGlb")return!0;if((n=e.userData)!=null&&n.furnitureId)return!1;e=e.parent}return!1}function rS(i,e){(Math.floor(e*60)&1)===0&&eS();const n=(Math.random()<.11?2.2:1)*(1+Math.sin(e*61)*.3+Math.random()*.55);i.traverse(s=>{var o,a;if(!((o=s.isMesh)!=null&&o.material)||!sS(s))return;const r=Array.isArray(s.material)?s.material:[s.material];for(const l of r){if(!((a=l.userData)!=null&&a.chairGlitch))continue;const c=l.userData.glitchUniforms;c&&(c.uGlitchTime.value=e,c.uGlitchAmp.value=n),l.emissiveIntensity=.5+Math.random()*.95}})}const ci=new Vt;function oS(i,e,t){e.updateMatrixWorld(!0),ci.setFromObject(i);const n={minX:ci.min.x,maxX:ci.max.x,minZ:ci.min.z,maxZ:ci.max.z,topY:ci.max.y,bottomY:ci.min.y};return t.push(n),n}function aS(i,e,t,n){let s=0;const r=Math.max(.22,t*.38);for(const o of n)i+r>o.minX&&i-r<o.maxX&&e+r>o.minZ&&e-r<o.maxZ&&(s=Math.max(s,o.topY));return s}const Gr=new Vt,pu=new kt,lS=[["floor_normal",28],["floor_tipped",18],["wall_lean",24],["wall_embedded",14],["ceiling_stuck",10],["floor_embedded",6]],cS=[["floor_normal",38],["floor_tipped",32],["floor_embedded",18],["wall_lean",12]],uS=[["floor_normal",32],["floor_tipped",28],["floor_embedded",14],["ceiling_stuck",10]],hS=[["floor_normal",38],["floor_tipped",32],["floor_embedded",18],["ceiling_stuck",12]];function Fi(i,e,t){e.updateMatrixWorld(!0),Gr.setFromObject(i),i.position.y+=t-Gr.min.y}function fS(i,e,t){e.updateMatrixWorld(!0),Gr.setFromObject(i),i.position.y+=t-Gr.max.y}function Ha(i,e,t=.55,n=48){for(let s=0;s<n;s++){const r=e.range(t,k-t),o=e.range(t,k-t);if(mi(r,o,i))return{x:r,z:o}}return null}function dS(i){const e=St*.5+.04,t=.8,n=[{axis:"z",pos:e,span0:t,span1:k-t},{axis:"z",pos:k-e,span0:t,span1:k-t},{axis:"x",pos:e,span0:t,span1:k-t},{axis:"x",pos:k-e,span0:t,span1:k-t}];return[...i,...n]}function pS(i,e,t){if(i.axis==="z"){const r=mi(e,i.pos+.55,t),o=mi(e,i.pos-.55,t);return r&&!o?.55:o&&!r?-.55:r?.55:-.55}const n=mi(i.pos+.55,e,t),s=mi(i.pos-.55,e,t);return n&&!s?.55:s&&!n?-.55:n?.55:-.55}function mS(i,e,t,n){const s=[...i];for(let r=s.length-1;r>0;r--){const o=n.int(0,r);[s[r],s[o]]=[s[o],s[r]]}for(let r=0;r<24;r++){const o=s[r%s.length],a=n.range(o.span0+t*.5,o.span1-t*.5),l=pS(o,a,e),c=o.axis==="z"?a:o.pos+l,u=o.axis==="z"?o.pos+l:a;if(!mi(c,u,e))continue;const h=o.axis==="z"?l>0?0:Math.PI:l>0?-Math.PI/2:Math.PI/2;return{x:c,z:u,yaw:h,wall:o,offset:l}}return null}function gS(i,e,t,n,s,r){const{height:o,depth:a}=s,l=t.supportY??0;switch(i.rotation.set(0,0,0),i.position.set(t.x,0,t.z),e){case"floor_normal":i.rotation.y=t.yaw??n.range(0,Math.PI*2),Fi(i,r,l);break;case"floor_tipped":i.rotation.y=n.range(0,Math.PI*2),pu.set(n.range(1.1,1.65),i.rotation.y,n.range(-.35,.35)),i.setRotationFromEuler(pu),Fi(i,r,l+n.range(-.01,.02));break;case"wall_lean":{const c=n.range(.22,.48);i.rotation.y=t.yaw+n.range(-.2,.2),(t.wall.axis==="z"?"x":"z")==="x"?i.rotation.x=t.offset>0?-c:c:i.rotation.z=t.offset>0?c:-c;const h=a*n.range(.22,.42);t.wall.axis==="z"?i.position.z-=Math.sign(t.offset)*h:i.position.x-=Math.sign(t.offset)*h,Fi(i,r,l);break}case"wall_embedded":{i.rotation.y=t.yaw+n.range(-.15,.15);const c=a*n.range(.42,.72);t.wall.axis==="z"?i.position.z-=Math.sign(t.offset)*c:i.position.x-=Math.sign(t.offset)*c,i.rotation.x=n.range(-.12,.12),Fi(i,r,l+n.range(-.03,.05));break}case"ceiling_stuck":i.rotation.y=n.range(0,Math.PI*2),i.rotation.x=Math.PI+n.range(-.22,.22),i.rotation.z=n.range(-.18,.18),fS(i,r,xi-.006+n.range(0,o*.22));break;case"floor_embedded":i.rotation.y=n.range(0,Math.PI*2),i.rotation.z=n.range(-.18,.18),Fi(i,r,l-o*n.range(.15,.35));break;default:i.rotation.y=n.range(0,Math.PI*2),Fi(i,r,l)}}function _S(i,e=!1,t=!1){return t?i.pickWeighted(e?hS:uS):i.pickWeighted(e?cS:lS)}function xS(i,e,t){for(const n of e){const[s,r]=n.split(",").map(Number),o=i.x-s,a=i.z-r;if(o*o+a*a<t*t)return!0}return!1}function vS(i,e,t,n,s,r,o){e.userData.chunkOwned=!0,i.add(e),n.push(QM(e,i)),t.furnitureId==="chairGlb"&&iS(e),oS(e,i,o),s.add(`${r.x.toFixed(2)},${r.z.toFixed(2)}`)}function Xh(i,e,t,n,s,r,o,a={}){if(!t)return!1;const l=eM(t),c=l.userData;c.furnitureKind=a.kind||(c.isPile?"pile":"chair");const u=_S(n,a.pileMode,!!a.spot);let h=null;if(a.spot)h={...a.spot,yaw:a.spot.yaw??n.range(0,Math.PI*2)};else if(u==="floor_normal"||u==="floor_tipped"||u==="floor_embedded"){const d=Ha(e.innerWalls,n,c.footprint*.45);if(!d)return!1;h={...d,yaw:n.range(0,Math.PI*2)}}else if(u==="ceiling_stuck"){const d=Ha(e.innerWalls,n,c.footprint*.4);if(!d)return!1;h={...d}}else{const d=dS(e.innerWalls);if(h=mS(d,e.innerWalls,c.footprint,n),!h)return!1}h.supportY=aS(h.x,h.z,c.footprint,o);const f=a.minSep??c.footprint*.72;return xS(h,s,f)?!1:(gS(l,u,h,n,c,i),vS(i,l,c,r,s,h,o),!0)}function mu(i,e,t,n,s,r,o){const a=Lh(t,n);return Xh(i,e,a,n,s,r,o,{kind:"prop"})}function MS(i,e,t,n,s,r,o){const a=Ha(e.innerWalls,n,1.2,72);if(!a)return 0;const l=n.int(2,14),c=n.range(.55,1.35);let u=0;for(let h=0;h<l*5&&u<l;h++){const f=n.range(0,Math.PI*2),d=n.range(.02,c)*Math.sqrt(n.range(.15,1)),g={x:a.x+Math.cos(f)*d,z:a.z+Math.sin(f)*d,yaw:n.range(0,Math.PI*2)};if(g.x<.45||g.x>k-.45||g.z<.45||g.z>k-.45||!mi(g.x,g.z,e.innerWalls))continue;const _=Lh(t,n);Xh(i,e,_,n,s,r,o,{spot:g,pileMode:!0,minSep:.26,kind:"pile"})&&u++}return u}function SS(i,e,t){var u;if(!((u=t==null?void 0:t.allProps)!=null&&u.length))return{colliders:[]};const n=[],s=[],r=Fs(e.cx,e.cz,881);if(!r.chance(.5))return i.userData.furnitureColliders=n,{colliders:n};const o=new Set;let a=0;r.chance(.3)&&(a+=MS(i,e,t,r,o,n,s));const l=a>0?r.int(0,2):r.int(1,2);let c=0;for(let h=0;h<l*6&&c<l;h++)mu(i,e,t,r,o,n,s)&&c++;if(a+=c,a===0)for(let h=0;h<4&&!mu(i,e,t,r,o,n,s);h++);return i.userData.furnitureColliders=n,{colliders:n}}const _l=new vi(k,k);_l.translate(k/2,k/2,0);_l.userData.shared=!0;const Yh=new vi(Kc,Kc);Yh.userData.shared=!0;const qh=new vi(Fx,Ox);qh.userData.shared=!0;const gu=new Bn().setFromEuler(new kt(Math.PI/2,0,0)),Sr=new D,_u=new D(1,1,1),yr=new Ne;function xu(i,e=xi){i.boundingSphere=new pn(new D(k/2,e*.5,k/2),Math.hypot(k,e)*.75)}function yS(i,e,t,n,s,r){const{geometry:o}=jM(e,t.wallTex,n,s,r);if(o){o.computeBoundingBox(),o.computeBoundingSphere();const a=new At(o,t.wall);a.frustumCulled=!1,i.add(a)}}function ES(i,e,t,n){const s=_l.clone();Xx(s,Ua,t,n);const r=new At(s,e.floor);r.rotation.x=-Math.PI/2,r.frustumCulled=!1,i.add(r)}function TS(i,e,t,n,s){const{gapY:r,tileY:o}=HM(e),a=Kr,{tx0:l,tx1:c,tz0:u,tz1:h}=zM(n,s,k,a),f=[];for(let m=l;m<=c;m++)for(let p=u;p<=h;p++){const{x:T,z:y}=kM(m,p,n,s,a);f.push(T,y)}const d=f.length/2,g=new Pa(qh,t.ceilingGroove,d),_=new Pa(Yh,t.ceilingTile,d);g.frustumCulled=!1,_.frustumCulled=!1,_.renderOrder=2;for(let m=0;m<d;m++){const p=f[m*2],T=f[m*2+1];Sr.set(p,r,T),yr.compose(Sr,gu,_u),g.setMatrixAt(m,yr),Sr.set(p,o,T),yr.compose(Sr,gu,_u),_.setMatrixAt(m,yr)}g.instanceMatrix.needsUpdate=!0,_.instanceMatrix.needsUpdate=!0,xu(g,e),xu(_,e),i.add(g),i.add(_)}function bS(i){i.traverse(e=>{var n;if(e.frustumCulled=!1,e.isInstancedMesh||!e.isMesh)return;const t=e.geometry;t&&!((n=t.userData)!=null&&n.shared)&&(t.computeBoundingBox(),t.computeBoundingSphere())})}function Kh(i,e,t=null){const n=new cn;return n.position.set(i.cx*k,0,i.cz*k),{room:i,group:n,materials:e,furnitureModels:t,shellDone:!1,worldX:i.cx*k,worldZ:i.cz*k}}function $h(i){if(i.shellDone)return;const{room:e,group:t,materials:n}=i,s=e.height;ES(t,n,i.worldX,i.worldZ),TS(t,s,n,i.worldX,i.worldZ),yS(t,e,n,s,i.worldX,i.worldZ),i.furnitureModels&&SS(t,e,i.furnitureModels),i.shellDone=!0}function AS(i,e){return i.shellDone||$h(i),!0}function jh(i){const{group:e,room:t}=i;return e.userData.room=t,bS(e),e.frustumCulled=!1,e}function vu(i,e,t=null){const n=Kh(i,e,t);return $h(n),jh(n)}const wS=["map","normalMap","roughnessMap","metalnessMap","aoMap","emissiveMap","alphaMap","bumpMap"];function Mu(i){var e,t;if((e=i==null?void 0:i.userData)!=null&&e.chunkOwned){for(const n of wS){const s=i[n];(t=s==null?void 0:s.userData)!=null&&t.chunkOwned&&s.dispose()}i.dispose()}}function RS(i){var t;const e=i.geometry;if(e&&!((t=e.userData)!=null&&t.shared)&&e.dispose(),!!i.material)if(Array.isArray(i.material))for(const n of i.material)Mu(n);else Mu(i.material)}function Su(i){i&&i.traverse(e=>{e.isLight||(e.isMesh||e.isInstancedMesh)&&RS(e)})}const CS=2,yu=2,LS=2;class PS{constructor(e,t,n=null){this.scene=e,this.materials=t,this.furnitureModels=n,this.chunks=new Map,this.wallMap=new Map,this.colliders=[],this.collidersDirty=!1,this.time=0,this.loadQueue=[],this.pendingKeys=new Set,this.disposeQueue=[],this.despawnPending=[],this.cellCx=NaN,this.cellCz=NaN,this.lastPrefetchEdge=!1,this.preloading=!1}key(e,t){return`${e},${t}`}distToPlayer(e,t,n){const s=e*k+k/2-n.x,r=t*k+k/2-n.z;return s*s+r*r}nearPrefetchEdge(e,t,n){const s=e.x-t*k,r=e.z-n*k,o=k*xs;return s>o||s<k-o||r>o||r<k-o}ringKeys(e,t,n){const s=new Set;for(let r=t-n;r<=t+n;r++)for(let o=e-n;o<=e+n;o++)s.add(this.key(o,r));return s}computeNeed(e,t,n,s=dl){const r=this.ringKeys(e,t,s),o=n.x-e*k,a=n.z-t*k,l=s+1;if(o>k*xs)for(let c=t-s;c<=t+s;c++)r.add(this.key(e+l,c));if(o<k*(1-xs))for(let c=t-s;c<=t+s;c++)r.add(this.key(e-l,c));if(a>k*xs)for(let c=e-s;c<=e+s;c++)r.add(this.key(c,t+l));if(a<k*(1-xs))for(let c=e-s;c<=e+s;c++)r.add(this.key(c,t-l));return r}insertJob(e){const t=e.dist;let n=0,s=this.loadQueue.length;for(;n<s;){const r=n+s>>1;this.loadQueue[r].dist<t?n=r+1:s=r}this.loadQueue.splice(n,0,e)}rebuildColliderList(){const e=BM(this.wallMap);for(const t of this.chunks.values()){const n=t.furnitureColliders;n!=null&&n.length&&e.push(...n)}this.colliders=e,this.collidersDirty=!1}_markCollidersDirty(){this.collidersDirty=!0}addCollidersForRoom(e){au(this.wallMap,e),this.rebuildColliderList()}removeCollidersForRoom(e){lu(this.wallMap,e)&&this.rebuildColliderList()}addFurnitureForChunk(e){const t=e.userData.furnitureColliders||[];return this._markCollidersDirty(),{furnitureColliders:t}}removeFurnitureForChunk(e){this._markCollidersDirty()}consumeColliderRebuild(){return this.collidersDirty?(this.rebuildColliderList(),!0):!1}attachChunk(e,t,n,s){const r=this.key(e,t);jh(s);const o=s.group,a=this.addFurnitureForChunk(o);this.chunks.set(r,{mesh:o,room:n,...a})}spawnComplete(e,t){const n=Ho(e,t);this.addCollidersForRoom(n);const s=vu(n,this.materials,this.furnitureModels),r=this.addFurnitureForChunk(s);this.scene.add(s),this.chunks.set(this.key(e,t),{mesh:s,room:n,...r})}despawn(e){const t=this.chunks.get(e);if(!t)return;const{mesh:n,room:s}=t;n&&(this.scene.remove(n),this.disposeQueue.push(n)),this.chunks.delete(e),s&&this.removeCollidersForRoom(s)}enqueue(e,t,n){const s=this.key(e,t);this.chunks.has(s)||this.pendingKeys.has(s)||(this.pendingKeys.add(s),this.insertJob({cx:e,cz:t,dist:this.distToPlayer(e,t,n),room:null,build:null}))}init(e){const t=Math.floor(e.x/k),n=Math.floor(e.z/k);this.cellCx=t,this.cellCz=n,this.lastPrefetchEdge=this.nearPrefetchEdge(e,t,n),this.spawnComplete(t,n)}update(e){if(this.preloading)return;const t=Math.floor(e.x/k),n=Math.floor(e.z/k),s=this.nearPrefetchEdge(e,t,n);if(t===this.cellCx&&n===this.cellCz&&s===this.lastPrefetchEdge&&!this.loadQueue.length&&!this.despawnPending.length)return;this.cellCx=t,this.cellCz=n,this.lastPrefetchEdge=s;const r=this.computeNeed(t,n,e),o=new Set(this.despawnPending);for(const a of this.chunks.keys()){if(r.has(a)||o.has(a))continue;const[l,c]=a.split(",").map(Number);Math.max(Math.abs(l-t),Math.abs(c-n))>Lx&&this.despawnPending.push(a)}this.loadQueue=this.loadQueue.filter(a=>{var c;const l=this.key(a.cx,a.cz);return r.has(l)?!0:(a.room&&!this.chunks.has(l)&&(lu(this.wallMap,a.room),this._markCollidersDirty()),(c=a.build)!=null&&c.group&&(a.build.group.parent&&this.scene.remove(a.build.group),Su(a.build.group)),!1)});for(const a of this.pendingKeys)!r.has(a)&&!this.chunks.has(a)&&this.pendingKeys.delete(a);for(const a of r)if(!this.chunks.has(a)){const[l,c]=a.split(",").map(Number);this.enqueue(l,c,e)}}processLoadQueue(e){let t=0;for(;this.loadQueue.length&&t<LS;){const n=this.loadQueue[0],s=this.key(n.cx,n.cz);if(!n.room){n.room=Ho(n.cx,n.cz),n.build=Kh(n.room,this.materials,this.furnitureModels),this.chunks.has(s)||(au(this.wallMap,n.room),this._markCollidersDirty());continue}n.build.shellDone||AS(n.build),n.build.group.parent||this.scene.add(n.build.group),this.attachChunk(n.cx,n.cz,n.room,n.build),this.loadQueue.shift(),this.pendingKeys.delete(s),t++}}tick(e){this.time+=e,this.disposeQueue.length&&Su(this.disposeQueue.shift());for(let t=0;t<CS&&this.despawnPending.length;t++)this.despawn(this.despawnPending.shift())}getColliders(){return this.colliders}_spawnChunkComplete(e,t){const n=this.key(e,t),s=Ho(e,t);this.addCollidersForRoom(s);const r=vu(s,this.materials,this.furnitureModels),o=this.addFurnitureForChunk(r);this.scene.add(r),this.chunks.set(n,{mesh:r,room:s,...o}),this.pendingKeys.delete(n)}_spawnChunkSafe(e,t){try{this._spawnChunkComplete(e,t)}catch(n){throw console.error(`Chunk build failed (${e}, ${t})`,n),n}}async preloadAround(e,t){const n=e.position,s=Math.floor(n.x/k),r=Math.floor(n.z/k),o=[];for(let a=r-gr;a<=r+gr;a++)for(let l=s-gr;l<=s+gr;l++)this.chunks.has(this.key(l,a))||o.push({cx:l,cz:a});o.sort((a,l)=>this.distToPlayer(a.cx,a.cz,n)-this.distToPlayer(l.cx,l.cz,n)),this.preloading=!0,this.loadQueue.length=0,this.pendingKeys.clear();try{const a=o.length;let l=0;for(let c=0;c<o.length;c+=yu){const u=Math.min(c+yu,o.length);for(let h=c;h<u;h++){const{cx:f,cz:d}=o[h];this._spawnChunkSafe(f,d),l++}t==null||t(l,a||1),await new Promise(h=>requestAnimationFrame(h))}this.rebuildColliderList(),t==null||t(a||1,a||1)}finally{this.preloading=!1}}hasPendingLoads(){return!this.preloading&&this.loadQueue.length>0}}const DS=3.2,IS=5.8,US=9,NS=.035,FS=.018,Eu=.09,Go=xi-.1,Tu=new kt(0,0,0,"YXZ"),OS=new D(0,1,0),Cn=new D,Er=new D,tn=new D;class BS{constructor(e,t){this.camera=e,this.domElement=t,this.position=new D(k/2,Vi,k/2),this.yaw=0,this.pitch=0,this.keys={},this.locked=!1,this.mobileMode=!1,this.mobileActive=!1,this.mobileMove={x:0,y:0},this.mobileControls=null,this.colliders=[],this.bob=0,this.vy=0,this.grounded=!0,this.groundY=0,this.crouchBlend=0,this.onMove=null,this.onJump=null,this.onLand=null,this.onLockLost=null,this.onLockAcquired=null,this.camera.rotation.order="YXZ",this._onKeyDown=n=>{var s;n.code==="Space"&&(n.preventDefault(),this.locked&&this.grounded&&!this.crouching&&(this.vy=Xc,this.grounded=!1,(s=this.onJump)==null||s.call(this))),this.keys[n.code]=!0,n.code==="KeyR"&&this._unstuck()},this._onKeyUp=n=>{this.keys[n.code]=!1},this._onMouseMove=n=>{this.locked&&(this.yaw-=n.movementX*Yc,this.pitch-=n.movementY*Yc,this.pitch=Yn.clamp(this.pitch,-mr,mr))},this._onLockChange=()=>{var s,r;const n=this.locked;this.locked=document.pointerLockElement===this.domElement,n&&!this.locked?(this._clearKeys(),(s=this.onLockLost)==null||s.call(this)):!n&&this.locked&&((r=this.onLockAcquired)==null||r.call(this))},this._onVisibility=()=>{document.hidden&&this._clearKeys()},this._onBlur=()=>{this._clearKeys()}}get crouching(){return this.inputActive&&!!this.keys.KeyC}get inputActive(){return this.locked||this.mobileMode&&this.mobileActive}_eyeHeight(){return Yn.lerp(Vi,fx,this.crouchBlend)}_collisionRadius(){return Yn.lerp(Ns,dx,this.crouchBlend)}_clearKeys(){this.keys={}}connect(){window.addEventListener("keydown",this._onKeyDown),window.addEventListener("keyup",this._onKeyUp),document.addEventListener("mousemove",this._onMouseMove),document.addEventListener("pointerlockchange",this._onLockChange),document.addEventListener("visibilitychange",this._onVisibility),window.addEventListener("blur",this._onBlur)}setMobileMode(e,t=null){this.mobileMode=e,this.mobileControls=t}startMobile(){var e;this.mobileActive=!0,(e=this.onLockAcquired)==null||e.call(this)}requestLock(){this.mobileMode||this.locked||this.domElement.requestPointerLock()}isLocked(){return this.locked}setColliders(e){this.colliders=e}_unstuck(){this.crouchBlend=0,this.position.set(k/2,Vi,k/2),this.vy=0,this.grounded=!0,this.groundY=0}_feetY(){return this.position.y-this._eyeHeight()}_eyeOnSupport(e){return e+this._eyeHeight()}_horizontalProbeY(){return Yn.lerp(this.position.y,this._feetY()+px*.42,this.crouchBlend)}_overlapsXZ(e,t,n,s=this._collisionRadius()){return!(e+s<=n.minX||e-s>=n.maxX||t+s<=n.minZ||t-s>=n.maxZ)}_findSupportY(e,t,n,s,r){let o=0;const a=n+s*r,l=Ns;for(const c of this.colliders){if(!c.standable||c.standTopY===void 0||!this._overlapsXZ(e,t,c,l))continue;const u=c.standTopY,h=Math.abs(n-u)<Eu,f=s<=0&&a<=u+Eu&&n>=u-.65;(h||f)&&(o=Math.max(o,u))}return o}_applyLook(e=0){this.camera.position.set(this.position.x,this.position.y+e,this.position.z),this.camera.up.set(0,1,0),Tu.set(this.pitch,this.yaw,0),this.camera.quaternion.setFromEuler(Tu),this.camera.updateMatrixWorld(!0)}_syncWalkFromCamera(){this.camera.getWorldDirection(Cn),Cn.y=0,Cn.lengthSq()<1e-10?Cn.set(0,0,-1):Cn.normalize(),Er.crossVectors(Cn,OS).normalize()}_blocksHorizontal(e,t){return!(e.isCeiling||t<e.minY-.2||t>e.maxY+.2)}_insideWall(e,t){const n=this._horizontalProbeY(),s=this._collisionRadius();for(const r of this.colliders)if(this._blocksHorizontal(r,n)&&!(e+s<=r.minX||e-s>=r.maxX||t+s<=r.minZ||t-s>=r.maxZ))return!0;return!1}_pushOut(e,t){const n=this._horizontalProbeY(),s=this._collisionRadius();for(let r=0;r<14;r++){let o=!1;for(const a of this.colliders){if(!this._blocksHorizontal(a,n)||e+s<=a.minX||e-s>=a.maxX||t+s<=a.minZ||t-s>=a.maxZ)continue;const l=e+s-a.minX,c=a.maxX-(e-s),u=t+s-a.minZ,h=a.maxZ-(t-s),f=Math.min(l,c,u,h);f===l?e-=l:f===c?e+=c:f===u?t-=u:t+=h,o=!0}if(!o)break}return{px:e,pz:t}}resolvePenetration(){if(!this._insideWall(this.position.x,this.position.z))return;const e=this._pushOut(this.position.x,this.position.z);this.position.x=e.px,this.position.z=e.pz}_applyMobileLook(){if(!this.mobileMode||!this.mobileActive||!this.mobileControls)return;const{dx:e,dy:t}=this.mobileControls.consumeLook();e===0&&t===0||(this.yaw-=e*qc,this.pitch-=t*qc,this.pitch=Yn.clamp(this.pitch,-mr,mr))}_tryMobileJump(){var e;!this.mobileMode||!this.mobileActive||!this.mobileControls||this.mobileControls.consumeJump()&&this.grounded&&!this.crouching&&(this.vy=Xc,this.grounded=!1,(e=this.onJump)==null||e.call(this))}update(e){var m,p,T;if(!this.inputActive)return;this._applyMobileLook(),this._tryMobileJump();const t=this.crouching?1:0;if(this.crouchBlend+=(t-this.crouchBlend)*Math.min(1,gx*e),this._applyLook(0),this._syncWalkFromCamera(),tn.set(0,0,0),this.mobileMode&&this.mobileActive){const{x:y,y:v}=((m=this.mobileControls)==null?void 0:m.move)??this.mobileMove;tn.addScaledVector(Cn,-v),tn.addScaledVector(Er,y)}else(this.keys.KeyW||this.keys.ArrowUp)&&tn.add(Cn),(this.keys.KeyS||this.keys.ArrowDown)&&tn.sub(Cn),(this.keys.KeyA||this.keys.ArrowLeft)&&tn.sub(Er),(this.keys.KeyD||this.keys.ArrowRight)&&tn.add(Er);const n=this.keys.ShiftLeft||this.keys.ShiftRight,s=!this.crouching&&n,r=this.crouching?mx:s?IS:DS,o=this.position.x,a=this.position.z;let l=0;if(tn.lengthSq()>0){tn.normalize().multiplyScalar(r*e);const y=this.position.x+tn.x,v=this.position.z+tn.z;if(!this._insideWall(y,v))this.position.x=y,this.position.z=v;else{const R=this._pushOut(y,v);this.position.x=R.px,this.position.z=R.pz}l=Math.hypot(this.position.x-o,this.position.z-a),this.grounded&&(this.bob+=e*US*(this.crouching?.75:s?1.3:1))}else this.grounded&&(this.bob*=.85);l>0&&this.grounded&&((p=this.onMove)==null||p.call(this,l,s,this.crouching,r));const c=this.grounded,u=this._feetY(),h=this._findSupportY(this.position.x,this.position.z,u,this.vy,e),f=Math.min(this._eyeOnSupport(h),Go);this.vy-=vx*e;let d=this.position.y+this.vy*e;if(d>Go&&(d=Go,this.vy=0),d<=f&&this.vy<=0){const y=Math.abs(this.vy),v=!c;this.position.y=f,this.vy=0,this.grounded=!0,this.groundY=h,v&&((T=this.onLand)==null||T.call(this,y))}else this.position.y=d,this.grounded=!1;this.resolvePenetration();const g=Yn.lerp(NS,FS,this.crouchBlend),_=this.grounded?Math.sin(this.bob)*g:0;this._applyLook(_)}}const kS="/backroom/",zS=`${kS}assets/${encodeURIComponent("01. Government Funding.mp3")}`,HS=2,GS=2.75,VS=1.4;class WS{constructor(){this.ctx=null,this.master=null,this.sfxGain=null,this.bgmGain=null,this.bgmBuffer=null,this.bgmSource=null,this._stepAccum=0,this._bgmLoading=null}_ensure(){if(this.ctx)return!0;try{return this.ctx=new AudioContext,this.master=this.ctx.createGain(),this.master.gain.value=1,this.master.connect(this.ctx.destination),this.sfxGain=this.ctx.createGain(),this.sfxGain.gain.value=2.1,this.sfxGain.connect(this.master),!0}catch{return!1}}async preload(){return this.bgmBuffer?this.bgmBuffer:this._bgmLoading?this._bgmLoading:(this._bgmLoading=fetch(zS).then(e=>{if(!e.ok)throw new Error(`BGM load failed: ${e.status}`);return e.arrayBuffer()}).then(e=>this._ensure()?this.ctx.decodeAudioData(e):null).then(e=>(this.bgmBuffer=e,e)).catch(e=>(console.warn("[audio] background music unavailable",e),null)),this._bgmLoading)}start(){if(!this._ensure()||(this.ctx.state==="suspended"&&this.ctx.resume(),this.bgmSource))return;const e=()=>{if(!this.bgmBuffer||this.bgmSource)return;const t=this.ctx.createBufferSource();t.buffer=this.bgmBuffer,t.loop=!0,this.bgmGain=this.ctx.createGain(),this.bgmGain.gain.value=.42,t.connect(this.bgmGain),this.bgmGain.connect(this.master),t.start(),this.bgmSource=t};if(this.bgmBuffer){e();return}this.preload().then(e)}onLand(e=4){if(!this._ensure())return;this.ctx.state==="suspended"&&this.ctx.resume();const t=Math.min(1,Math.max(.3,e/7.5));this._stepAccum=0,this._playFootstep(!1,!1,{land:!0,impact:t})}onJump(){this._ensure()&&(this.ctx.state==="suspended"&&this.ctx.resume(),this._playFootstep(!1,!1,{jump:!0}))}onMove(e,t,n=!1,s=3.2){if(!this._ensure()||(this.ctx.state==="suspended"&&this.ctx.resume(),e<1e-5||s<.1))return;this._stepAccum+=e;const o=s/(n?VS:t?GS:HS);for(;this._stepAccum>=o;)this._stepAccum-=o,this._playFootstep(t,n)}_playFootstep(e,t,{jump:n=!1,land:s=!1,impact:r=1}={}){const o=this.ctx,a=o.currentTime;let l,c,u,h,f;n?(l=.065,c=.22,u=128,h=860,f=250):s?(l=.12,c=.3+r*.38,u=72+r*48,h=620,f=175):(l=t?.12:e?.075:.1,c=t?.24:e?.42:.34,u=t?88:e?118:102,h=t?480:e?1050:780,f=t?165:e?285:220);const d=o.createOscillator();d.type="sine",d.frequency.value=u+Math.random()*28;const g=o.createGain();g.gain.setValueAtTime(c*1.35,a),g.gain.exponentialRampToValueAtTime(.001,a+l),d.connect(g),g.connect(this.sfxGain),d.start(a),d.stop(a+l+.02);const _=Math.max(1,Math.floor(o.sampleRate*l)),m=o.createBuffer(1,_,o.sampleRate),p=m.getChannelData(0);for(let C=0;C<_;C++){const A=Math.pow(1-C/_,1.4);p[C]=(Math.random()*2-1)*A}const T=o.createBufferSource();T.buffer=m;const y=o.createBiquadFilter();y.type="lowpass",y.frequency.value=h,y.Q.value=.55;const v=o.createBiquadFilter();v.type="bandpass",v.frequency.value=f+Math.random()*70,v.Q.value=.65;const R=o.createGain();R.gain.setValueAtTime(c,a),R.gain.exponentialRampToValueAtTime(.001,a+l*.92),T.connect(y),y.connect(v),v.connect(R),R.connect(this.sfxGain),T.start(a),T.stop(a+l+.02)}}const XS={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		}`},ey={uniforms:{tDiffuse:{value:null},time:{value:0},resolution:{value:new ke(1280,720)},intensity:{value:.16},blurAmount:{value:.58},wobble:{value:.0022}},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
      gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
  ...
  `};function ty(){return new xl(ey)}function ny(i,e){i.uniforms.time.value=e}function Zh(i,e,t,n=1){i.uniforms.resolution.value.set(e*n,t*n)}function vl(i){return i.getPixelRatio()*Bx}function Jh(i,e,t){const n=vl(i);return new ke(1/(e*n),1/(t*n))}function iy(i,e,t){const n=window.innerWidth,s=window.innerHeight,r=vl(i),o=new ZS(i);o.setPixelRatio(r),o.setSize(n,s),o.addPass(new JS(e,t));const a=new xl(QS);a.material.uniforms.resolution.value.copy(Jh(i,n,s)),o.addPass(a);const l=ty();return Zh(l,n,s,r),o.addPass(l),{composer:o,fxaa:a,noise:l,render(c=0){ny(l,c),o.render()}}}function sy(i,e,t,n){const s=vl(i);i.setSize(t,n),e.composer.setPixelRatio(s),e.composer.setSize(t,n),e.fxaa.material.uniforms.resolution.value.copy(Jh(i,t,n)),Zh(e.noise,t,n,s)}const ry="1.0.0",oy="053150a",ay="2026-06-24 09:20:19",ly="dev";function cy(){return`v${ry} · ${oy} · ${ay} · ${ly}`}function uy(){if(typeof window>"u")return!1;const i=window.matchMedia("(pointer: coarse)").matches,e=navigator.maxTouchPoints>0,t=/Android|iPhone|iPad|iPod|Mobile|webOS|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);return i&&e||t}const hy=52,fy=.12;class dy{constructor(e){this.root=e,this.active=!1,this.move={x:0,y:0},this.look={dx:0,dy:0},this._jumpQueued=!1,this._stickBase=e.querySelector(".mc-stick-base"),this._stickKnob=e.querySelector(".mc-stick-knob"),this._lookZone=e.querySelector(".mc-look-zone"),this._btnJump=e.querySelector(".mc-btn-jump"),this._stickTouchId=null,this._stickOrigin={x:0,y:0},this._lookTouchId=null,this._lookLast={x:0,y:0},this._onStickStart=t=>this._stickDown(t),this._onStickMove=t=>this._stickMove(t),this._onStickEnd=t=>this._stickUp(t),this._onLookStart=t=>this._lookDown(t),this._onLookMove=t=>this._lookMove(t),this._onLookEnd=t=>this._lookUp(t),this._onJump=t=>{var n;t.preventDefault(),this._jumpQueued=!0,(n=this._btnJump)==null||n.classList.add("pressed"),window.setTimeout(()=>{var s;return(s=this._btnJump)==null?void 0:s.classList.remove("pressed")},120)}}mount(){var e,t,n,s,r,o,a,l,c;(e=this._stickBase)==null||e.addEventListener("touchstart",this._onStickStart,{passive:!1}),(t=this._stickBase)==null||t.addEventListener("touchmove",this._onStickMove,{passive:!1}),(n=this._stickBase)==null||n.addEventListener("touchend",this._onStickEnd),(s=this._stickBase)==null||s.addEventListener("touchcancel",this._onStickEnd),(r=this._lookZone)==null||r.addEventListener("touchstart",this._onLookStart,{passive:!1}),(o=this._lookZone)==null||o.addEventListener("touchmove",this._onLookMove,{passive:!1}),(a=this._lookZone)==null||a.addEventListener("touchend",this._onLookEnd),(l=this._lookZone)==null||l.addEventListener("touchcancel",this._onLookEnd),(c=this._btnJump)==null||c.addEventListener("touchstart",this._onJump,{passive:!1})}show(){this.active=!0,this.root.hidden=!1,this.root.classList.add("visible")}hide(){this.active=!1,this.root.classList.remove("visible"),this.root.hidden=!0,this._reset()}consumeJump(){return this._jumpQueued?(this._jumpQueued=!1,!0):!1}consumeLook(){const e=this.look.dx,t=this.look.dy;return this.look.dx=0,this.look.dy=0,{dx:e,dy:t}}_reset(){var e,t;this.move.x=0,this.move.y=0,this.look.dx=0,this.look.dy=0,this._jumpQueued=!1,this._stickTouchId=null,this._lookTouchId=null,(e=this._btnJump)==null||e.classList.remove("pressed"),(t=this._stickKnob)==null||t.style.setProperty("transform","translate(-50%, -50%)")}_stickDown(e){if(!this.active||this._stickTouchId!==null)return;const t=e.changedTouches[0];if(!t)return;e.preventDefault(),this._stickTouchId=t.identifier;const n=this._stickBase.getBoundingClientRect();this._stickOrigin.x=n.left+n.width/2,this._stickOrigin.y=n.top+n.height/2,this._updateStick(t.clientX,t.clientY)}_stickMove(e){if(this._stickTouchId===null)return;const t=this._findTouch(e,this._stickTouchId);t&&(e.preventDefault(),this._updateStick(t.clientX,t.clientY))}_stickUp(e){var n;this._stickTouchId===null||!this._findTouch(e,this._stickTouchId)&&e.type!=="touchcancel"||(this._stickTouchId=null,this.move.x=0,this.move.y=0,(n=this._stickKnob)==null||n.style.setProperty("transform","translate(-50%, -50%)"))}_updateStick(e,t){var u;let n=e-this._stickOrigin.x,s=t-this._stickOrigin.y;const r=Math.hypot(n,s),o=hy;r>o&&(n=n/r*o,s=s/r*o),(u=this._stickKnob)==null||u.style.setProperty("transform",`translate(calc(-50% + ${n}px), calc(-50% + ${s}px))`);const a=n/o,l=s/o;Math.hypot(a,l)<fy?(this.move.x=0,this.move.y=0):(this.move.x=a,this.move.y=l)}_lookDown(e){if(!this.active||this._lookTouchId!==null)return;const t=e.changedTouches[0];t&&(e.preventDefault(),this._lookTouchId=t.identifier,this._lookLast.x=t.clientX,this._lookLast.y=t.clientY)}_lookMove(e){if(this._lookTouchId===null)return;const t=this._findTouch(e,this._lookTouchId);t&&(e.preventDefault(),this.look.dx+=t.clientX-this._lookLast.x,this.look.dy+=t.clientY-this._lookLast.y,this._lookLast.x=t.clientX,this._lookLast.y=t.clientY)}_lookUp(e){this._lookTouchId===null||!this._findTouch(e,this._lookTouchId)&&e.type!=="touchcancel"||(this._lookTouchId=null)}_findTouch(e,t){for(const n of e.changedTouches)if(n.identifier===t)return n;for(const n of e.touches)if(n.identifier===t)return n;return null}}const Dn=uy();document.documentElement.classList.toggle("mobile",Dn);const Oi=document.getElementById("overlay"),py=document.getElementById("hud"),my=document.getElementById("vignette"),Yi=document.getElementById("crosshair"),Au=document.getElementById("build-label"),Vo=document.getElementById("build-badge"),wu=document.getElementById("build-version"),nn=document.getElementById("resume-prompt"),Ru=document.getElementById("mobile-controls"),ki=Dn&&Ru?new dy(Ru):null;ki&&ki.mount();const Qh=cy();Au&&(Au.textContent=Qh);wu&&(wu.textContent=Qh);function Wo(){if(!Yi)return;const i=Tt.domElement.getBoundingClientRect();Yi.style.left=`${i.left+i.width/2}px`,Yi.style.top=`${i.top+i.height/2}px`}const Tt=new hx({antialias:!1,powerPreference:"high-performance"});Tt.setPixelRatio(Math.min(window.devicePixelRatio,1));Tt.setSize(window.innerWidth,window.innerHeight);Tt.outputColorSpace=it;Tt.toneMapping=Lu;Tt.toneMappingExposure=kx;Tt.domElement.style.cssText="position:fixed;inset:0;z-index:1;visibility:hidden";document.body.appendChild(Tt.domElement);const jn=new Bd;jn.background=new be(gh);jn.fog=new el(gh,wx,Rx);const fi=new It(Mx,window.innerWidth/window.innerHeight,Sx,yx);fi.position.set(k/2,Vi,k/2);jn.add(new _p(Px,Dx));jn.add(new up(Ix,Ux,Nx));const sn=new WS;async function gy(){const i=document.getElementById("hint-status"),e="Loading… please wait",t=Dn?"Tap to start":"Click to start";i&&(i.textContent=e),Oi.style.cursor="wait";const n=new ah,s=await iv(n),r=await tv(n),o=await Zx(n),a=sv(s,r,o),l=await Qv();await sn.preload();const c=new PS(jn,a,l),u=new BS(fi,Tt.domElement);if(Dn&&ki){u.setMobileMode(!0,ki),nn&&(nn.hidden=!0);const v=document.querySelector("#overlay .hint-controls");v&&(v.innerHTML="Move: left stick<br />Look: drag right<br />Jump: button")}u.connect();function h(){nn&&(nn.hidden=!1,nn.classList.add("visible"))}function f(){nn&&(nn.classList.remove("visible"),nn.hidden=!0)}function d(){!m||!_||Dn||u.isLocked()||u.requestLock()}u.onLockLost=()=>{_&&!Dn&&h()},u.onLockAcquired=f,u.onMove=(v,R,C,A)=>{_&&sn.onMove(v,R,C,A)},u.onJump=()=>{_&&sn.onJump()},u.onLand=v=>{_&&sn.onLand(v)},Tt.domElement.addEventListener("click",()=>{var v;((v=sn.ctx)==null?void 0:v.state)==="suspended"&&sn.ctx.resume()}),Tt.domElement.addEventListener("click",d),nn==null||nn.addEventListener("click",d);const g=iy(Tt,jn,fi);let _=!1,m=!1;c.preloadAround(fi,(v,R)=>{i&&!m&&(i.innerHTML=`Building nearby rooms… ${v}/${R}<br />Please wait`)}).then(()=>{u.setColliders(c.getColliders()),m=!0,Tt.domElement.style.visibility="visible",Wo(),Oi.style.cursor="pointer",i&&(i.textContent=t)}).catch(v=>{console.error(v),m=!0,Tt.domElement.style.visibility="visible",Oi.style.cursor="pointer",i&&(i.textContent="Load error — please refresh.")}),Oi.addEventListener("click",()=>{var v;((v=sn.ctx)==null?void 0:v.state)==="suspended"&&sn.ctx.resume(),m&&(Dn||u.requestLock(),_||(_=!0,Dn&&ki&&(u.startMobile(),ki.show()),Oi.classList.add("hidden"),py.classList.add("visible"),my.classList.add("visible"),Dn||Yi==null||Yi.classList.add("visible"),Wo(),Vo==null||Vo.classList.add("visible"),sn.start()))}),Oi.addEventListener("touchstart",()=>{var v;((v=sn.ctx)==null?void 0:v.state)==="suspended"&&sn.ctx.resume()},{passive:!0});const p=new lh;let T=0;function y(){requestAnimationFrame(y);const v=Math.min(p.getDelta(),.05);T+=v,c.tick(v),rS(jn,T),c.preloading||(c.update(u.position),_&&c.hasPendingLoads()&&c.processLoadQueue(u.position),c.consumeColliderRebuild()&&(u.setColliders(c.getColliders()),u.resolvePenetration())),_&&u.update(v),m?g.render(T):Tt.render(jn,fi),!c.preloading&&_&&c.processLoadQueue(u.position)}y(),window.addEventListener("resize",()=>{const v=window.innerWidth,R=window.innerHeight;fi.aspect=v/R,fi.updateProjectionMatrix(),sy(Tt,g,v,R),Wo()})}gy().catch(i=>{console.error(i);const e=document.getElementById("hint-status");e&&(e.textContent="Load error — please refresh.")});
